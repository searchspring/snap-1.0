...
describe('Snap Api', () => {
	...
	it('can call postMeta', async () => {
		...
		const requestUrl = 'https://8uyt2m.a.athoscommerce.net/v1/meta';
	...
	it('can call postSearch', async () => {
		...
		const requestUrl = 'https://8uyt2m.a.athoscommerce.net/v1/search';
	...
	it('can call postAutocomplete', async () => {
		...
		const requestUrl = 'https://8uyt2m.a.athoscommerce.net/v1/autocomplete';
