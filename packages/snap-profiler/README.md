...
## Logging profiles
It is recommended to use the [Snap Logger's `profile`](https://athoscommerce.github.io/snap/reference-logger#profile-method) method to log Snap Profiles as it provides a clean output for easy parsing.