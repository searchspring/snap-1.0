...
import type { CategorySchema, Model400Response, Model404Response } from '../models/index';
import {
...
export class CategoryApi extends runtime.BaseAPI {
	...
	async categoryRenderRaw(
		...
		if (requestParameters['categorySchema'] == null) {
			throw new runtime.RequiredError('categorySchema', 'Required parameter "categorySchema" was null or undefined when calling categoryRender().');
		}
