...
import type { Model400Response, Model404Response, SearchRedirectSchema, SearchSchema } from '../models/index';
import {
...
export class SearchApi extends runtime.BaseAPI {
	...
	async searchAddtocartRaw(
		...
		if (requestParameters['searchSchema'] == null) {
			throw new runtime.RequiredError('searchSchema', 'Required parameter "searchSchema" was null or undefined when calling searchAddtocart().');
		}
	...
	async searchClickthroughRaw(
		...
		if (requestParameters['searchSchema'] == null) {
			throw new runtime.RequiredError('searchSchema', 'Required parameter "searchSchema" was null or undefined when calling searchClickthrough().');
		}
	...
	async searchImpressionRaw(
		...
		if (requestParameters['searchSchema'] == null) {
			throw new runtime.RequiredError('searchSchema', 'Required parameter "searchSchema" was null or undefined when calling searchImpression().');
		}
	...
	async searchRenderRaw(
		...
		if (requestParameters['searchSchema'] == null) {
			throw new runtime.RequiredError('searchSchema', 'Required parameter "searchSchema" was null or undefined when calling searchRender().');
		}
