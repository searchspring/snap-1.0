...
export type AutocompleteSchemaDataMerchandisingPersonalizedEnum =
	typeof AutocompleteSchemaDataMerchandisingPersonalizedEnum[keyof typeof AutocompleteSchemaDataMerchandisingPersonalizedEnum];
...
export function AutocompleteSchemaDataMerchandisingFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutocompleteSchemaDataMerchandising {
	...
	return {
		...
		triggeredCampaigns:
			json['triggeredCampaigns'] == null
				? undefined
				: (json['triggeredCampaigns'] as Array<any>).map(AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON),
	};
}
...
export function AutocompleteSchemaDataMerchandisingToJSONTyped(
	value?: AutocompleteSchemaDataMerchandising | null,
	...
	return {
		...
		triggeredCampaigns:
			value['triggeredCampaigns'] == null
				? undefined
				: (value['triggeredCampaigns'] as Array<any>).map(AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSON),
	};
}
