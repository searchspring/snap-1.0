...
export type CategorySchemaDataMerchandisingPersonalizedEnum =
	typeof CategorySchemaDataMerchandisingPersonalizedEnum[keyof typeof CategorySchemaDataMerchandisingPersonalizedEnum];
	...
	return {
		...
		triggeredCampaigns:
			json['triggeredCampaigns'] == null
				? undefined
				: (json['triggeredCampaigns'] as Array<any>).map(SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON),
	};
}
...
export function CategorySchemaDataMerchandisingToJSONTyped(
	value?: CategorySchemaDataMerchandising | null,
	...
	return {
		...
		triggeredCampaigns:
			value['triggeredCampaigns'] == null
				? undefined
				: (value['triggeredCampaigns'] as Array<any>).map(SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSON),
	};
}
