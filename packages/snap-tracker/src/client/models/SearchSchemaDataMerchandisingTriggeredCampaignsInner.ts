 ...
 */
export function instanceOfSearchSchemaDataMerchandisingTriggeredCampaignsInner(
	value: object
): value is SearchSchemaDataMerchandisingTriggeredCampaignsInner {
	return true;
}
...
export function SearchSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(
	json: any,
	ignoreDiscriminator: boolean
): SearchSchemaDataMerchandisingTriggeredCampaignsInner {
	if (json == null) {
		return json;
	}
	return {
...
export function SearchSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(
	value?: SearchSchemaDataMerchandisingTriggeredCampaignsInner | null,
