 ...
 */
export function instanceOfAutocompleteSchemaDataMerchandisingTriggeredCampaignsInner(
	value: object
): value is AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
	return true;
}

export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSON(
	json: any
): AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
	return AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(json, false);
}

export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerFromJSONTyped(
	json: any,
...
export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSON(
	json: any
): AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner {
	return AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(json, false);
}

export function AutocompleteSchemaDataMerchandisingTriggeredCampaignsInnerToJSONTyped(
	value?: AutocompleteSchemaDataMerchandisingTriggeredCampaignsInner | null,
