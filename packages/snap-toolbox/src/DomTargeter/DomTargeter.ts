...
export class DomTargeter {
	...
	getTargetedElems(): ReadonlyArray<Element> {
		this.targetedElems = this.targetedElems.filter((elem) => typeof elem.isConnected !== 'undefined' && elem.isConnected);
	...
	retarget(): void {
		...
		globallyTargetedElems = globallyTargetedElems.filter((elem) => typeof elem.isConnected !== 'undefined' && elem.isConnected);
		this.targetedElems = this.targetedElems.filter((elem) => typeof elem.isConnected !== 'undefined' && elem.isConnected);
