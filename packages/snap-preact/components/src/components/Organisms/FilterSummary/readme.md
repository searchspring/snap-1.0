...
```
### filterIcon
The `filterIcon` prop is the name of the icon to render for each filter. Can take a `false` boolean to disable the icon. 
...
### clearAllIcon
The `clearAllIcon` prop is the name of the icon to render for the 'clear all' button. Can take a `false` boolean to disable the icon. 
