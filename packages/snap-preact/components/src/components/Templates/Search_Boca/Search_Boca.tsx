...
import { Theme, useTheme, CacheProvider, useSnap, ThemePartial } from '../../../providers';
...
export const Search_Boca = observer((properties: SearchProps): JSX.Element => {
	...
	let props = mergeProps('search_boca', globalTheme, defaultProps, properties);
	...
	if (themeDefaults?.components?.layoutSelector) {
		themeDefaults.components.layoutSelector.selected = selectedLayout;
	}
