...
Utilizes `formatNumber` from <a target="_blank" rel="noopener noreferrer" href="https://athoscommerce.github.io/snap/reference-toolbox-filters">@athoscommerce/snap-preact/toolbox</a> to render a `<span>` containing a formatted number.
