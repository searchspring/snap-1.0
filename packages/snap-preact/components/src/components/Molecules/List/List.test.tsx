...
describe('List Component', () => {
	...
	it('it can hideOptionLabels', async () => {
		...
		expect(optionElements.innerHTML).toBe(
			`<span ss-path=\"list checkbox\" role=\"checkbox\" aria-checked=\"false\" aria-label=\"Red\" ss-lang=\"checkbox\" class=\"ss__checkbox ss-182zd4n\"><span class=\"ss__checkbox__empty\"></span></span>`
		);
