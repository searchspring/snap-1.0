import { SearchCollapsibleProps } from '../../components/Templates/SearchCollapsible';
import { ThemeComponent } from '../../providers';

export const searchCollapsibleThemeComponentProps: ThemeComponent<'searchCollapsible', SearchCollapsibleProps> = {
	default: {
		searchCollapsible: {
			layoutOptions: [
				{
