	...
	(() => {
		...
		function L(e, t) {
			...
			if (e && t && (r = e.constructor) === t.constructor) {
				...
				if (r === Map) {
					if (e.size !== t.size) return !1;
					for (n of e) if (((a = n[0]), (a && typeof a == 'object' && ((a = Me(t, a)), !a)) || !L(n[1], t.get(a)))) return !1;
					return !0;
				}
		...
		function W(e) {
			...
			return (
				(W = function (n) {
					...
					return (a.prototype = Object.create(n.prototype, { constructor: { value: a, enumerable: !1, writable: !0, configurable: !0 } })), S(a, n);
				}),
				W(e)
			);
		}
		...
		var pt = /^#[a-fA-F0-9]{6}$/,
			...
			gt = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i,
			bt = /^hsl\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*\)$/i,
			ht =
				/^hsl(?:a)?\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i;
		function I(e) {
			if (typeof e != 'string') throw new v(3);
			var t = ct(e);
			if (t.match(pt)) return { red: parseInt('' + t[1] + t[2], 16), green: parseInt('' + t[3] + t[4], 16), blue: parseInt('' + t[5] + t[6], 16) };
			if (t.match(ft)) {
				var r = parseFloat((parseInt('' + t[7] + t[8], 16) / 255).toFixed(2));
				return { red: parseInt('' + t[1] + t[2], 16), green: parseInt('' + t[3] + t[4], 16), blue: parseInt('' + t[5] + t[6], 16), alpha: r };
			}
			if (t.match(dt)) return { red: parseInt('' + t[1] + t[1], 16), green: parseInt('' + t[2] + t[2], 16), blue: parseInt('' + t[3] + t[3], 16) };
			if (t.match(mt)) {
		...
		var kt = Object.create,
			...
			Yt = (e, t, r, n) => {
				if ((t && typeof t == 'object') || typeof t == 'function')
					for (let a of Ze(t)) !Vt.call(e, a) && a !== r && pe(e, a, { get: () => t[a], enumerable: !(n = Gt(t, a)) || n.enumerable });
				return e;
			},
			Jt = (e, t, r) => ((r = e != null ? kt(Wt(e)) : {}), Yt(t || !e || !e.__esModule ? pe(r, 'default', { value: e, enumerable: !0 }) : r, e)),
			qt = fe({
		...
		var Kt = {
			...
			er = ({ expanded: e, styles: t }) => o.createElement('span', { style: { ...t.base, ...(e ? t.expanded : t.collapsed) } }, '\u25B6'),
			tr = j((e) => {
				e = {
					expanded: !0,
		...
		var rr = (e) => Array.from({ length: e }, (t, r) => [X].concat(Array.from({ length: r }, () => '*')).join('.')),
					...
					i.forEach((l) => {
						let u = l.split('.'),
							c = (p, d, f) => {
								...
								let g = u[f];
								if (f === 0) J(p, t) && (g === X || g === Ye) && c(p, X, f + 1);
								else if (g === Ye) for (let { name: m, data: y } of t(p)) J(y, t) && c(y, `${d}.${m}`, f + 1);
								else {
									let m = p[g];
									J(m, t) && c(m, `${d}.${g}`, f + 1);
								}
			...
			et = j((e) => {
				...
				return o.createElement(
					...
					c
						? [...r(t)].map(({ name: d, data: f, ...g }) =>
								o.createElement(et, { name: d, data: f, depth: a + 1, path: `${n}.${d}`, key: d, dataIterator: r, nodeRenderer: i, ...g })
						  )
						: null
				);
			}),
		...
		var ue = ({ data: e }) => {
				let t = A('ObjectPreview'),
					r = e;
				if (typeof r != 'object' || r === null || r instanceof Date || r instanceof RegExp) return o.createElement(z, { object: r });
				if (Array.isArray(r)) {
					...
					for (let s in r)
						if (rt.call(r, s)) {
							...
							let u = le(r, s);
							if (
								(a.push(o.createElement('span', { key: s }, o.createElement(me, { name: s || '""' }), ':\xA0', o.createElement(z, { object: u }), l)),
								l)
							)
								break;
						}
			...
			or = ({ name: e, data: t }) =>
				typeof e == 'string'
					? o.createElement('span', null, o.createElement(me, { name: e }), o.createElement('span', null, ': '), o.createElement(ue, { data: t }))
			...
			lr = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
				e === 0 ? o.createElement(or, { name: t, data: r }) : o.createElement(ir, { name: t, data: r, isNonenumerable: n }),
		...
		var fr = ({ rows: e, columns: t, rowsData: r }) => {
								...
								o.createElement(
									...
									t.map((l) => {
										...
										return typeof u == 'object' && u !== null && rt.call(u, l)
											? o.createElement('td', { key: l, style: { ...n.td, ...a.solid } }, o.createElement(z, { object: u[l] }))
			...
			dr = (e) =>
				o.createElement('div', { style: { position: 'absolute', top: 1, right: 0, bottom: 1, display: 'flex', alignItems: 'center' } }, e.children),
			mr = ({ sortAscending: e }) => {
					...
					o.createElement(
						...
						o.createElement(
							...
							o.createElement(
								...
								t.map((p) =>
									o.createElement(qe, { borderStyle: c.solid, key: p, sorted: r && a === p, sortAscending: i, onClick: s.bind(null, p) }, p)
								)
							)
						)
					)
			...
			br = ({ data: e, columns: t }) => {
				...
				if (
					(i !== void 0
						? (g = f.map((m, y) => (typeof m == 'object' && m !== null ? [m[i], y] : [void 0, y])))
						: a && (g = p.map((m, y) => [p[y], y])),
					g !== void 0)
				) {
					let m = (O, x) => (ot, it) => {
						...
						y = g.sort(m((O) => O[0], s)).map((O) => O[1]);
					(p = y.map((O) => p[O])), (f = y.map((O) => f[O]));
				}
				return o.createElement(
					'div',
					{ style: r.base },
					o.createElement(gr, { columns: d, sorted: n, sortIndexColumn: a, sortColumn: i, sortAscending: s, onTHClick: c, onIndexTHClick: u }),
			...
			Er = 80,
			nt = (e) =>
				e.childNodes.length === 0 || (e.childNodes.length === 1 && e.childNodes[0].nodeType === Node.TEXT_NODE && e.textContent.length < Er),
			...
			Xe = ({ tagName: e, isChildNode: t = !1, styles: r }) =>
				o.createElement('span', { style: Object.assign({}, r.base, t && r.offsetLeft) }, '</', o.createElement('span', { style: r.tagName }, e), '>'),
			Or = {
				1: 'ELEMENT_NODE',
				3: 'TEXT_NODE',
			...
			Ir = Be(({ theme: e, ...t }) => o.createElement(Rr, { theme: e.addonActionsTheme || 'chromeLight', table: !1, ...t })),
						...
						e.map((r) =>
							o.createElement(
								...
								o.createElement(
									xr,
									null,
									o.createElement(Ir, { sortObjectKeys: !0, showNonenumerable: !1, name: r.data.name, data: r.data.args || r.data })
								)
							)
						)
					),
					...
					super(e),
						...
						(this.addAction = (t) => {
							this.setState((r) => {
								let n = [...r.actions],
									a = n.length && n[0];
								return a && Pr(a.data, t.data) ? a.count++ : ((t.count = 1), n.unshift(t)), { actions: n.slice(0, t.options.limit) };
							});
						}),
						(this.clearActions = () => {
		...
		Q.register(H, (e) => {
			Q.add(Br, { title: zr, type: Re.PANEL, render: ({ active: t }) => o.createElement(Fr, { api: e, active: !!t }), paramKey: Mr });
		});
	})();
} catch (e) {
