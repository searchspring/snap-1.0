try {
	(() => {
		...
		var R = ((e) =>
			typeof require < 'u' ? require : typeof Proxy < 'u' ? new Proxy(e, { get: (t, o) => (typeof require < 'u' ? require : t)[o] }) : e)(function (
			e
		) {
		...
		var ce = (e, t, o, n) => {
			if ((t && typeof t == 'object') || typeof t == 'function')
				for (let u of ae(t)) !le.call(e, u) && u !== o && H(e, u, { get: () => t[u], enumerable: !(n = ne(t, u)) || n.enumerable });
			return e;
		};
		var de = (e, t, o) => ((o = e != null ? oe(se(e)) : {}), ce(t || !e || !e.__esModule ? H(o, 'default', { value: e, enumerable: !0 }) : o, e));
		var y = P(() => {});
		var b = P(() => {});
		var S = P(() => {});
		var J = ue((Z, B) => {
							...
							function (n, u, f) {
								...
								(c.prototype.get = function (i) {
									...
									(c.prototype.delete = function (i) {
										var r;
										if ((this.lastItem && this.isEqual(this.lastItem.key, i) && (this.lastItem = void 0), (r = this.indexOf(i)), r >= 0))
							...
							function (n, u, f) {
									...
									return function (g) {
										var l = function () {
											...
											for (v = 0; v < x; v++) {
												...
												(I = !1), (p = new c(!1)), s.set(arguments[v], p), (s = p);
											}
											return (
												I && (s.has(arguments[x]) ? (A = s.get(arguments[x])) : (I = !1)),
												I || ((A = g.apply(null, arguments)), s.set(arguments[x], A)),
												a > 0 && ((L[x] = { cacheItem: s, arg: arguments[x] }), I ? i(d, L) : d.push(L), d.length > a && r(d.shift())),
												(l.wasMemoized = I),
												(l.numArgs = x + 1),
												A
											);
										};
										return (l.limit = a), (l.wasMemoized = !1), (l.cache = h), (l.lru = d), l;
									};
								};
								function i(a, h) {
									var d = a.length,
								...
								function r(a) {
									var h = a.length,
										...
										g,
										l;
									for (d.cacheItem.delete(d.arg), l = h - 2; l >= 0 && ((d = a[l]), (g = d.cacheItem.get(d.arg)), !g || !g.size); l--)
		...
		var _ = 'storybook/viewport',
			...
			be = (0, q.default)(50)((e) => [...Se, ...Object.entries(e).map(([t, { name: o, ...n }]) => ({ ...n, id: t, title: o }))]),
			...
			Ee = F(
				X(({ theme: e }) => {
					let { viewports: t = ye, defaultOrientation: o = 'portrait', defaultViewport: n = C.id, disable: u } = $(fe, {}),
					...
					let { selected: h, isRotated: d } = f,
						g = i.find((p) => p.id === h) || i.find((p) => p.id === n) || i.find((p) => p.default) || C,
						l = Y(),
						...
						u || Object.entries(t).length === 0
							...
							: w.createElement(
									...
									w.createElement(
										...
										{
											placement: 'top',
											tooltip: ({ onHide: p }) => w.createElement(ee, { links: we(i, g, c, f, p) }),
										...
										w.createElement(
											...
											s ? w.createElement(Te, null, d ? `${g.title} (L)` : `${g.title} (P)`) : null
										)
									),
									s
										? w.createElement(
		...
		V.register(_, () => {
			V.add(_, { title: 'viewport / media-queries', type: G.TOOL, match: ({ viewMode: e }) => e === 'story', render: () => W(Ee, null) });
		});
	})();
} catch (e) {
