/*! For license information please see components-Molecules-Checkbox-Checkbox-stories.721bcd7f.iframe.bundle.js.LICENSE.txt */
(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
	[9143],
	{
		'./components/src/components/Molecules/Checkbox/Checkbox.stories.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			'use strict';
			...
			const Checkbox_stories = {
				...
				Default = (args) => (0, emotion_react_jsx_runtime_browser_esm.Y)(Checkbox.S, { ...args }),
				Disabled = (args) => (0, emotion_react_jsx_runtime_browser_esm.Y)(Checkbox.S, { ...args });
			Disabled.args = { checked: !0, disabled: !0 };
			const Native = (args) => (0, emotion_react_jsx_runtime_browser_esm.Y)(Checkbox.S, { ...args });
			(Native.args = { native: !0 }),
				(Default.parameters = {
					...Default.parameters,
					docs: {
						...Default.parameters?.docs,
						source: { originalSource: '(args: CheckboxProps) => <Checkbox {...args} />', ...Default.parameters?.docs?.source },
					},
				}),
				(Disabled.parameters = {
					...Disabled.parameters,
					docs: {
						...
						source: { originalSource: '(args: CheckboxProps) => <Checkbox {...args} />', ...Disabled.parameters?.docs?.source },
					},
				}),
				(Native.parameters = {
					...Native.parameters,
					docs: {
						...
						source: { originalSource: '(args: CheckboxProps) => <Checkbox {...args} />', ...Native.parameters?.docs?.source },
					},
				});
