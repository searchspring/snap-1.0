			...
			'./components/src/components/Atoms/Dropdown/Dropdown.tsx'(w, a, e) {
				...
				const Z = ({ disableOverlay: E }) =>
					...
					G = (0, f.PA)((E) => {
						...
						se ||
							(V = (0, t.L)((n) => {
								(P && H.current && H.current.contains(n.target)) || (u && (T || (k && D && D(!1), O && O(n, !1))));
							})),
							(0, s.vJ)(() => {
								if (P && u) {
									const n = () => {
										if (W.current) {
											const g = W.current.getBoundingClientRect();
											re({ top: g.bottom + window.scrollY, left: g.left + window.scrollX, width: g.width });
										}
									};
									return (
										n(),
						...
						const v = (n, g) => {
							...
							z = (0, o.FD)('div', {
								...
								children: [(0, d.Y)(L, { open: u, toggleOpen: v, treePath: S }), (0, d.Y)(M, { open: u, toggleOpen: v, treePath: S })],
							});
						return (0, o.Y)(y._, {
							children: (0, o.FD)('div', {
								...F,
				...
				function c(s) {
					...
					return (
						...
						(0, o.vJ)(() => {
							...
							function r(f) {
								i.current && p.current && !i.current.contains(f.target) && p.current(f);
							}
						}, []),
						i
					);
