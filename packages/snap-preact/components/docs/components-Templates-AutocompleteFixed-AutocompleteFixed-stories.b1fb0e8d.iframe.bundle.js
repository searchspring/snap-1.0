		...
		'./components/src/components/Templates/AutocompleteFixed/AutocompleteFixed.stories.tsx': (
			...
			__webpack_require__.r(__webpack_exports__),
				__webpack_require__.d(__webpack_exports__, {
					...
					default: () => AutocompleteFixed_stories,
				});
			var emotion_react_jsx_runtime_browser_esm = __webpack_require__(
					'../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'
				),
				dist = __webpack_require__('../../node_modules/@storybook/blocks/dist/index.mjs'),
				AutocompleteFixed = __webpack_require__('./components/src/components/Templates/AutocompleteFixed/AutocompleteFixed.tsx'),
			...
			const AutocompleteFixed_stories = {
					title: 'Templates/AutocompleteFixed',
					component: AutocompleteFixed.f,
					tags: ['autodocs'],
					parameters: {
						docs: {
							page: () =>
					...
					argTypes: {
						...
						offset: { description: 'specifies the offset of the autocomplete', table: { type: { summary: 'object' } }, control: { type: 'object' } },
						width: {
							defaultValue: '500px',
				...
				Default = (args, { loaded: { controller } }) => {
					...
					return (
						...
						inputFound
							? (0, emotion_react_jsx_runtime_browser_esm.Y)(AutocompleteFixed.f, { ...args, controller, input: controller?.config.selector })
			...
			const defaultStyles = ({ inputBounds, offset, renderInput, width }) =>
				...
				AutocompleteFixed = (0, mobx_react_lite__WEBPACK_IMPORTED_MODULE_2__.PA)((properties) => {
					...
					const { layout, disableStyles, controller, renderInput, overlayColor, className, internalClassName, offset, treePath } = props,
						...
						[inputBounds, setInputBounds] = (0, preact_hooks__WEBPACK_IMPORTED_MODULE_1__.J0)(getInputBounds(input)),
						debouncedHandleResize = (0, _searchspring_snap_toolbox__WEBPACK_IMPORTED_MODULE_8__.s)(() => {
							setInputBounds(getInputBounds(input));
						}, 10);
