	...
	[8012],
	{
		'./components/src/components/Molecules/Grid/Grid.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
				...
				_Atoms_Image__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__('./components/src/components/Atoms/Image/Image.tsx'),
			...
			function Grid(properties) {
				...
				const limit = rows && columns ? columns * rows : options.length,
					...
					OverflowButtonElem = () => {
						const showButton = !hideShowLess || limited,
							...
							mergedLang = (0, _hooks__WEBPACK_IMPORTED_MODULE_9__.u)(lang, { limited, remainder });
						return showButton && remainder > 0 && options.length !== limit
							? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Y)('div', {
									...
									role: 'button',
									ref: (e) => (disableA11y || disableOverflowAction ? null : (0, _hooks__WEBPACK_IMPORTED_MODULE_11__.i)(e)),
									...(limited ? mergedLang.showMoreText.attributes : mergedLang.showLessText.attributes),
									children: overflowButton
										? (0, _utilities__WEBPACK_IMPORTED_MODULE_12__.Y)(overflowButton, { limited, remainder, treePath })
										: limited
				...
				return 'object' == typeof options && options?.length
					? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Y)(_providers__WEBPACK_IMPORTED_MODULE_13__._, {
							children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.FD)('div', {
								...
								children: [
									titleText &&
										(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Y)('h5', { className: 'ss__grid__title', children: titleText }),
									(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.FD)('div', {
										...
										children: [
												...
												if (!limited || options.length == limit || idx < limit - (overflowButtonInGrid ? 1 : 0))
													return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.FD)('div', {
														className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(
															`ss__grid__option ss__grid__option-value--${_searchspring_snap_toolbox__WEBPACK_IMPORTED_MODULE_14__.p(
														...
														children: [
															!option.background && option.backgroundImageUrl
																? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Y)(_Atoms_Image__WEBPACK_IMPORTED_MODULE_15__._, {
																		...subProps_image,
											...
											overflowButtonInGrid
												? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Y)(OverflowButtonElem, {})
												: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.Y)(preact__WEBPACK_IMPORTED_MODULE_0__.FK, {}),
										],
									}),
									overflowButtonInGrid
		...
		'./components/src/components/Molecules/Swatches/Swatches.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
				...
				_Carousel__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__('./components/src/components/Molecules/Carousel/Carousel.tsx'),
				_utilities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__('./components/src/utilities/defined.ts'),
				_utilities__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__('./components/src/utilities/mergeStyles.ts'),
				_Grid__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__('./components/src/components/Molecules/Grid/Grid.tsx'),
				...
				return 'object' == typeof options && options?.length
					? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Y)(_providers__WEBPACK_IMPORTED_MODULE_10__._, {
							children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Y)('div', {
								...
								children:
									'carousel' == type
										? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Y)(_Carousel__WEBPACK_IMPORTED_MODULE_11__.FN, {
												...subProps_carousel,
												children: options.map((option) => {
													...
													return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.FD)('div', {
														className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(
															`ss__swatches__carousel__swatch ss__swatches__carousel__swatch--${_searchspring_snap_toolbox__WEBPACK_IMPORTED_MODULE_12__.p(
																option.value?.toString()
															)}`,
															{
										...
										: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Y)(_Grid__WEBPACK_IMPORTED_MODULE_15__.x, {
												...subProps_grid,
												options,
												onSelect: (e, option) => {
		...
		'./components/src/components/Molecules/VariantSelection/VariantSelection.tsx': (
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
				...
				_Swatches__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__('./components/src/components/Molecules/Swatches/Swatches.tsx'),
				_Atoms_Dropdown__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__('./components/src/components/Atoms/Dropdown/Dropdown.tsx'),
			...
			const defaultStyles = () =>
				...
				VariantSelection = (0, mobx_react__WEBPACK_IMPORTED_MODULE_3__.PA)((properties) => {
					const globalTheme = (0, _providers__WEBPACK_IMPORTED_MODULE_4__.u)(),
						...
						{ type, selection, disableStyles, className, treePath } = props,
						subProps_dropdown = {
						...
						DropdownContent = (props) => {
							...
							return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)('ul', {
								className: 'ss__variant-selection__options',
								ref: (e) => (0, _hooks__WEBPACK_IMPORTED_MODULE_8__.i)(e, -1, !0, () => toggleOpen()),
								children: selection.values.map((val) => {
									const selected = selection.selected?.value == val.value;
									return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)('li', {
										...
										ref: (e) => (0, _hooks__WEBPACK_IMPORTED_MODULE_8__.i)(e),
										'aria-selected': selected,
						...
						? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(_providers__WEBPACK_IMPORTED_MODULE_9__._, {
								children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)('div', {
									...
									children: (() => {
										switch (type) {
											case 'dropdown':
												return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(preact__WEBPACK_IMPORTED_MODULE_0__.FK, {
													children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(_Atoms_Dropdown__WEBPACK_IMPORTED_MODULE_11__.m, {
														button: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)((props) => {
															const { open } = props;
															return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.FD)(preact__WEBPACK_IMPORTED_MODULE_0__.FK, {
																children: [
																	(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.FD)('div', {
																		className: 'ss__dropdown__button-wrapper',
																		children: [
																			(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)('span', {
																	...
																	(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(_Atoms_Icon__WEBPACK_IMPORTED_MODULE_10__.I, {
														...
														...subProps_dropdown,
														content: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(DropdownContent, {}),
													}),
												});
											case 'list':
												return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(preact__WEBPACK_IMPORTED_MODULE_0__.FK, {
													children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(_List__WEBPACK_IMPORTED_MODULE_12__.B, {
														...subProps_list,
											...
											case 'swatches':
												return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(preact__WEBPACK_IMPORTED_MODULE_0__.FK, {
													children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Y)(_Swatches__WEBPACK_IMPORTED_MODULE_13__.l, {
														...subProps_swatches,
														options: selection.values,
													}),
												});
