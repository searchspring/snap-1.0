...
import { dist_exports, dist_exports2 as dist_exports7, require_react, require_react_dom, scope } from './chunk-INSKDKQB.js';
...
var errorMessages = ['ResizeObserver loop completed with undelivered notifications.', 'ResizeObserver loop limit exceeded', 'Script error.'],
	...
	ReactProvider = class extends Provider {
		constructor() {
			...
			addons.setChannel(channel),
				...
				FEATURES?.storyStoreV7 && CONFIG_TYPE === 'DEVELOPMENT' && ((this.serverChannel = this.channel), addons.setServerChannel(this.serverChannel));
		}
		getElements(type) {
