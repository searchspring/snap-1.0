			...
			: function (target, source) {
					for (var from2, to = toObject(target), symbols, s = 1; s < arguments.length; s++) {
						...
						if (getOwnPropertySymbols) {
							...
							for (var i = 0; i < symbols.length; i++) propIsEnumerable.call(from2, symbols[i]) && (to[symbols[i]] = from2[symbols[i]]);
						}
					}
					return to;
			  };
...
var require_react_development = __commonJS({
    ...
    in ` +
			...
			var IsSomeRendererActing = { current: !1 },
				ReactSharedInternals = { ReactCurrentDispatcher, ReactCurrentBatchConfig, ReactCurrentOwner, IsSomeRendererActing, assign: _assign };
    ...
    in`) === 0;
			...
			function createElement2(type, config, children) {
				...
				if (config != null) {
					...
					for (propName in config)
						hasOwnProperty3.call(config, propName) && !RESERVED_PROPS.hasOwnProperty(propName) && (props[propName] = config[propName]);
				}
			...
			function cloneElement(element, config, children) {
				if (element == null) throw Error('React.cloneElement(...): The argument must be a React element, but you passed ' + element + '.');
				var propName,
			...
			function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
				...
				if (invokeCallback) return callback(traverseContext, children, nameSoFar === '' ? SEPARATOR + getComponentKey(children, 0) : nameSoFar), 1;
				var child,
					nextName,
					subtreeCount = 0,
			...
			function getComponentKey(component, index) {
				return typeof component == 'object' && component !== null && component.key != null ? escape(component.key) : index.toString(36);
			}
			...
			function validateFragmentProps(fragment) {
				{
					...
					fragment.ref !== null && error('Invalid attribute `ref` supplied to `React.Fragment`.'), setCurrentlyValidatingElement(null);
				}
			}
		...
		(function () {
			...
			function siftUp(heap, node2, i) {
				for (var index = i; ; ) {
					...
					if (parent !== void 0 && compare(parent, node2) > 0) (heap[parentIndex] = node2), (heap[index] = parent), (index = parentIndex);
					else return;
				}
			}
			function siftDown(heap, node2, i) {
				for (var index = i, length2 = heap.length; index < length2; ) {
					...
					else if (right !== void 0 && compare(right, node2) < 0) (heap[index] = right), (heap[rightIndex] = node2), (index = rightIndex);
					else return;
				}
			}
			...
			function markTaskStart(task, ms) {
				profilingState[QUEUE_SIZE]++, eventLog !== null && logEvent([TaskStartEvent, ms * 1e3, task.id, task.priorityLevel]);
			}
					...
					if (callback !== null) {
						...
						(currentTime = exports.unstable_now()),
							typeof continuationCallback == 'function'
								...
								: (markTaskCompleted(currentTask, currentTime), (currentTask.isQueued = !1), currentTask === peek2(taskQueue) && pop(taskQueue)),
					...
					try {
						...
						try {
							...
							try {
								...
								interaction.__count--,
									subscriber !== null && interaction.__count === 0 && subscriber.onInteractionScheduledWorkCompleted(interaction);
							}
						}
					}
				}
...
var require_react_dom_development = __commonJS({
    ...
    in`) === 0;
			...
			if (!React3) throw Error('ReactDOM was loaded before React. Make sure you load the React package before loading ReactDOM.');
			...
			validateEventDispatches = function (event) {
				...
				(instancesIsArr !== listenersIsArr || instancesLen !== listenersLen) && error('EventPluginUtils: Invalid `event`.');
			};
			...
			function publishEventForPlugin(dispatchConfig, pluginModule, eventName) {
				...
				if (phasedRegistrationNames) {
					...
					return !0;
				} else if (dispatchConfig.registrationName) return publishRegistrationName(dispatchConfig.registrationName, pluginModule, eventName), !0;
				return !1;
			}
			...
			function shouldRemoveAttribute(name, value, propertyInfo, isCustomComponentTag) {
				if (value === null || typeof value > 'u' || shouldRemoveAttributeWithWarning(name, value, propertyInfo, isCustomComponentTag)) return !0;
				if (isCustomComponentTag) return !1;
			...
			[
				...
				['xml:base', 'xml:lang', 'xml:space'].forEach(function (attributeName) {
					var name = attributeName.replace(CAMELIZE, capitalize);
					properties[name] = new PropertyInfoRecord(name, STRING, !1, attributeName, 'http://www.w3.org/XML/1998/namespace', !1);
				}),
				['tabIndex', 'crossOrigin'].forEach(function (attributeName) {
					properties[attributeName] = new PropertyInfoRecord(attributeName, STRING, !1, attributeName.toLowerCase(), null, !1);
				});
			var xlinkHref = 'xlinkHref';
			(properties[xlinkHref] = new PropertyInfoRecord('xlinkHref', STRING, !1, 'xlink:href', 'http://www.w3.org/1999/xlink', !0)),
				['src', 'href', 'action', 'formAction'].forEach(function (attributeName) {
					properties[attributeName] = new PropertyInfoRecord(attributeName, STRING, !1, attributeName.toLowerCase(), null, !0);
				});
			...
			function setValueForProperty(node2, name, value, isCustomComponentTag) {
				...
				if (!shouldIgnoreAttribute(name, propertyInfo, isCustomComponentTag)) {
					if (
						(shouldRemoveAttribute(name, value, propertyInfo, isCustomComponentTag) && (value = null), isCustomComponentTag || propertyInfo === null)
					) {
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`,
							...
							function (error2) {
								lazyComponent._status === Pending && ((lazyComponent._status = Rejected), (lazyComponent._result = error2));
							}
						);
				}
			}
				...
				var hasReadOnlyValue = { button: !0, checkbox: !0, image: !0, hidden: !0, radio: !0, reset: !0, submit: !0 },
					propTypes = {
						...
						checked: function (props, propName, componentName) {
							return props.onChange || props.readOnly || props.disabled || props[propName] == null || enableDeprecatedFlareAPI
								? null
								: new Error(
			...
			function trackValueOnNode(node2) {
				...
				if (
					!(node2.hasOwnProperty(valueField) || typeof descriptor > 'u' || typeof descriptor.get != 'function' || typeof descriptor.set != 'function')
				) {
			...
			function updateWrapper(element, props) {
				...
				props.hasOwnProperty('value')
					...
					: props.hasOwnProperty('defaultValue') && setDefaultValue(node2, props.type, getToStringValue(props.defaultValue)),
						...
						child != null &&
							(typeof child == 'string' ||
								...
								(typeof child.type == 'string' &&
									(didWarnInvalidChild || ((didWarnInvalidChild = !0), error('Only strings and numbers are supported as <option> children.')))));
					}),
					props.selected != null &&
...
Check the render method of \`` +
			...
			function getHostProps$3(element, props) {
				...
				var hostProps = _assign({}, props, { value: void 0, defaultValue: void 0, children: toString(node2._wrapperState.initialValue) });
				return hostProps;
			}
			...
			function getListenerMapForElement(element) {
				...
				return listenerMap === void 0 && ((listenerMap = new Map()), elementListenerMap.set(element, listenerMap)), listenerMap;
			}
			function get(key) {
			...
			function getEventTarget(nativeEvent) {
				...
				return (
					target.correspondingUseElement && (target = target.correspondingUseElement), target.nodeType === TEXT_NODE ? target.parentNode : target
				);
			}
			...
			function handleTopLevel(bookKeeping) {
				...
				do {
					...
					(tag === HostComponent || tag === HostText) && bookKeeping.ancestors.push(ancestor), (ancestor = getClosestInstanceFromNode(root2));
				} while (ancestor);
			...
			function legacyListenToEvent(registrationName, mountAt) {
				for (
					var listenerMap = getListenerMapForElement(mountAt), dependencies = registrationNameDependencies[registrationName], i = 0;
			...
			var simpleEventPluginEventTypes = {},
				...
				otherDiscreteEvents = [TOP_CHANGE, TOP_SELECTION_CHANGE, TOP_TEXT_INPUT, TOP_COMPOSITION_START, TOP_COMPOSITION_END, TOP_COMPOSITION_UPDATE],
			...
			function trapEventForPluginEventSystem(container, topLevelType, capture) {
				...
				capture ? addEventCaptureListener(container, rawEventName, listener) : addEventBubbleListener(container, rawEventName, listener);
			}
			function dispatchDiscreteEvent(topLevelType, eventSystemFlags, container, nativeEvent) {
				flushDiscreteUpdatesIfNeeded(nativeEvent.timeStamp), discreteUpdates(dispatchEvent, topLevelType, eventSystemFlags, container, nativeEvent);
			}
			...
			function dangerousStyleValue(name, value, isCustomProperty2) {
				...
				return isEmpty2
					? ''
					: !isCustomProperty2 && typeof value == 'number' && value !== 0 && !(isUnitlessNumber.hasOwnProperty(name) && isUnitlessNumber[name])
					? value + 'px'
					: ('' + value).trim();
			}
			...
			var warnValidStyle = function () {};
			{
				...
				warnValidStyle = function (name, value) {
					name.indexOf('-') > -1
						...
						typeof value == 'number' && (isNaN(value) ? warnStyleValueIsNaN(name, value) : isFinite(value) || warnStyleValueIsInfinity(name, value));
				};
			}
			...
			function expandShorthandMap(styles) {
				...
				for (var key in styles)
					for (var longhands = shorthandToLonghand[key] || [key], i = 0; i < longhands.length; i++) expanded[longhands[i]] = key;
				return expanded;
			}
...
`
				...
				switch (tag) {
					...
					default:
						(lastProps = lastRawProps),
							...
							typeof lastProps.onClick != 'function' && typeof nextProps.onClick == 'function' && trapClickOnNonInteractiveElement(domElement);
						break;
				}
			...
			function diffHydratedProperties(domElement, tag, rawProps, parentNamespace, rootContainerElement) {
				...
				switch (
					...
					case 'details':
						...
						break;
					case 'input':
						initWrapperState(domElement, rawProps), trapBubbledEvent(TOP_INVALID, domElement), ensureListeningTo(rootContainerElement, 'onChange');
						break;
					case 'option':
						validateProps(domElement, rawProps);
						break;
					case 'select':
						initWrapperState$1(domElement, rawProps), trapBubbledEvent(TOP_INVALID, domElement), ensureListeningTo(rootContainerElement, 'onChange');
						break;
					case 'textarea':
						initWrapperState$2(domElement, rawProps), trapBubbledEvent(TOP_INVALID, domElement), ensureListeningTo(rootContainerElement, 'onChange');
						break;
				}
						...
						if (propKey === CHILDREN)
							typeof nextProp == 'string'
								? domElement.textContent !== nextProp &&
								  (suppressHydrationWarning || warnForTextDifference(domElement.textContent, nextProp), (updatePayload = [CHILDREN, nextProp]))
								: typeof nextProp == 'number' &&
								  domElement.textContent !== '' + nextProp &&
								  (suppressHydrationWarning || warnForTextDifference(domElement.textContent, nextProp), (updatePayload = [CHILDREN, '' + nextProp]));
						else if (registrationNameModules.hasOwnProperty(propKey))
							nextProp != null &&
								(typeof nextProp != 'function' && warnForInvalidEventListener(propKey, nextProp), ensureListeningTo(rootContainerElement, propKey));
			...
			function getModernOffsetsFromPoints(outerNode, anchorNode, anchorOffset, focusNode, focusOffset) {
				...
				outer: for (;;) {
					for (
						var next2 = null;
						node2 === anchorNode && (anchorOffset === 0 || node2.nodeType === TEXT_NODE) && (start = length2 + anchorOffset),
							node2 === focusNode && (focusOffset === 0 || node2.nodeType === TEXT_NODE) && (end = length2 + focusOffset),
			...
			function getSelectionInformation() {
				...
				return { activeElementDetached: null, focusedElem, selectionRange: hasSelectionCapabilities(focusedElem) ? getSelection(focusedElem) : null };
			}
			function restoreSelection(priorSelectionInformation) {
				...
				if (curFocusedElem !== priorFocusedElem && isInDocument(priorFocusedElem)) {
					...
					for (var ancestors = [], ancestor = priorFocusedElem; (ancestor = ancestor.parentNode); )
						ancestor.nodeType === ELEMENT_NODE && ancestors.push({ element: ancestor, left: ancestor.scrollLeft, top: ancestor.scrollTop });
			...
			function getSelection(input) {
				var selection;
				return (
					'selectionStart' in input ? (selection = { start: input.selectionStart, end: input.selectionEnd }) : (selection = getOffsets(input)),
				...
				updatedAncestorInfo = function () {};
			{
				...
				var isTagValidWithParent = function (tag, parentTag) {
						...
						switch (tag) {
							...
							case 'h6':
								return (
									parentTag !== 'h1' && parentTag !== 'h2' && parentTag !== 'h3' && parentTag !== 'h4' && parentTag !== 'h5' && parentTag !== 'h6'
								);
							case 'rp':
							case 'rt':
				...
				validateDOMNesting = function (childTag, childText, ancestorInfo) {
					...
					childText != null &&
						(childTag != null && error('validateDOMNesting: when childText is passed, childTag should be null'), (childTag = '#text'));
			...
			function traverseEnterLeave(from2, to, fn, argFrom, argTo) {
				for (var common = from2 && to ? getLowestCommonAncestor(from2, to) : null, pathFrom = []; !(!from2 || from2 === common); ) {
			...
			function getListener(inst, registrationName) {
				...
				if (!props || ((listener = props[registrationName]), shouldPreventMouseEvent(registrationName, inst.type, props))) return null;
			...
			function SyntheticEvent(dispatchConfig, targetInst, nativeEvent, nativeEventTarget) {
				...
				return (
					defaultPrevented ? (this.isDefaultPrevented = functionThatReturnsTrue) : (this.isDefaultPrevented = functionThatReturnsFalse),
			...
			_assign(SyntheticEvent.prototype, {
				preventDefault: function () {
					...
					event &&
						(event.preventDefault ? event.preventDefault() : typeof event.returnValue != 'unknown' && (event.returnValue = !1),
						(this.isDefaultPrevented = functionThatReturnsTrue));
				},
				stopPropagation: function () {
					var event = this.nativeEvent;
					event &&
						(event.stopPropagation ? event.stopPropagation() : typeof event.cancelBubble != 'unknown' && (event.cancelBubble = !0),
			...
			var canUseTextInputEvent = canUseDOM && 'TextEvent' in window && !documentMode,
				useFallbackCompositionData = canUseDOM && (!canUseCompositionEvent || (documentMode && documentMode > 8 && documentMode <= 11)),
				SPACEBAR_CODE = 32,
			...
			var previousScreenX = 0,
				...
				EnterLeaveEventPlugin = {
					...
					extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget, eventSystemFlags) {
						...
						if (
							(isOverEvent && !(eventSystemFlags & IS_REPLAYED) && (nativeEvent.relatedTarget || nativeEvent.fromElement)) ||
			...
			function getSelection$1(node2) {
				if ('selectionStart' in node2 && hasSelectionCapabilities(node2)) return { start: node2.selectionStart, end: node2.selectionEnd };
			...
			function constructSelectEvent(nativeEvent, nativeEventTarget) {
				...
				if (!lastSelection || !shallowEqual(lastSelection, currentSelection)) {
					...
					return (
						(syntheticEvent.type = 'select'), (syntheticEvent.target = activeElement$1), accumulateTwoPhaseDispatches(syntheticEvent), syntheticEvent
					);
				}
				return null;
			}
			var SelectEventPlugin = {
				...
				SyntheticAnimationEvent = SyntheticEvent.extend({ animationName: null, elapsedTime: null, pseudoElement: null }),
			...
			function getEventCharCode(nativeEvent) {
				...
				return (
					'charCode' in nativeEvent ? ((charCode = nativeEvent.charCode), charCode === 0 && keyCode === 13 && (charCode = 13)) : (charCode = keyCode),
			...
			var SyntheticKeyboardEvent = SyntheticUIEvent.extend({
				...
				SyntheticTransitionEvent = SyntheticEvent.extend({ propertyName: null, elapsedTime: null, pseudoElement: null }),
			...
			var reactEmoji = '\u269B',
				...
				getFiberLabel = function (componentName, isMounted2, phase) {
					return phase === null ? componentName + ' [' + (isMounted2 ? 'update' : 'mount') + ']' : componentName + '.' + phase;
				},
				...
				resumeTimersRecursively = function (fiber) {
					fiber.return !== null && resumeTimersRecursively(fiber.return), fiber._debugIsCurrentlyTiming && beginFiberMark(fiber, null);
				},
			...
			function startWorkTimer(fiber) {
				{
					if (!supportsUserTiming || shouldIgnoreFiber(fiber) || ((currentFiber = fiber), !beginFiberMark(fiber, null))) return;
			...
			function stopWorkTimer(fiber) {
				{
					if (!supportsUserTiming || shouldIgnoreFiber(fiber) || ((currentFiber = fiber.return), !fiber._debugIsCurrentlyTiming)) return;
			...
			function processChildContext(fiber, type, parentContext) {
				{
					...
					for (var contextKey in childContext)
						if (!(contextKey in childContextTypes))
							throw Error(
								(getComponentName(type) || 'Unknown') + '.getChildContext(): key "' + contextKey + '" is not defined in childContextTypes.'
							);
					{
						var name = getComponentName(type) || 'Unknown';
			...
			function invalidateContextProvider(workInProgress2, type, didChange) {
				{
					...
					} else pop(didPerformWorkStackCursor, workInProgress2), push(didPerformWorkStackCursor, didChange, workInProgress2);
				}
			}
				...
				(ReactStrictModeWarnings.recordLegacyContextWarning = function (fiber, instance) {
					...
					if (!didWarnAboutLegacyContext.has(fiber.type)) {
						...
						(fiber.type.contextTypes != null ||
							...
							(warningsForRoot === void 0 && ((warningsForRoot = []), pendingLegacyContextWarning.set(strictRoot, warningsForRoot)),
...
Learn more about this warning here: https://fb.me/react-legacy-context%s`,
			...
			function readLazyComponentType(lazyComponent) {
				if ((initializeLazyComponentType(lazyComponent), lazyComponent._status !== Resolved)) throw lazyComponent._result;
			...
			function calculateChangedBits(context, newValue, oldValue) {
				...
				var changedBits =
					typeof context._calculateChangedBits == 'function' ? context._calculateChangedBits(oldValue, newValue) : MAX_SIGNED_31_BIT_INT;
				return (
				...
				for (var node2 = parent; node2 !== null; ) {
					...
					if (node2.childExpirationTime < renderExpirationTime2)
						(node2.childExpirationTime = renderExpirationTime2),
							alternate !== null && alternate.childExpirationTime < renderExpirationTime2 && (alternate.childExpirationTime = renderExpirationTime2);
					else if (alternate !== null && alternate.childExpirationTime < renderExpirationTime2) alternate.childExpirationTime = renderExpirationTime2;
					else break;
					node2 = node2.return;
				}
			}
			function propagateContextChange(workInProgress2, context, changedBits, renderExpirationTime2) {
				...
				for (fiber !== null && (fiber.return = workInProgress2); fiber !== null; ) {
					...
					if (list !== null) {
						...
						for (var dependency = list.firstContext; dependency !== null; ) {
							if (dependency.context === context && dependency.observedBits & changedBits) {
								...
								var alternate = fiber.alternate;
								alternate !== null && alternate.expirationTime < renderExpirationTime2 && (alternate.expirationTime = renderExpirationTime2),
					...
					} else fiber.tag === ContextProvider ? (nextFiber = fiber.type === workInProgress2.type ? null : fiber.child) : (nextFiber = fiber.child);
			...
			function prepareToReadContext(workInProgress2, renderExpirationTime2) {
				...
				if (dependencies !== null) {
					...
					firstContext !== null &&
						(dependencies.expirationTime >= renderExpirationTime2 && markWorkInProgressReceivedUpdate(), (dependencies.firstContext = null));
				}
			}
			...
			function enqueueCapturedUpdate(workInProgress2, update) {
				...
				last === null ? ((queue.baseQueue = update.next = update), (update.next = update)) : ((update.next = last.next), (last.next = update));
			}
				...
				switch (update.tag) {
					case ReplaceState: {
						...
						if (typeof payload == 'function') {
							enterDisallowedContextReadInDEV(), workInProgress2.mode & StrictMode && payload.call(instance, prevState, nextProps);
			...
			function checkClassInstance(workInProgress2, ctor, newProps) {
				var instance = workInProgress2.stateNode;
				{
					...
					_state && (typeof _state != 'object' || isArray(_state)) && error('%s.state: must be set to an object or null', name),
			...
			function constructClassInstance(workInProgress2, ctor, props) {
				...
				var instance = new ctor(props, context),
					state = (workInProgress2.memoizedState = instance.state !== null && instance.state !== void 0 ? instance.state : null);
				adoptClassInstance(workInProgress2, instance);
				{
					...
					if (typeof ctor.getDerivedStateFromProps == 'function' || typeof instance.getSnapshotBeforeUpdate == 'function') {
						...
						if (
							(typeof instance.componentWillMount == 'function' && instance.componentWillMount.__suppressDeprecationWarning !== !0
								? (foundWillMountName = 'componentWillMount')
								: typeof instance.UNSAFE_componentWillMount == 'function' && (foundWillMountName = 'UNSAFE_componentWillMount'),
							typeof instance.componentWillReceiveProps == 'function' && instance.componentWillReceiveProps.__suppressDeprecationWarning !== !0
								? (foundWillReceivePropsName = 'componentWillReceiveProps')
								: typeof instance.UNSAFE_componentWillReceiveProps == 'function' && (foundWillReceivePropsName = 'UNSAFE_componentWillReceiveProps'),
							typeof instance.componentWillUpdate == 'function' && instance.componentWillUpdate.__suppressDeprecationWarning !== !0
								? (foundWillUpdateName = 'componentWillUpdate')
								: typeof instance.UNSAFE_componentWillUpdate == 'function' && (foundWillUpdateName = 'UNSAFE_componentWillUpdate'),
							foundWillMountName !== null || foundWillReceivePropsName !== null || foundWillUpdateName !== null)
						) {
							var _componentName = getComponentName(ctor) || 'Component',
								newApiName = typeof ctor.getDerivedStateFromProps == 'function' ? 'getDerivedStateFromProps()' : 'getSnapshotBeforeUpdate()';
  ...
  ` + foundWillUpdateName
			...
			function mountClassInstance(workInProgress2, ctor, newProps, renderExpirationTime2) {
				...
				}
				{
					...
					workInProgress2.mode & StrictMode && ReactStrictModeWarnings.recordLegacyContextWarning(workInProgress2, instance),
						ReactStrictModeWarnings.recordUnsafeLifecycleWarnings(workInProgress2, instance);
				}
				processUpdateQueue(workInProgress2, newProps, instance, renderExpirationTime2), (instance.state = workInProgress2.memoizedState);
			...
			function resumeMountClassInstance(workInProgress2, ctor, newProps, renderExpirationTime2) {
				...
				var getDerivedStateFromProps = ctor.getDerivedStateFromProps,
					hasNewLifecycles = typeof getDerivedStateFromProps == 'function' || typeof instance.getSnapshotBeforeUpdate == 'function';
				!hasNewLifecycles &&
				...
				if (
					...
					oldProps === newProps && oldState === newState && !hasContextChanged() && !checkHasForceUpdateAfterProcessing())
				)
				...
				return (
					shouldUpdate
						? (!hasNewLifecycles &&
								...
								typeof instance.componentWillUpdate == 'function' && instance.componentWillUpdate(newProps, newState, nextContext),
								typeof instance.UNSAFE_componentWillUpdate == 'function' && instance.UNSAFE_componentWillUpdate(newProps, newState, nextContext),
								stopPhaseTimer()),
...
See https://fb.me/react-refs-must-have-owner for more information.`
			...
			function ChildReconciler(shouldTrackSideEffects) {
				...
				function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, expirationTime) {
					...
					for (var existingChildren = mapRemainingChildren(returnFiber, oldFiber); newIdx < newChildren.length; newIdx++) {
						...
						_newFiber2 !== null &&
							(shouldTrackSideEffects && _newFiber2.alternate !== null && existingChildren.delete(_newFiber2.key === null ? newIdx : _newFiber2.key),
				...
				function reconcileChildrenIterator(returnFiber, currentFirstChild, newChildrenIterable, expirationTime) {
					...
					if (oldFiber === null) {
						for (; !step.done; newIdx++, step = newChildren.next()) {
							...
							_newFiber3 !== null &&
								...
								previousNewFiber === null ? (resultingFirstChild = _newFiber3) : (previousNewFiber.sibling = _newFiber3),
					...
					for (var existingChildren = mapRemainingChildren(returnFiber, oldFiber); !step.done; newIdx++, step = newChildren.next()) {
						...
						_newFiber4 !== null &&
							(shouldTrackSideEffects && _newFiber4.alternate !== null && existingChildren.delete(_newFiber4.key === null ? newIdx : _newFiber4.key),
							...
							switch (child.tag) {
								case Fragment2: {
									if (element.type === REACT_FRAGMENT_TYPE) {
										...
										return (
											(existing.return = returnFiber), (existing._debugSource = element._source), (existing._debugOwner = element._owner), existing
										);
									}
									break;
								}
			...
			function cloneChildFibers(current2, workInProgress2) {
				if (!(current2 === null || workInProgress2.child === current2.child)) throw Error('Resuming work not yet implemented.');
			...
			function resetChildFibers(workInProgress2, renderExpirationTime2) {
				for (var child = workInProgress2.child; child !== null; ) resetWorkInProgress(child, renderExpirationTime2), (child = child.sibling);
			}
			var NO_CONTEXT = {},
				...
				for (var node2 = row; node2 !== null; ) {
					if (node2.tag === SuspenseComponent) {
						...
						if (state !== null) {
							...
							if (dehydrated === null || isSuspenseInstancePending(dehydrated) || isSuspenseInstanceFallback(dehydrated)) return node2;
						}
			...
			function updateHookTypesDev() {
				{
					var hookName = currentHookNameInDev;
					hookTypesDev !== null &&
						(hookTypesUpdateIndexDev++, hookTypesDev[hookTypesUpdateIndexDev] !== hookName && warnOnHookMismatchInDev(hookName));
				}
			}
...
Incoming: %s`,
						...
						if (updateExpirationTime < renderExpirationTime) {
							...
							newBaseQueueLast === null
								...
								updateExpirationTime > currentlyRenderingFiber$1.expirationTime &&
									((currentlyRenderingFiber$1.expirationTime = updateExpirationTime), markUnprocessedUpdateTime(updateExpirationTime));
						} else {
							if (newBaseQueueLast !== null) {
								var _clone = {
									expirationTime: Sync,
							...
							if ((markRenderEventTimeAndConfig(updateExpirationTime, update.suspenseConfig), update.eagerReducer === reducer))
				...
				if (fiber === currentlyRenderingFiber$1 || (alternate !== null && alternate === currentlyRenderingFiber$1))
					...
					if (fiber.expirationTime === NoWork && (alternate === null || alternate.expirationTime === NoWork)) {
						...
						if (lastRenderedReducer !== null) {
							var prevDispatcher;
							(prevDispatcher = ReactCurrentDispatcher.current), (ReactCurrentDispatcher.current = InvalidNestedHooksDispatcherOnUpdateInDEV);
							try {
				...
				InvalidNestedHooksDispatcherOnRerenderInDEV = null;
			{
				...
				(HooksDispatcherOnMountInDEV = {
					...
					useResponder: function (responder, props) {
						return (currentHookNameInDev = 'useResponder'), mountHookTypesDev(), createDeprecatedResponderListener(responder, props);
					},
					...
					(HooksDispatcherOnMountWithHookTypesInDEV = {
						...
						useResponder: function (responder, props) {
							return (currentHookNameInDev = 'useResponder'), updateHookTypesDev(), createDeprecatedResponderListener(responder, props);
						},
						useDeferredValue: function (value, config) {
							return (currentHookNameInDev = 'useDeferredValue'), updateHookTypesDev(), mountDeferredValue(value, config);
						},
						useTransition: function (config) {
					...
					(HooksDispatcherOnUpdateInDEV = {
						...
						useDeferredValue: function (value, config) {
							return (currentHookNameInDev = 'useDeferredValue'), updateHookTypesDev(), updateDeferredValue(value, config);
						},
						useTransition: function (config) {
					...
					(HooksDispatcherOnRerenderInDEV = {
						...
						useDeferredValue: function (value, config) {
							return (currentHookNameInDev = 'useDeferredValue'), updateHookTypesDev(), rerenderDeferredValue(value, config);
						},
						useTransition: function (config) {
					...
					(InvalidNestedHooksDispatcherOnMountInDEV = {
						...
						useDeferredValue: function (value, config) {
							return (currentHookNameInDev = 'useDeferredValue'), warnInvalidHookAccess(), mountHookTypesDev(), mountDeferredValue(value, config);
						},
						useTransition: function (config) {
							return (currentHookNameInDev = 'useTransition'), warnInvalidHookAccess(), mountHookTypesDev(), mountTransition(config);
						},
					}),
					(InvalidNestedHooksDispatcherOnUpdateInDEV = {
						...
						useDeferredValue: function (value, config) {
							return (currentHookNameInDev = 'useDeferredValue'), warnInvalidHookAccess(), updateHookTypesDev(), updateDeferredValue(value, config);
						},
						useTransition: function (config) {
							return (currentHookNameInDev = 'useTransition'), warnInvalidHookAccess(), updateHookTypesDev(), updateTransition(config);
						},
					}),
					(InvalidNestedHooksDispatcherOnRerenderInDEV = {
						...
						useDeferredValue: function (value, config) {
							return (currentHookNameInDev = 'useDeferredValue'), warnInvalidHookAccess(), updateHookTypesDev(), rerenderDeferredValue(value, config);
						},
						useTransition: function (config) {
							return (currentHookNameInDev = 'useTransition'), warnInvalidHookAccess(), updateHookTypesDev(), rerenderTransition(config);
						},
					});
			}
			...
			function popToNextHostParent(fiber) {
				for (
					...
					parent !== null && parent.tag !== HostComponent && parent.tag !== HostRoot && parent.tag !== SuspenseComponent;
				...
				if (current2 === null) {
					...
					if (isSimpleFunctionComponent(type) && Component.compare === null && Component.defaultProps === void 0) {
						...
						return (
							...
							updateSimpleMemoComponent(current2, workInProgress2, resolvedType, nextProps, updateExpirationTime, renderExpirationTime2)
						);
					}
					{
			...
			function markRef(current2, workInProgress2) {
				...
				((current2 === null && ref !== null) || (current2 !== null && current2.ref !== ref)) && (workInProgress2.effectTag |= Ref);
			}
			...
			function updateClassComponent(current2, workInProgress2, Component, nextProps, renderExpirationTime2) {
				...
				var instance = workInProgress2.stateNode,
					shouldUpdate;
				instance === null
					? (current2 !== null && ((current2.alternate = null), (workInProgress2.alternate = null), (workInProgress2.effectTag |= Placement)),
			...
			function finishClassComponent(current2, workInProgress2, Component, shouldUpdate, hasContext, renderExpirationTime2) {
				...
				return (
					didCaptureError && typeof Component.getDerivedStateFromError != 'function'
						...
						: (setIsRendering(!0), (nextChildren = instance.render()), workInProgress2.mode & StrictMode && instance.render(), setIsRendering(!1)),
					(workInProgress2.effectTag |= PerformedWork),
			...
			function updateHostRoot(current2, workInProgress2, renderExpirationTime2) {
				...
				cloneUpdateQueue(current2, workInProgress2), processUpdateQueue(workInProgress2, nextProps, null, renderExpirationTime2);
				var nextState = workInProgress2.memoizedState,
				...
				if (root2.hydrate && enterHydrationState(workInProgress2)) {
					...
					for (var node2 = child; node2; ) (node2.effectTag = (node2.effectTag & ~Placement) | Hydrating), (node2 = node2.sibling);
			...
			function updateHostComponent(current2, workInProgress2, renderExpirationTime2) {
				...
				return (
					isDirectTextChild
						? (nextChildren = null)
						: prevProps !== null && shouldSetTextContent(type, prevProps) && (workInProgress2.effectTag |= ContentReset),
					markRef(current2, workInProgress2),
					workInProgress2.mode & ConcurrentMode && renderExpirationTime2 !== Never && shouldDeprioritizeSubtree(type, nextProps)
						? (markSpawnedWork(Never), (workInProgress2.expirationTime = workInProgress2.childExpirationTime = Never), null)
			...
			function mountIndeterminateComponent(_current, workInProgress2, Component, renderExpirationTime2) {
				...
				var value;
				{
					...
					workInProgress2.mode & StrictMode && ReactStrictModeWarnings.recordLegacyContextWarning(workInProgress2, null),
						setIsRendering(!0),
						(ReactCurrentOwner$1.current = workInProgress2),
				...
				if (
					...
					return (
						typeof getDerivedStateFromProps == 'function' && applyDerivedStateFromProps(workInProgress2, Component, getDerivedStateFromProps, props),
...
Check the render method of \`` +
			...
			function updateSuspenseComponent(current2, workInProgress2, renderExpirationTime2) {
				...
				if (
					...
					if ((nextProps.fallback !== void 0 && tryToClaimNextHydratableInstance(workInProgress2), nextDidTimeout)) {
						...
						return (
							(workInProgress2.memoizedState = null),
							(workInProgress2.child = mountChildFibers(workInProgress2, null, nextPrimaryChildren, renderExpirationTime2))
						);
					}
				else {
					...
					if (prevState !== null) {
						...
						if (nextDidTimeout) {
							var _nextFallbackChildren2 = nextProps.fallback,
								_primaryChildFragment2 = createWorkInProgress(currentPrimaryChildFragment, currentPrimaryChildFragment.pendingProps);
							if (((_primaryChildFragment2.return = workInProgress2), (workInProgress2.mode & BlockingMode) === NoMode)) {
								var _progressedState = workInProgress2.memoizedState,
									_progressedPrimaryChild = _progressedState !== null ? workInProgress2.child.child : workInProgress2.child;
							...
							var _nextPrimaryChildren = nextProps.children,
								...
								primaryChild = reconcileChildFibers(workInProgress2, currentPrimaryChild, _nextPrimaryChildren, renderExpirationTime2);
						...
						if (nextDidTimeout) {
							...
							if (
								...
								var _progressedState2 = workInProgress2.memoizedState,
									_progressedPrimaryChild2 = _progressedState2 !== null ? workInProgress2.child.child : workInProgress2.child;
			...
			function updateSuspenseListComponent(current2, workInProgress2, renderExpirationTime2) {
				...
				if (shouldForceFallback)
					(suspenseContext = setShallowSuspenseContext(suspenseContext, ForceSuspenseFallback)), (workInProgress2.effectTag |= DidCapture);
				else {
					var didSuspendBefore = current2 !== null && (current2.effectTag & DidCapture) !== NoEffect;
					didSuspendBefore && propagateSuspenseContextChange(workInProgress2, workInProgress2.child, renderExpirationTime2),
						(suspenseContext = setDefaultShallowSuspenseContext(suspenseContext));
				}
					...
					switch (revealOrder) {
						case 'forwards': {
							...
							lastContentRow === null
								...
								initSuspenseListRenderState(workInProgress2, !1, tail, lastContentRow, tailMode, workInProgress2.lastEffect);
							break;
						}
						case 'backwards': {
							var _tail = null,
			...
			function updateContextProvider(current2, workInProgress2, renderExpirationTime2) {
					...
					newValue = newProps.value;
				{
					...
					providerPropTypes && checkPropTypes(providerPropTypes, newProps, 'prop', 'Context.Provider', getCurrentFiberStackInDev);
				}
			...
			function bailoutOnAlreadyFinishedWork(current2, workInProgress2, renderExpirationTime2) {
				cancelWorkTimer(workInProgress2), current2 !== null && (workInProgress2.dependencies = current2.dependencies), stopProfilerTimerIfRunning();
				...
				return childExpirationTime < renderExpirationTime2 ? null : (cloneChildFibers(current2, workInProgress2), workInProgress2.child);
			}
			function remountFiber(current2, oldWorkInProgress, newWorkInProgress) {
				{
					...
					if (
						...
						for (; prevSibling.sibling !== oldWorkInProgress; )
							if (((prevSibling = prevSibling.sibling), prevSibling === null)) throw new Error('Expected to find the previous sibling.');
			...
			function beginWork(current2, workInProgress2, renderExpirationTime2) {
				...
				if (current2 !== null) {
					var oldProps = current2.memoizedProps,
						newProps = workInProgress2.pendingProps;
					if (oldProps !== newProps || hasContextChanged() || workInProgress2.type !== current2.type) didReceiveUpdate = !0;
						...
						switch (((didReceiveUpdate = !1), workInProgress2.tag)) {
							...
							case HostComponent:
								if (
									...
									return markSpawnedWork(Never), (workInProgress2.expirationTime = workInProgress2.childExpirationTime = Never), null;
								break;
							case ClassComponent: {
							...
							case SuspenseListComponent: {
								...
								if (didSuspendBefore) {
									if (_hasChildWork) return updateSuspenseListComponent(current2, workInProgress2, renderExpirationTime2);
				...
				switch (((workInProgress2.expirationTime = NoWork), workInProgress2.tag)) {
					...
					case FunctionComponent: {
						var _Component = workInProgress2.type,
							...
							resolvedProps = workInProgress2.elementType === _Component ? unresolvedProps : resolveDefaultProps(_Component, unresolvedProps);
					...
					case ClassComponent: {
						var _Component2 = workInProgress2.type,
							...
							_resolvedProps = workInProgress2.elementType === _Component2 ? _unresolvedProps : resolveDefaultProps(_Component2, _unresolvedProps);
					...
					case ForwardRef: {
						var type = workInProgress2.type,
							...
							_resolvedProps2 = workInProgress2.elementType === type ? _unresolvedProps2 : resolveDefaultProps(type, _unresolvedProps2);
					...
					case MemoComponent: {
						...
						return (
							...
							updateMemoComponent(current2, workInProgress2, _type2, _resolvedProps3, updateExpirationTime, renderExpirationTime2)
						);
					}
					case SimpleMemoComponent:
					...
					case IncompleteClassComponent: {
						var _Component3 = workInProgress2.type,
							...
							_resolvedProps4 = workInProgress2.elementType === _Component3 ? _unresolvedProps4 : resolveDefaultProps(_Component3, _unresolvedProps4);
				...
				switch (workInProgress2.tag) {
						...
						if (current2 !== null && workInProgress2.stateNode != null)
							...
							if (_wasHydrated)
								...
								appendAllChildren(instance, workInProgress2, !1, !1),
									(workInProgress2.stateNode = instance),
									finalizeInitialChildren(instance, type, newProps, rootContainerInstance) && markUpdate(workInProgress2);
							}
					...
					case SuspenseComponent: {
						...
						var nextDidTimeout = nextState !== null,
							prevDidTimeout = !1;
						if (current2 === null) workInProgress2.memoizedProps.fallback !== void 0 && popHydrationState(workInProgress2);
						else {
							var prevState = current2.memoizedState;
							if (((prevDidTimeout = prevState !== null), !nextDidTimeout && prevState !== null)) {
								...
								if (currentFallbackChild !== null) {
									...
									first !== null
										...
										: ((workInProgress2.firstEffect = workInProgress2.lastEffect = currentFallbackChild), (currentFallbackChild.nextEffect = null)),
						...
						if (nextDidTimeout && !prevDidTimeout && (workInProgress2.mode & BlockingMode) !== NoMode) {
							...
							hasInvisibleChildContext || hasSuspenseContext(suspenseStackCursor.current, InvisibleParentSuspenseContext)
								? renderDidSuspend()
						...
						if (renderedTail === null)
							if (didSuspendAlready) cutOffTailIfNeeded(renderState, !1);
								...
								if (!cannotBeSuspended)
									for (var row = workInProgress2.child; row !== null; ) {
										...
										if (suspended !== null) {
											(didSuspendAlready = !0), (workInProgress2.effectTag |= DidCapture), cutOffTailIfNeeded(renderState, !1);
											var newThennables = suspended.updateQueue;
											return (
												newThennables !== null && ((workInProgress2.updateQueue = newThennables), (workInProgress2.effectTag |= Update)),
							...
							if (!didSuspendAlready) {
								...
								if (_suspended !== null) {
									...
									if (
										(_newThennables !== null && ((workInProgress2.updateQueue = _newThennables), (workInProgress2.effectTag |= Update)),
									...
									(workInProgress2.effectTag |= DidCapture), (didSuspendAlready = !0), cutOffTailIfNeeded(renderState, !1);
									var nextPriority = renderExpirationTime2 - 1;
									(workInProgress2.expirationTime = workInProgress2.childExpirationTime = nextPriority), markSpawnedWork(nextPriority);
								}
							}
							if (renderState.isBackwards) (renderedTail.sibling = workInProgress2.child), (workInProgress2.child = renderedTail);
							else {
								var previousSibling = renderState.last;
								previousSibling !== null ? (previousSibling.sibling = renderedTail) : (workInProgress2.child = renderedTail),
			...
			function unwindWork(workInProgress2, renderExpirationTime2) {
				switch (workInProgress2.tag) {
					case ClassComponent: {
						...
						return effectTag & ShouldCapture ? ((workInProgress2.effectTag = (effectTag & ~ShouldCapture) | DidCapture), workInProgress2) : null;
					}
					case HostRoot: {
						popHostContainer(workInProgress2), popTopLevelContextObject(workInProgress2);
					...
					case SuspenseComponent: {
						...
						return _effectTag2 & ShouldCapture ? ((workInProgress2.effectTag = (_effectTag2 & ~ShouldCapture) | DidCapture), workInProgress2) : null;
					}
					case SuspenseListComponent:
...
Learn more about data fetching with Hooks: https://fb.me/react-hooks-data-fetching`)
			...
			function commitNestedUnmounts(finishedRoot, root2, renderPriorityLevel) {
				for (var node2 = root2; ; ) {
					if ((commitUnmount(finishedRoot, node2, renderPriorityLevel), node2.child !== null && node2.tag !== HostPortal)) {
						(node2.child.return = node2), (node2 = node2.child);
						continue;
					}
			...
			function insertOrAppendPlacementNode(node2, before, parent) {
				...
				if (isHost || enableFundamentalAPI) {
					...
					if (child !== null) {
						...
						for (var sibling = child.sibling; sibling !== null; ) insertOrAppendPlacementNode(sibling, before, parent), (sibling = sibling.sibling);
					}
				}
			}
				...
				for (var node2 = current2, currentParentIsValid = !1, currentParent, currentParentIsContainer; ; ) {
					...
					if (node2.tag === HostComponent || node2.tag === HostText)
						commitNestedUnmounts(finishedRoot, node2, renderPriorityLevel),
							currentParentIsContainer ? removeChildFromContainer(currentParent, node2.stateNode) : removeChild(currentParent, node2.stateNode);
					else if (node2.tag === HostPortal) {
						if (node2.child !== null) {
							(currentParent = node2.stateNode.containerInfo), (currentParentIsContainer = !0), (node2.child.return = node2), (node2 = node2.child);
							continue;
						}
			...
			function commitSuspenseComponent(finishedWork) {
				...
				newState === null ? (newDidTimeout = !1) : ((newDidTimeout = !0), (primaryChildParent = finishedWork.child), markCommitTimeOfFallback()),
					...
					inst !== null && typeof inst.componentDidCatch == 'function'
						? (update.callback = function () {
								markFailedErrorBoundaryForHotReloading(fiber),
									typeof getDerivedStateFromError != 'function' && (markLegacyErrorBoundaryAsFailed(this), logError(fiber, errorInfo));
			...
			function attachPingListener(root2, renderExpirationTime2, thenable) {
				...
				if (
					(pingCache === null
						? ((pingCache = root2.pingCache = new PossiblyWeakMap$1()), (threadIDs = new Set()), pingCache.set(thenable, threadIDs))
						: ((threadIDs = pingCache.get(thenable)), threadIDs === void 0 && ((threadIDs = new Set()), pingCache.set(thenable, threadIDs))),
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` +
			...
			function computeExpirationForFiber(currentTime, fiber, suspenseConfig) {
				...
				var expirationTime;
				if (suspenseConfig !== null) expirationTime = computeSuspenseExpiration(currentTime, suspenseConfig.timeoutMs | 0 || LOW_PRIORITY_EXPIRATION);
				else
					switch (priorityLevel) {
						case ImmediatePriority:
							expirationTime = Sync;
				...
				return workInProgressRoot !== null && expirationTime === renderExpirationTime$1 && (expirationTime -= 1), expirationTime;
			}
			function scheduleUpdateOnFiber(fiber, expirationTime) {
				...
				if (
					...
					if (rootsWithPendingDiscreteUpdates === null) rootsWithPendingDiscreteUpdates = new Map([[root2, expirationTime]]);
					else {
						var lastDiscreteTime = rootsWithPendingDiscreteUpdates.get(root2);
						(lastDiscreteTime === void 0 || lastDiscreteTime > expirationTime) && rootsWithPendingDiscreteUpdates.set(root2, expirationTime);
					}
			}
				...
				if (node2 === null && fiber.tag === HostRoot) root2 = fiber.stateNode;
					...
					for (; node2 !== null; ) {
						if (
							...
							alternate !== null && alternate.childExpirationTime < expirationTime && (alternate.childExpirationTime = expirationTime),
				...
				return (
					root2 !== null &&
						(workInProgressRoot === root2 &&
							...
							workInProgressRootExitStatus === RootSuspendedWithDelay && markRootSuspendedAtTime(root2, renderExpirationTime$1)),
			...
			function ensureRootIsScheduled(root2) {
				...
				if (expirationTime === NoWork) {
					existingCallbackNode !== null &&
						((root2.callbackNode = null), (root2.callbackExpirationTime = NoWork), (root2.callbackPriority = NoPriority));
					return;
				}
				var currentTime = requestCurrentTimeForUpdate(),
			...
			function performConcurrentWorkOnRoot(root2, didTimeout) {
				...
				if (expirationTime !== NoWork) {
					...
					if (
						...
						if ((ensureRootIsScheduled(root2), root2.callbackNode === originalCallbackNode)) return performConcurrentWorkOnRoot.bind(null, root2);
					}
				}
				return null;
			}
			function finishConcurrentRender(root2, finishedWork, exitStatus, expirationTime) {
				switch (((workInProgressRoot = null), exitStatus)) {
					...
					case RootSuspended: {
						...
						expirationTime === lastSuspendedTime && (root2.nextKnownPendingLevel = getRemainingExpirationTime(finishedWork));
					...
					case RootSuspendedWithDelay: {
						...
						if (
							(expirationTime === _lastSuspendedTime && (root2.nextKnownPendingLevel = getRemainingExpirationTime(finishedWork)),
			...
			function handleError(root2, thrownValue) {
				do {
					try {
						if ((resetContextDependencies(), resetHooksAfterThrow(), resetCurrentFiber(), workInProgress === null || workInProgress.return === null))
							return (workInProgressRootExitStatus = RootFatalErrored), (workInProgressRootFatalError = thrownValue), (workInProgress = null), null;
						enableProfilerTimer && workInProgress.mode & ProfileMode && stopProfilerTimerIfRunningAndRecordDelta(workInProgress, !0),
			...
			function pushDispatcher(root2) {
				...
				return (ReactCurrentDispatcher$1.current = ContextOnlyDispatcher), prevDispatcher === null ? ContextOnlyDispatcher : prevDispatcher;
			}
			...
			function markRenderEventTimeAndConfig(expirationTime, suspenseConfig) {
				expirationTime < workInProgressRootLatestProcessedExpirationTime &&
					...
					suspenseConfig !== null &&
						...
						expirationTime > Idle &&
						((workInProgressRootLatestSuspenseTimeout = expirationTime), (workInProgressRootCanSuspendUsingConfig = suspenseConfig));
			}
					...
					if ((workInProgress.effectTag & Incomplete) === NoEffect) {
						...
						if (returnFiber !== null && (returnFiber.effectTag & Incomplete) === NoEffect) {
							...
							effectTag > PerformedWork &&
								(returnFiber.lastEffect !== null ? (returnFiber.lastEffect.nextEffect = workInProgress) : (returnFiber.firstEffect = workInProgress),
						...
						stopWorkTimer(workInProgress),
							returnFiber !== null && ((returnFiber.firstEffect = returnFiber.lastEffect = null), (returnFiber.effectTag |= Incomplete));
					}
					...
					if ((completedWork.mode & ProfileMode) !== NoMode) {
						for (
							var actualDuration = completedWork.actualDuration,
								...
								shouldBubbleActualDurations = completedWork.alternate === null || completedWork.child !== completedWork.alternate.child,
			...
			function commitRootImpl(root2, renderPriorityLevel) {
				...
				markRootFinishedAtTime(root2, expirationTime, remainingExpirationTimeBeforeCommit),
					root2 === workInProgressRoot && ((workInProgressRoot = null), (workInProgress = null), (renderExpirationTime$1 = NoWork));
				var firstEffect;
				if (
					...
					(ReactCurrentOwner$2.current = null), startCommitSnapshotEffectsTimer(), prepareForCommit(root2.containerInfo), (nextEffect = firstEffect);
					do
					...
					stopCommitSnapshotEffectsTimer(), recordCommitTime(), startCommitHostEffectsTimer(), (nextEffect = firstEffect);
					do
				...
				if (remainingExpirationTime !== NoWork) {
					if (spawnedWorkDuringRender !== null) {
						...
						spawnedWorkDuringRender = null;
						for (var i = 0; i < expirationTimes.length; i++) scheduleInteractions(root2, expirationTimes[i], root2.memoizedInteractions);
					}
			...
			function commitLayoutEffects(root2, committedExpirationTime) {
				for (; nextEffect !== null; ) {
					...
					effectTag & Ref && (recordEffect(), commitAttachRef(nextEffect)), resetCurrentFiber(), (nextEffect = nextEffect.nextEffect);
				}
			}
			function flushPassiveEffects() {
				if (pendingPassiveEffectsRenderPriority !== NoPriority) {
					var priorityLevel = pendingPassiveEffectsRenderPriority > NormalPriority ? NormalPriority : pendingPassiveEffectsRenderPriority;
					return (pendingPassiveEffectsRenderPriority = NoPriority), runWithPriority$1(priorityLevel, flushPassiveEffectsImpl);
				}
			}
			function flushPassiveEffectsImpl() {
				...
				var prevExecutionContext = executionContext;
				executionContext |= CommitContext;
				for (var prevInteractions = pushInteractions(root2), _effect2 = root2.current.firstEffect; _effect2 !== null; ) {
					{
						if ((setCurrentFiber(_effect2), invokeGuardedCallback(null, commitPassiveHookEffects, null, _effect2), hasCaughtError())) {
			...
			function pingSuspendedRoot(root2, thenable, suspendedTime) {
				var pingCache = root2.pingCache;
				if ((pingCache !== null && pingCache.delete(thenable), workInProgressRoot === root2 && renderExpirationTime$1 === suspendedTime)) {
					workInProgressRootExitStatus === RootSuspendedWithDelay ||
				...
				if (isRootSuspendedAtTime(root2, suspendedTime)) {
					...
					(lastPingedTime !== NoWork && lastPingedTime < suspendedTime) ||
						((root2.lastPingedTime = suspendedTime), ensureRootIsScheduled(root2), schedulePendingInteractions(root2, suspendedTime));
				}
			}
			...
			function resolveRetryThenable(boundaryFiber, thenable) {
				var retryTime = NoWork,
					retryCache;
				(retryCache = boundaryFiber.stateNode), retryCache !== null && retryCache.delete(thenable), retryTimedOutBoundary(boundaryFiber, retryTime);
			}
			...
			function checkForInterruption(fiberThatReceivedUpdate, updateExpirationTime) {
				workInProgressRoot !== null && updateExpirationTime > renderExpirationTime$1 && (interruptedBy = fiberThatReceivedUpdate);
			}
...
For more info, visit https://fb.me/react-mock-scheduler`));
			...
			function markSpawnedWork(expirationTime) {
				spawnedWorkDuringRender === null ? (spawnedWorkDuringRender = [expirationTime]) : spawnedWorkDuringRender.push(expirationTime);
			}
...
Check the render method of \`` +
			...
			function createFiberFromSuspense(pendingProps, mode, expirationTime, key) {
				...
				return (fiber.type = REACT_SUSPENSE_TYPE), (fiber.elementType = REACT_SUSPENSE_TYPE), (fiber.expirationTime = expirationTime), fiber;
			}
			function createFiberFromSuspenseList(pendingProps, mode, expirationTime, key) {
				var fiber = createFiber(SuspenseListComponent, pendingProps, key, mode);
				return (
					(fiber.type = REACT_SUSPENSE_LIST_TYPE), (fiber.elementType = REACT_SUSPENSE_LIST_TYPE), (fiber.expirationTime = expirationTime), fiber
				);
			}
			...
			function markRootSuspendedAtTime(root2, expirationTime) {
				...
				firstSuspendedTime < expirationTime && (root2.firstSuspendedTime = expirationTime),
					(lastSuspendedTime > expirationTime || firstSuspendedTime === NoWork) && (root2.lastSuspendedTime = expirationTime),
			...
			function markRootFinishedAtTime(root2, finishedExpirationTime, remainingExpirationTime) {
				(root2.firstPendingTime = remainingExpirationTime),
					finishedExpirationTime <= root2.lastSuspendedTime
						? (root2.firstSuspendedTime = root2.lastSuspendedTime = root2.nextKnownPendingLevel = NoWork)
						: finishedExpirationTime <= root2.firstSuspendedTime && (root2.firstSuspendedTime = finishedExpirationTime - 1),
...
Check the render method of %s.`,
			...
			function markRetryTimeImpl(fiber, retryTime) {
				var suspenseState = fiber.memoizedState;
				suspenseState !== null && suspenseState.dehydrated !== null && suspenseState.retryTime < retryTime && (suspenseState.retryTime = retryTime);
			}
			...
			function attemptContinuousHydration$1(fiber) {
				fiber.tag === SuspenseComponent && (scheduleWork(fiber, ContinuousHydration), markRetryTimeIfNotHydrated(fiber, ContinuousHydration));
			}
				...
				setSuspenseHandler = null;
			{
				...
				(overrideHookState = function (fiber, id, path, value) {
					for (var currentHook2 = fiber.memoizedState; currentHook2 !== null && id > 0; ) (currentHook2 = currentHook2.next), id--;
			...
			if (
				...
				((navigator.userAgent.indexOf('Chrome') > -1 && navigator.userAgent.indexOf('Edge') === -1) || navigator.userAgent.indexOf('Firefox') > -1)
			) {
...
var isRgb = function (color2) {
	...
	isHsla = function (color2) {
		return (
			typeof color2.hue == 'number' && typeof color2.saturation == 'number' && typeof color2.lightness == 'number' && typeof color2.alpha == 'number'
		);
	};
...
var curriedTransparentize = curry(transparentize),
	...
	isColorString = (color2) =>
		typeof color2 != 'string'
			? (logger.warn(`Color passed to theme object should be a string. Instead ${color2}(${typeof color2}) was passed.`), !1)
			: !0,
	isValidColorForPolished = (color2) => !/(gradient|var|calc)/.test(color2),
	applyPolished = (type, color2) =>
		type === 'darken' ? rgba(`${curriedDarken$1(1, color2)}`, 0.95) : type === 'lighten' ? rgba(`${curriedLighten$1(1, color2)}`, 0.95) : color2,
	...
	getPreferredColorScheme = () =>
		!globalWindow || !globalWindow.matchMedia ? 'light' : globalWindow.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light',
...
function hash(value, length2) {
	return charat(value, 0) ^ 45
		? (((((((length2 << 2) ^ charat(value, 0)) << 2) ^ charat(value, 1)) << 2) ^ charat(value, 2)) << 2) ^ charat(value, 3)
		: 0;
}
function trim(value) {
	return value.trim();
				...
				switch (character2) {
					...
					default:
						if (
							...
							if (offset === 0) parse(characters2, root, reference, reference, props, rulesets, length2, points, children);
							else
...
var weakMemoize = function (func) {
	...
	identifierWithPointTracking = function (begin, points, index) {
		for (
			...
			(previous = character2), (character2 = peek()), previous === 38 && character2 === 12 && (points[index] = 1), !token(character2);
		...
		return function (element, index, children) {
			if (!(element.type !== 'rule' || cache.compat)) {
				...
				if (unsafePseudoClasses) {
					for (
						var isNested = !!element.parent, commentContainer = isNested ? element.parent.children : children, i = commentContainer.length - 1;
						i >= 0;
						i--
					) {
...
function prefix(value, length2) {
	switch (hash(value, length2)) {
		...
		case 4968:
			return (
				replace(replace(value, /(.+:)(flex-)?(.*)/, WEBKIT + 'box-pack:$3' + MS + 'flex-pack:$3'), /s.+-b[^;]+/, 'justify') + WEBKIT + value + value
			);
		case 4095:
		case 3583:
		case 4068:
				...
				case 101:
					return (
						replace(
							value,
							/(.+:)([^;!]+)(;|!.+)?/,
							'$1' + WEBKIT + (charat(value, 14) === 45 ? 'inline-' : '') + 'box$3$1' + WEBKIT + '$2$3$1' + MS + '$2box$3'
						) + value
					);
			}
			break;
...
`),
	...
	createEmotionProps = function (type, props) {
		...
		if (
			...
			props.css && (typeof props.css != 'object' || typeof props.css.name != 'string' || props.css.name.indexOf('-') === -1))
		) {
			...
			useInsertionEffectWithLayoutFallback(
				function () {
					var key = cache.key + '-global',
						sheet = new cache.sheet.constructor({ key, nonce: cache.sheet.nonce, container: cache.sheet.container, speedy: cache.sheet.isSpeedy }),
						rehydrating = !1,
...
var Insertion3 = function (_ref) {
	...
	ClassNames = withEmotionCache(function (props, cache) {
		...
		return (hasRendered = !0), React2.createElement(React2.Fragment, null, React2.createElement(Insertion3, { cache, serializedArr }), ele);
	});
			...
			return (
				...
				(Styled.withComponent = function (nextTag, nextOptions) {
					return createStyled2(
						nextTag,
						_extends2({}, options, nextOptions, { shouldForwardProp: composeShouldForwardProps(Styled, nextOptions, !0) })
					).apply(void 0, styles);
				}),
				Styled
			);
...
var createReset = (0, import_memoizerific.default)(1)(({ typography: typography2 }) => ({
	...
	createGlobal = (0, import_memoizerific.default)(1)(({ color: color2, background: background2, typography: typography2 }) => {
...
`,
	...
	convert = (inherit = themes[getPreferredColorScheme()]) => {
		...
		return {
			...
			barBg,
			brand: { title: brandTitle, url: brandUrl, image: brandImage || (brandTitle ? null : void 0), target: brandTarget },
