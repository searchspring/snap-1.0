				...
				var S = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
							...
							? ia
								? function (r, u, n) {
										if ((Ue(r), (u = gt(u)), Ue(n), typeof r == 'function' && u === 'prototype' && 'value' in n && _r in n && !n[_r])) {
											...
											D &&
												D[_r] &&
												((r[u] = n.value), (n = { configurable: vr in n ? n[vr] : D[vr], enumerable: Ar in n ? n[Ar] : D[Ar], writable: !1 }));
										}
										return Fr(r, u, n);
								  }
								: Fr
					...
					$t = S((a2, Lt) => {
						var Oa = se(),
							...
							$a = (Lt.exports = function (e, r, u) {
								String(r).slice(0, 7) === 'Symbol(' && (r = '[' + String(r).replace(/^Symbol\(([^)]*)\)/, '$1') + ']'),
									u && u.getter && (r = 'get ' + r),
									u && u.setter && (r = 'set ' + r),
									(!Xe(e, 'name') || (Ia && e.name !== r)) && (Ir ? He(e, 'name', { value: r, configurable: !0 }) : (e.name = r)),
									ka && u && Xe(u, 'arity') && e.length !== u.arity && He(e, 'length', { value: u.arity });
								try {
									u && Xe(u, 'constructor') && u.constructor ? Ir && He(e, 'prototype', { writable: !1 }) : e.prototype && (e.prototype = void 0);
								} catch {}
								var n = xa(e);
					...
					jt = S((o2, Mt) => {
						...
						Mt.exports = function (e, r, u, n) {
							...
							if ((Ma(u) && Ua(u, s, n), n.global)) D ? (e[r] = u) : Ga(r, u);
								...
								D ? (e[r] = u) : ja.f(e, r, { value: u, enumerable: !1, configurable: !n.nonConfigurable, writable: !n.nonWritable });
							}
							return e;
						};
					}),
						...
						En.exports = function (e, r) {
							...
							if ((n ? (i = Pr) : D ? (i = Pr[u] || wo(u, {})) : (i = (Pr[u] || {}).prototype), i))
								for (f in r) {
									if (
										((F = r[f]),
										e.dontCallGetSet ? ((a = To(i, f)), (c = a && a.value)) : (c = i[f]),
						...
						var jo = Lr(),
							...
							Tn = function (e, r, u, n, D, s, i, f) {
								for (var c = D, F = 0, a = i ? Vo(i, f) : !1, l, h; F < n; )
									F in u &&
										((l = a ? a(u[F], F, r) : u[F]),
										s > 0 && jo(l) ? ((h = Uo(l)), (c = Tn(e, r, l, h, c, s - 1) - 1)) : (Go(c + 1), (e[c] = l)),
										c++),
										F++;
								return c;
							};
					...
					Un = S((x2, jn) => {
						...
						jn.exports = function (e) {
							...
							return (
								$n(e) &&
									((r = e.constructor), oD(r) && (r === Mn || $n(r.prototype)) ? (r = void 0) : DD(r) && ((r = r[cD]), r === null && (r = void 0))),
								r === void 0 ? Mn : r
							);
						};
					}),
						...
						var el = Object.create,
							...
							fs = (e, r, u, n) => {
								if ((r && typeof r == 'object') || typeof r == 'function')
									for (let D of Xr(r)) !tl.call(e, D) && D !== u && Je(e, D, { get: () => r[D], enumerable: !(n = rl(r, D)) || n.enumerable });
								return e;
							},
							nl = (e, r, u) => (
								(u = e != null ? el(ul(e)) : {}), fs(r || !e || !e.__esModule ? Je(u, 'default', { value: e, enumerable: !0 }) : u, e)
							),
									...
									function N(o) {
										...
										for (let p = 0; p < o.length; p++) {
											...
											A <= 127
												...
												: A <= 2047
												? (E += String.fromCharCode(((A >> 6) & 31) | 192, (A & 63) | 128))
												: A <= 65535
												? (E += String.fromCharCode((A >> 12) | 224, ((A >> 6) & 63) | 128, (A & 63) | 128))
												: A <= 2097151 &&
												  (E += String.fromCharCode(((A >> 18) & 7) | 240, ((A >> 12) & 63) | 128, ((A >> 6) & 63) | 128, (A & 63) | 128));
										}
										return E;
									}
									e.utf8Encode = N;
...
`);
									...
									var x = typeof window < 'u' && window,
										k = typeof self < 'u' && typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope && self,
...
` && ++T == l
									...
									function c(a, l) {
										let h = u.identifierModuleUrl(l),
											C = h != null ? `in ${a} ${u.identifierName(l)} in ${h}` : `in ${a} ${u.identifierName(l)}`,
											d = new D('', C);
							...
							ol = I({
								'src/utils/front-matter/parse.js'(e, r) {
									...
									function n(D) {
										...
										let { startDelimiter: i, language: f, value: c = '', endDelimiter: F } = s.groups,
											a = f.trim() || 'yaml';
										if ((i === '+++' && (a = 'toml'), a !== 'yaml' && i !== F)) return { content: D };
										let [l] = s;
										return {
											frontMatter: { type: 'front-matter', lang: a, value: c, startDelimiter: i, endDelimiter: F, raw: l.replace(/\n$/, '') },
											content: l.replace(/[^\n]/g, ' ') + D.slice(l.length),
										};
									}
									r.exports = n;
						...
						var cl = Ee({
							...
							gs = I({
								'node_modules/semver/internal/debug.js'(e, r) {
									q();
									var u =
										typeof Te == 'object' && Te.env && Te.env.NODE_DEBUG && /\bsemver\b/i.test(Te.env.NODE_DEBUG)
											? function () {
							...
							hl = I({
								'node_modules/semver/internal/re.js'(e, r) {
									...
									c('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
										...
										c('MAINVERSION', `(${s[i.NUMERICIDENTIFIER]})\\.(${s[i.NUMERICIDENTIFIER]})\\.(${s[i.NUMERICIDENTIFIER]})`),
										c('MAINVERSIONLOOSE', `(${s[i.NUMERICIDENTIFIERLOOSE]})\\.(${s[i.NUMERICIDENTIFIERLOOSE]})\\.(${s[i.NUMERICIDENTIFIERLOOSE]})`),
										c('PRERELEASEIDENTIFIER', `(?:${s[i.NUMERICIDENTIFIER]}|${s[i.NONNUMERICIDENTIFIER]})`),
										c('PRERELEASEIDENTIFIERLOOSE', `(?:${s[i.NUMERICIDENTIFIERLOOSE]}|${s[i.NONNUMERICIDENTIFIER]})`),
										c('PRERELEASE', `(?:-(${s[i.PRERELEASEIDENTIFIER]}(?:\\.${s[i.PRERELEASEIDENTIFIER]})*))`),
										c('PRERELEASELOOSE', `(?:-?(${s[i.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${s[i.PRERELEASEIDENTIFIERLOOSE]})*))`),
										c('BUILDIDENTIFIER', '[0-9A-Za-z-]+'),
										c('BUILD', `(?:\\+(${s[i.BUILDIDENTIFIER]}(?:\\.${s[i.BUILDIDENTIFIER]})*))`),
										c('FULLPLAIN', `v?${s[i.MAINVERSION]}${s[i.PRERELEASE]}?${s[i.BUILD]}?`),
										c('FULL', `^${s[i.FULLPLAIN]}$`),
										c('LOOSEPLAIN', `[v=\\s]*${s[i.MAINVERSIONLOOSE]}${s[i.PRERELEASELOOSE]}?${s[i.BUILD]}?`),
										c('LOOSE', `^${s[i.LOOSEPLAIN]}$`),
										c('GTLT', '((?:<|>)?=?)'),
										c('XRANGEIDENTIFIERLOOSE', `${s[i.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`),
										c('XRANGEIDENTIFIER', `${s[i.NUMERICIDENTIFIER]}|x|X|\\*`),
										c(
											'XRANGEPLAIN',
											`[v=\\s]*(${s[i.XRANGEIDENTIFIER]})(?:\\.(${s[i.XRANGEIDENTIFIER]})(?:\\.(${s[i.XRANGEIDENTIFIER]})(?:${s[i.PRERELEASE]})?${
												s[i.BUILD]
											}?)?)?`
										),
										c(
											'XRANGEPLAINLOOSE',
											`[v=\\s]*(${s[i.XRANGEIDENTIFIERLOOSE]})(?:\\.(${s[i.XRANGEIDENTIFIERLOOSE]})(?:\\.(${s[i.XRANGEIDENTIFIERLOOSE]})(?:${
												s[i.PRERELEASELOOSE]
											})?${s[i.BUILD]}?)?)?`
										),
										c('XRANGE', `^${s[i.GTLT]}\\s*${s[i.XRANGEPLAIN]}$`),
										c('XRANGELOOSE', `^${s[i.GTLT]}\\s*${s[i.XRANGEPLAINLOOSE]}$`),
										c('COERCE', `(^|[^\\d])(\\d{1,${u}})(?:\\.(\\d{1,${u}}))?(?:\\.(\\d{1,${u}}))?(?:$|[^\\d])`),
										...
										c('COMPARATORTRIM', `(\\s*)${s[i.GTLT]}\\s*(${s[i.LOOSEPLAIN]}|${s[i.XRANGEPLAIN]})`, !0),
										(e.comparatorTrimReplace = '$1$2$3'),
										c('HYPHENRANGE', `^\\s*(${s[i.XRANGEPLAIN]})\\s+-\\s+(${s[i.XRANGEPLAIN]})\\s*$`),
										c('HYPHENRANGELOOSE', `^\\s*(${s[i.XRANGEPLAINLOOSE]})\\s+-\\s+(${s[i.XRANGEPLAINLOOSE]})\\s*$`),
										c('STAR', '(<|>)?=?\\s*\\*'),
										c('GTE0', '^\\s*>=\\s*0\\.0\\.0\\s*$'),
							...
							pl = I({
								'node_modules/semver/internal/parse-options.js'(e, r) {
									...
									var u = ['includePrerelease', 'loose', 'rtl'],
										n = (D) => (D ? (typeof D != 'object' ? { loose: !0 } : u.filter((s) => D[s]).reduce((s, i) => ((s[i] = !0), s), {})) : {});
									r.exports = n;
								},
							}),
							fl = I({
								...
								'node_modules/semver/classes/semver.js'(e, r) {
									...
									var u = gs(),
										...
										F = class {
											...
											compareMain(a) {
												return (
													a instanceof F || (a = new F(a, this.options)), c(this.major, a.major) || c(this.minor, a.minor) || c(this.patch, a.patch)
												);
											}
											comparePre(a) {
											...
											inc(a, l) {
												switch (a) {
													...
													case 'pre':
														...
														l &&
															(c(this.prerelease[0], l) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = [l, 0]) : (this.prerelease = [l, 0]));
														break;
													default:
							...
							Fl = I({
								'node_modules/outdent/lib/index.js'(e, r) {
									q(), Object.defineProperty(e, '__esModule', { value: !0 }), (e.outdent = void 0);
									function u() {
									...
									function T(g) {
										...
										function j(O) {
											...
											if (m(O)) {
												var $ = O,
													t = (x[0] === j || x[0] === w) && h.test($[0]) && a.test($[1]),
													o = t ? R : N,
													E = o.get($);
    ...
    `,
											...
											useTabs: { since: '1.0.0', category: c, type: 'boolean', default: !1, description: 'Indent with tabs instead of spaces.' },
									...
									function i() {
										let {
											...
											d = n(
												...
												.filter((g) => m(g) && T(g))
												.sort((g, N) => (g.name === N.name ? 0 : g.name < N.name ? -1 : 1))
												.map(w)
												.map((g) => {
													(g = Object.assign({}, g)),
														Array.isArray(g.default) &&
															(g.default =
																g.default.length === 1
																	? g.default[0].value
																	: g.default.filter(m).sort((R, j) => u.compare(j.since, R.since))[0].value),
														Array.isArray(g.choices) && ((g.choices = g.choices.filter((R) => m(R) && T(R))), g.name === 'parser' && f(g, C, c));
													let N = Object.fromEntries(
														c.filter((R) => R.defaultOptions && R.defaultOptions[g.name] !== void 0).map((R) => [R.name, R.defaultOptions[g.name]])
													);
							...
							xl = I({
								'src/common/util.js'(e, r) {
									...
									var { default: u } = (cl(), ds(ms)),
										...
										s = _l(),
										i = Il(),
										{ skipWhitespace: f, skipSpaces: c, skipToLineEnd: F, skipEverythingButNewLine: a } = zr(),
										l = _s(),
										h = Ss(),
										C = ys(),
										d = Rl(),
...
`
									...
									function N(v, y, B) {
										let b = B(y) - 1;
										(b = c(v, b, { backwards: !0 })), (b = C(v, b, { backwards: !0 })), (b = c(v, b, { backwards: !0 }));
...
`);
									...
									function M(v, y) {
										(v.comments || (v.comments = [])).push(y), (y.printed = !1), (y.nodeDescription = J(v));
									}
									function z(v, y) {
										...
										let y = v.type || v.kind || '(unknown type)',
											B = String(
												v.name ||
													...
													(v.value && (typeof v.value == 'object' ? '' : String(v.value))) ||
													v.operator ||
													''
											);
									...
									var u = { attrs: !0, children: !0 },
										...
										D = class {
											constructor() {
												...
												for (let f of new Set([...n, ...Object.keys(i)])) this.setProperty(f, i[f]);
											}
											setProperty(i, f) {
												if (this[i] !== f) {
													...
													Object.defineProperty(this, i, { value: f, enumerable: !1, configurable: !0 });
												}
											}
											map(i) {
												let f;
										...
										let [, l, h, C] = a,
											...
											[w, g] = (() => {
												try {
													...
													return [!1, [{ type: 'text', value: C, sourceSpan: new u(m, T) }]];
												}
											})();
										return {
...
`,
										...
										u = class {
											constructor() {
												...
												(this.closedByChildren = {}),
													...
													(this.canSelfClose = !1),
													i && i.length > 0 && i.forEach((h) => (this.closedByChildren[h] = !0)),
													(this.isVoid = a),
							...
							bs = I({
								'node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js'(e) {
									...
									var i = class {
										constructor(d, m, T) {
											let w = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null,
												g = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null,
												N = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null;
											(this.name = d),
												(this.value = m),
												(this.sourceSpan = T),
												(this.valueSpan = w),
									...
									var f = class {
										constructor(d, m, T, w) {
											let g = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null,
												N = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null,
												R = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : null,
												j = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null;
											(this.name = d),
												(this.attrs = m),
												(this.children = T),
												(this.sourceSpan = w),
									...
									function a(d, m) {
										let T = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null,
											w = [],
											g = d.visit ? (N) => d.visit(N, T) || N.visit(d, T) : (N) => N.visit(d, T);
										return (
											m.forEach((N) => {
												let R = g(N);
												R && w.push(R);
										...
										return (
											d instanceof f &&
												(d.endSourceSpan
													...
													: d.children && d.children.length && (T = h(d.children[d.children.length - 1]).end)),
											{ start: m, end: T }
										);
									}
									function C(d, m) {
									...
									function r(D, s) {
										if (s != null) {
											...
											for (let i = 0; i < s.length; i += 1)
												if (typeof s[i] != 'string') throw new Error(`Expected '${D}' to be an array of strings.`);
										}
									}
										...
										d = class {
											constructor(t, o, E) {
												(this._getTagContentType = o),
													...
													(this._interpolationConfig = E.interpolationConfig || n.DEFAULT_INTERPOLATION_CONFIG),
													(this._leadingTriviaCodePoints = E.leadingTriviaChars && E.leadingTriviaChars.map((A) => A.codePointAt(0) || 0)),
													(this._canSelfClose = E.canSelfClose || !1),
													(this._allowHtmComponentClosingTags = E.allowHtmComponentClosingTags || !1);
...
`
											...
											_tokenizeExpansionForm() {
												...
												if (R(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
											...
											_attemptCharCodeCaseInsensitive(t) {
												return j(this._cursor.peek(), t) ? (this._cursor.advance(), !0) : !1;
											}
											_requireCharCode(t) {
												let o = this._cursor.clone();
											...
											_attemptStr(t) {
												...
												for (let p = 0; p < o; p++) if (!this._attemptCharCode(t.charCodeAt(p))) return (this._cursor = E), !1;
												return !0;
											}
											...
											_decodeEntity() {
												...
												if ((this._cursor.advance(), this._attemptCharCode(r.$HASH))) {
													let o = this._attemptCharCode(r.$x) || this._attemptCharCode(r.$X),
											...
											_consumePrefixAndName() {
												...
												this._cursor.peek() === r.$COLON
													? ((o = this._cursor.getChars(t)), this._cursor.advance(), (E = this._cursor.clone()))
													: (E = t),
											...
											_consumeTagOpen(t) {
												...
												try {
													...
													for (
														p = this._consumeTagOpenStart(t), E = p.parts[0], o = p.parts[1], this._attemptCharCodeUntilFn(m);
												...
												this._handleFullNameStackForTagOpen(E, o),
													z === D.TagContentType.RAW_TEXT
														...
														: z === D.TagContentType.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(E, o, !0);
											}
											_consumeRawTextWithTagClose(t, o, E) {
												this._consumeRawText(E, () =>
													!this._attemptCharCode(r.$LT) ||
													!this._attemptCharCode(r.$SLASH) ||
													(this._attemptCharCodeUntilFn(m), !this._attemptStrCaseInsensitive(t ? `${t}:${o}` : o))
														? !1
											...
											_consumeAttributeValue() {
												...
												if (this._cursor.peek() === r.$SQ || this._cursor.peek() === r.$DQ) {
													...
													let E = [];
													for (; this._cursor.peek() !== o; ) E.push(this._readChar(!0));
											...
											_consumeText() {
												...
												do
													this._interpolationConfig && this._attemptStr(this._interpolationConfig.start)
														? (o.push(this._interpolationConfig.start), (this._inInterpolation = !0))
														: this._interpolationConfig && this._inInterpolation && this._attemptStr(this._interpolationConfig.end)
														? (o.push(this._interpolationConfig.end), (this._inInterpolation = !1))
											...
											_isInExpansionCase() {
												return (
													...
													this._expansionCaseStack[this._expansionCaseStack.length - 1] === s.EXPANSION_CASE_EXP_START
												);
											}
											_isInExpansionForm() {
												return (
													this._expansionCaseStack.length > 0 &&
													this._expansionCaseStack[this._expansionCaseStack.length - 1] === s.EXPANSION_FORM_START
												);
											}
											...
											_handleFullNameStackForTagOpen(t, o) {
												...
												(this._fullNameStack.length === 0 || this._fullNameStack[this._fullNameStack.length - 1] === E) &&
									...
									function O(t) {
										...
										for (let p = 0; p < t.length; p++) {
											...
											E && E.type == s.TEXT && A.type == s.TEXT
												? ((E.parts[0] += A.parts[0]), (E.sourceSpan.end = A.sourceSpan.end))
												: ((E = A), o.push(E));
										}
										return o;
									}
									var x = class {
											constructor(t, o) {
												if (t instanceof x)
													...
													(this.file = t),
														...
														(this.end = o.endPos),
														(this.state = { peek: -1, offset: o.startPos, line: o.startLine, column: o.startCol });
												}
											}
											clone() {
												return new x(this);
											...
											getSpan(t, o) {
												...
												return new u.ParseSourceSpan(
													new u.ParseLocation(t.file, t.state.offset, t.state.line, t.state.column),
													new u.ParseLocation(this.file, this.state.offset, this.state.line, this.state.column)
												);
											}
											getChars(t) {
										...
										k = class extends x {
											constructor(t, o) {
												t instanceof k
													? (super(t), (this.internalState = Object.assign({}, t.internalState)))
									...
									var c = class {
										...
										_consumeComment(a) {
											let l = this._advanceIf(n.TokenType.RAW_TEXT),
												...
												d = new r.ParseSourceSpan(a.sourceSpan.start, (h || l || a).sourceSpan.end);
										...
										_parseExpansionCase() {
											...
											let m = new r.ParseSourceSpan(a.sourceSpan.start, C.sourceSpan.end),
										...
										_collectExpansionExpTokens(a) {
											...
											for (;;) {
												if (
													((this._peek.type === n.TokenType.EXPANSION_FORM_START || this._peek.type === n.TokenType.EXPANSION_CASE_EXP_START) &&
...
`
										...
										_consumeStartTag(a) {
											...
											if (this._peek.type === n.TokenType.TAG_OPEN_END_VOID) {
												...
												this.canSelfClose ||
													...
													R.isVoid ||
													this._errors.push(s.create(d, a.sourceSpan, `Only void and foreign elements can be self closed "${a.parts[1]}"`));
											} else this._peek.type === n.TokenType.TAG_OPEN_END && (this._advance(), (m = !1));
											let T = this._peek.sourceSpan.start,
												w = new r.ParseSourceSpan(a.sourceSpan.start, T),
												g = new r.ParseSourceSpan(a.sourceSpan.start.moveBy(1), a.sourceSpan.end),
												N = new u.Element(d, C, [], w, w, void 0, g);
											this._pushElement(N), m && (this._popElement(d), (N.endSourceSpan = w));
										}
										_pushElement(a) {
											let l = this._getParentElement();
											l && this.getTagDefinition(l.name).isClosedByChild(a.name) && this._elementStack.pop(),
												this._addToParent(a),
										...
										_consumeEndTag(a) {
											let l =
												this.allowHtmComponentClosingTags && a.parts.length === 0
													? null
													: this._getElementFullName(a.parts[0], a.parts[1], this._getParentElement());
										...
										_consumeAttr(a) {
											let l = D.mergeNsAndName(a.parts[0], a.parts[1]),
												...
												m;
											if (
												(this._peek.type === n.TokenType.ATTR_QUOTE && (m = this._advance().sourceSpan.start),
											...
											return (
												this._peek.type === n.TokenType.ATTR_QUOTE && ((h = this._advance().sourceSpan.end), (d = new r.ParseSourceSpan(m, h))),
												new u.Attribute(l, C, new r.ParseSourceSpan(a.sourceSpan.start, h), d, a.sourceSpan)
											);
										}
										_getParentElement() {
										...
										_getElementFullName(a, l, h) {
											return (
												a === '' &&
													((a = this.getTagDefinition(l).implicitNamespacePrefix || ''), a === '' && h != null && (a = D.getNsPrefix(h.name))),
								...
								'node_modules/angular-html-parser/lib/angular-html-parser/src/index.js'(e) {
									...
									function s(i) {
										let f = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
											{ canSelfClose: c = !1, allowHtmComponentClosingTags: F = !1, isTagNameCaseSensitive: a = !1, getTagContentType: l } = f;
										return D().parse(
											i,
											'angular-html-parser',
											{ tokenizeExpansionForms: !1, interpolationConfig: void 0, canSelfClose: c, allowHtmComponentClosingTags: F },
											a,
											l
										);
									}
						...
						function oc(e, r, u) {
							...
							if (u.parser === 'vue')
								if (d.some((O) => (O.type === 'docType' && O.value === 'html') || (O.type === 'element' && O.name.toLowerCase() === 'html'))) {
									...
									if (d.some(O)) {
										let x,
											k = () => F.parse(e, { canSelfClose: n, allowHtmComponentClosingTags: i, isTagNameCaseSensitive: f }),
											$ = () => x || (x = k()),
											t = (o) =>
												$().rootNodes.find((E) => {
							...
							let T = (_) => {
									...
									switch (_.type) {
										case 'element':
											...
											for (let O of _.attrs)
												T(O),
													O.valueSpan
														? ((O.value = O.valueSpan.toString()), /["']/.test(O.value[0]) && (O.value = O.value.slice(1, -1)))
														: (O.value = null);
											break;
										case 'comment':
								...
								N = (_) => {
									if (
										_.type === 'element' &&
										(D && (!_.namespace || _.namespace === _.tagDefinition.implicitNamespacePrefix || hs(_)) && (_.name = g(_.name, (O) => O in uc)),
										s)
									) {
						...
						function Ns(e, r, u) {
							let n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0,
								{ frontMatter: D, content: s } = n ? Jl(e) : { frontMatter: null, content: e },
							...
							let a = new nc(F),
								l = (h, C) => {
									...
									return (
										g.length === d
											? w.children.shift()
											: ((g.sourceSpan = new Qe(g.sourceSpan.start.moveBy(d), g.sourceSpan.end)), (g.value = g.value.slice(d))),
										w
									);
								};
							return (
						...
						Os.exports = {
							parsers: {
								html: Ke({ name: 'html', canSelfClose: !0, normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 }),
				...
				var xe = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports),
							...
							? Dc
								? function (r, t, s) {
										if ((vr(r), (t = Is(t)), vr(s), typeof r == 'function' && t === 'prototype' && 'value' in s && fn in s && !s[fn])) {
											...
											a &&
												a[fn] &&
												((r[t] = s.value), (s = { configurable: pn in s ? s[pn] : a[pn], enumerable: cn in s ? s[cn] : a[cn], writable: !1 }));
										}
										return ln(r, t, s);
								  }
								: ln
						...
						var qc = Dt(),
							...
							Uc = (Qs.exports = function (e, r, t) {
								String(r).slice(0, 7) === 'Symbol(' && (r = '[' + String(r).replace(/^Symbol\(([^)]*)\)/, '$1') + ']'),
									t && t.getter && (r = 'get ' + r),
									t && t.setter && (r = 'set ' + r),
									(!Fr(e, 'name') || (Rc && e.name !== r)) && (Fn ? Ar(e, 'name', { value: r, configurable: !0 }) : (e.name = r)),
									Hc && t && Fr(t, 'arity') && e.length !== t.arity && Ar(e, 'length', { value: t.arity });
								try {
									t && Fr(t, 'constructor') && t.constructor ? Fn && Ar(e, 'prototype', { writable: !1 }) : e.prototype && (e.prototype = void 0);
								} catch {}
								var s = Vc(e);
					...
					ei = xe((Z0, Zs) => {
						...
						Zs.exports = function (e, r, t, s) {
							...
							if ((Jc(t) && Xc(t, n, s), s.global)) a ? (e[r] = t) : Kc(r, t);
								...
								a ? (e[r] = t) : zc.f(e, r, { value: t, enumerable: !1, configurable: !s.nonConfigurable, writable: !s.nonWritable });
							}
							return e;
						};
					}),
						...
						Bi.exports = function (e, r) {
							...
							if ((s ? (u = xn) : a ? (u = xn[t] || Lp(t, {})) : (u = (xn[t] || {}).prototype), u))
								for (i in r) {
									if (
										((p = r[i]),
										e.dontCallGetSet ? ((y = Pp(u, i)), (l = y && y.value)) : (l = u[i]),
						...
						var Up = bn(),
							...
							Oi = function (e, r, t, s, a, n, u, i) {
								for (var l = a, p = 0, y = u ? Xp(u, i) : !1, h, g; p < s; )
									p in t &&
										((h = y ? y(t[p], p, r) : t[p]),
										n > 0 && Up(h) ? ((g = Jp(h)), (l = Oi(e, r, h, g, l, n - 1) - 1)) : (zp(l + 1), (e[l] = h)),
										l++),
										p++;
								return l;
							};
					...
					Yi = xe((Fy, Ki) => {
						...
						Ki.exports = function (e) {
							...
							return (
								zi(e) &&
									((r = e.constructor), mf(r) && (r === Xi || zi(r.prototype)) ? (r = void 0) : df(r) && ((r = r[yf]), r === null && (r = void 0))),
								r === void 0 ? Xi : r
							);
						};
					}),
					...
					Ca = xe((Ly, va) => {
						...
						va.exports = function (e, r, t) {
							return t.get && ha(t.get, r, { getter: !0 }), t.set && ha(t.set, r, { setter: !0 }), nD.f(e, r, t);
						};
					}),
					Fa = xe((Oy, Ea) => {
						var uD = Tt();
					...
					e0 = xe((Uy, jo) => {
						...
						var FD = Object.create,
							...
							Pa = (e, r, t, s) => {
								if ((r && typeof r == 'object') || typeof r == 'function')
									for (let a of Gn(r)) !xD.call(e, a) && a !== t && _r(e, a, { get: () => r[a], enumerable: !(s = AD(r, a)) || s.enumerable });
								return e;
							},
							bD = (e, r, t) => (
								(t = e != null ? FD(SD(e)) : {}), Pa(r || !e || !e.__esModule ? _r(t, 'default', { value: e, enumerable: !0 }) : t, e)
							),
									...
									r.prototype = {
												...
												for (var N = -1 * c; N <= c; N += 2) {
													...
													if (
														(!D || (T && I.newPos < P.newPos)
															...
															: ((x = I), x.newPos++, p.pushComponent(x.components, !0, void 0)),
										...
										equals: function (n, u) {
											return this.options.comparator
												...
												: n === u || (this.options.ignoreCase && n.toLowerCase() === u.toLowerCase());
										},
										...
										for (; b.length > 0; ) {
											...
											if ((v && b.push(B, i), !d || d(B) !== !1))
												if (n(B) || B.type === 'fill') {
													...
													if (S) for (let k = B.expandedStates.length, M = k - 1; M >= 0; --M) b.push(B.expandedStates[M]);
									...
									function F(x, I, P) {
										return I === Number.NEGATIVE_INFINITY
											...
											? I.type === 'root'
												...
												: _(x, { type: typeof I == 'string' ? 'stringAlign' : 'numberAlign', n: I }, P)
											: x;
									}
									function _(x, I, P) {
...
`
												...
												switch (b.type) {
													...
													case 'fill': {
														...
														let j = { ind: v, mode: S, doc: n(k) },
															Y = k[0];
														E({ ind: v, mode: g, doc: [M, R, Y] }, [], B, o.length > 0, !0) ? T.push(j, Q, q) : L ? T.push(j, V, q) : T.push(j, V, J);
														break;
													}
													case 'if-break':
													case 'indent-if-break': {
								...
								'src/document/doc-debug.js'(e, r) {
									...
									function a(u) {
										...
										return u.type === 'if-break'
											? Object.assign(Object.assign({}, u), {}, { breakContents: a(u.breakContents), flatContents: a(u.flatContents) })
											: u.type === 'group'
											? Object.assign(
													Object.assign({}, u),
													{},
													{ contents: a(u.contents), expandedStates: u.expandedStates && u.expandedStates.map(a) }
											  )
											: u.type === 'fill'
										...
										function p(h, g, c) {
											...
											if (h.type === 'if-break')
												return (
													...
													(h.groupId ? (h.flatContents ? '' : ', ""') + `, { groupId: ${y(h.groupId)} }` : '') +
													')'
												);
						...
						var $D = ht({
							...
							qa = te({
								'node_modules/semver/internal/debug.js'(e, r) {
									ne();
									var t =
										typeof wt == 'object' && wt.env && wt.env.NODE_DEBUG && /\bsemver\b/i.test(wt.env.NODE_DEBUG)
											? function () {
							...
							VD = te({
								'node_modules/semver/internal/re.js'(e, r) {
									...
									l('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
										...
										l('MAINVERSION', `(${n[u.NUMERICIDENTIFIER]})\\.(${n[u.NUMERICIDENTIFIER]})\\.(${n[u.NUMERICIDENTIFIER]})`),
										l('MAINVERSIONLOOSE', `(${n[u.NUMERICIDENTIFIERLOOSE]})\\.(${n[u.NUMERICIDENTIFIERLOOSE]})\\.(${n[u.NUMERICIDENTIFIERLOOSE]})`),
										l('PRERELEASEIDENTIFIER', `(?:${n[u.NUMERICIDENTIFIER]}|${n[u.NONNUMERICIDENTIFIER]})`),
										l('PRERELEASEIDENTIFIERLOOSE', `(?:${n[u.NUMERICIDENTIFIERLOOSE]}|${n[u.NONNUMERICIDENTIFIER]})`),
										l('PRERELEASE', `(?:-(${n[u.PRERELEASEIDENTIFIER]}(?:\\.${n[u.PRERELEASEIDENTIFIER]})*))`),
										l('PRERELEASELOOSE', `(?:-?(${n[u.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${n[u.PRERELEASEIDENTIFIERLOOSE]})*))`),
										l('BUILDIDENTIFIER', '[0-9A-Za-z-]+'),
										l('BUILD', `(?:\\+(${n[u.BUILDIDENTIFIER]}(?:\\.${n[u.BUILDIDENTIFIER]})*))`),
										l('FULLPLAIN', `v?${n[u.MAINVERSION]}${n[u.PRERELEASE]}?${n[u.BUILD]}?`),
										l('FULL', `^${n[u.FULLPLAIN]}$`),
										l('LOOSEPLAIN', `[v=\\s]*${n[u.MAINVERSIONLOOSE]}${n[u.PRERELEASELOOSE]}?${n[u.BUILD]}?`),
										...
										l(
											'XRANGEPLAIN',
											`[v=\\s]*(${n[u.XRANGEIDENTIFIER]})(?:\\.(${n[u.XRANGEIDENTIFIER]})(?:\\.(${n[u.XRANGEIDENTIFIER]})(?:${n[u.PRERELEASE]})?${
												n[u.BUILD]
											}?)?)?`
										),
										l(
											'XRANGEPLAINLOOSE',
											`[v=\\s]*(${n[u.XRANGEIDENTIFIERLOOSE]})(?:\\.(${n[u.XRANGEIDENTIFIERLOOSE]})(?:\\.(${n[u.XRANGEIDENTIFIERLOOSE]})(?:${
												n[u.PRERELEASELOOSE]
											})?${n[u.BUILD]}?)?)?`
										),
										l('XRANGE', `^${n[u.GTLT]}\\s*${n[u.XRANGEPLAIN]}$`),
										l('XRANGELOOSE', `^${n[u.GTLT]}\\s*${n[u.XRANGEPLAINLOOSE]}$`),
										l('COERCE', `(^|[^\\d])(\\d{1,${t}})(?:\\.(\\d{1,${t}}))?(?:\\.(\\d{1,${t}}))?(?:$|[^\\d])`),
										...
										l('COMPARATORTRIM', `(\\s*)${n[u.GTLT]}\\s*(${n[u.LOOSEPLAIN]}|${n[u.XRANGEPLAIN]})`, !0),
										(e.comparatorTrimReplace = '$1$2$3'),
										l('HYPHENRANGE', `^\\s*(${n[u.XRANGEPLAIN]})\\s+-\\s+(${n[u.XRANGEPLAIN]})\\s*$`),
										l('HYPHENRANGELOOSE', `^\\s*(${n[u.XRANGEPLAINLOOSE]})\\s+-\\s+(${n[u.XRANGEPLAINLOOSE]})\\s*$`),
										l('STAR', '(<|>)?=?\\s*\\*'),
										l('GTE0', '^\\s*>=\\s*0\\.0\\.0\\s*$'),
								...
								'node_modules/semver/classes/semver.js'(e, r) {
									...
									var t = qa(),
										...
										p = class {
											...
											compareMain(y) {
												return (
													y instanceof p || (y = new p(y, this.options)), l(this.major, y.major) || l(this.minor, y.minor) || l(this.patch, y.patch)
												);
											}
											comparePre(y) {
											...
											inc(y, h) {
												switch (y) {
													...
													case 'pre':
														...
														h &&
															(l(this.prerelease[0], h) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = [h, 0]) : (this.prerelease = [h, 0]));
														break;
													default:
    ...
    `,
											...
											useTabs: { since: '1.0.0', category: l, type: 'boolean', default: !1, description: 'Indent with tabs instead of spaces.' },
											embeddedLanguageFormatting: {
												since: '2.1.0',
												category: l,
												type: 'choice',
									...
									function u() {
										let {
											...
											f = s(
												...
												.filter((E) => F(E) && _(E))
												.sort((E, N) => (E.name === N.name ? 0 : E.name < N.name ? -1 : 1))
												.map(w)
												.map((E) => {
													(E = Object.assign({}, E)),
														Array.isArray(E.default) &&
															(E.default =
																E.default.length === 1
																	? E.default[0].value
																	: E.default.filter(F).sort((x, I) => t.compare(I.since, x.since))[0].value),
														Array.isArray(E.choices) && ((E.choices = E.choices.filter((x) => F(x) && _(x))), E.name === 'parser' && i(E, c, l));
													let N = Object.fromEntries(
														l.filter((x) => x.defaultOptions && x.defaultOptions[E.name] !== void 0).map((x) => [x.name, x.defaultOptions[E.name]])
													);
							...
							Ue = te({
								'src/common/util.js'(e, r) {
									...
									var { default: t } = ($D(), ft(ja)),
										...
										n = Kn(),
										u = Oa(),
										{ skipWhitespace: i, skipSpaces: l, skipToLineEnd: p, skipEverythingButNewLine: y } = Pr(),
										h = Ra(),
										g = $a(),
										c = Va(),
										f = YD(),
...
`);
									...
									function o(V, j) {
										let Y = V.slice(1, -1),
											ie =
												j.parser === 'json' || (j.parser === 'json5' && j.quoteProps === 'preserve' && !j.singleQuote)
													? '"'
							...
							function l(p) {
								...
								for (; t; )
									try {
										if (
											((s = 1),
											a && (n = p[0] & 2 ? a.return : p[0] ? a.throw || ((n = a.return) && n.call(a), 0) : a.next) && !(n = n.call(a, p[1])).done)
										)
											return n;
							...
							eu = te({
								'node_modules/vnopts/lib/utils.js'(e) {
									...
									function p(c, f) {
										...
										return c === !1 ? !1 : c === !0 ? (F ? !0 : [{ value: f }]) : 'value' in c ? [c] : c.length === 0 ? !1 : c;
									}
											...
											constructor(a) {
												super(a),
													(this._choices = t.mapFromArray(
														a.choices.map((n) => (n && typeof n == 'object' ? n : { value: n })),
														'value'
													));
											}
											expected(a) {
											...
											for (let p of i) {
												...
												let c = (w) => {
													...
													f = (w) => {
														...
														if (x !== !1)
															if (x === !0) this._hasDeprecationWarned(p) || this._utils.logger.warn(this._deprecatedHandler(p, N, this._utils));
															else
							...
							Om = te({
								'src/main/options-normalizer.js'(e, r) {
												...
												preprocess(_, w) {
													if (typeof _ == 'string' && _.length > 0 && !this._flags.includes(_)) {
														...
														if (E)
															return (
																w.logger.warn(
																	[`Unknown flag ${c.yellow(w.descriptor.value(_))},`, `did you mean ${c.blue(w.descriptor.value(E))}?`].join(' ')
																),
																E
															);
													}
									...
									function l(g, c) {
										...
										for (let E of g)
											w.push(p(E, { isCLI: f, optionInfos: g, colorsModule: F, levenshteinDistance: _ })),
												E.alias && f && w.push(t.AliasSchema.create({ name: E.alias, sourceName: E.name }));
										return w;
									}
									function p(g, c) {
										let { isCLI: f, optionInfos: F, colorsModule: _, levenshteinDistance: w } = c,
											{ name: E } = g;
												...
												(x = t.ChoiceSchema),
													(N.choices = g.choices.map((P) =>
														typeof P == 'object' && P.redirect
															? Object.assign(Object.assign({}, P), {}, { redirect: { to: { key: g.name, value: P.redirect } } })
															: P
													));
												break;
											case 'boolean':
										...
										if (
											...
											g.redirect && (I.redirect = (P) => (P ? { to: { key: g.redirect.option, value: g.redirect.value } } : void 0)),
										...
										return g.array
											? t.ArraySchema.create(
													Object.assign(
														Object.assign(Object.assign({}, f ? { preprocess: (P) => (Array.isArray(P) ? P : [P]) } : {}), I),
														{},
...
` + w.codeFrame),
								...
								'src/main/options.js'(e, r) {
									...
									function l(h) {
										let g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
											...
											F = Object.assign(
												Object.assign({}, i),
												Object.fromEntries(f.filter((x) => x.default !== void 0).map((x) => [x.name, x.default]))
											);
										if (!c.parser) {
											if (!c.filepath)
										...
										let E = Object.fromEntries(
												f.filter((x) => x.pluginDefaults && x.pluginDefaults[w.name] !== void 0).map((x) => [x.name, x.pluginDefaults[w.name]])
											),
										...
										return (
											...
											n.normalizeApiOptions(c, f, Object.assign({ passThrough: Object.keys(i) }, g))
										);
									}
									function p(h) {
										let { astFormat: g } = h;
							...
							et = te({
								'src/main/comments.js'(e, r) {
									...
									var t = Zt(),
										{
											builders: { line: s, hardline: a, breakParent: n, indent: u, lineSuffix: i, join: l, cursor: p },
										} = qe(),
										{
											hasNewline: y,
											skipNewline: h,
									...
									function I(k, M, R, q) {
										...
										let J = [],
											...
											{ avoidAstMutation: j, ownLine: Y = x, endOfLine: ie = x, remaining: ee = x } = V,
											ce = k.map((W, K) =>
												Object.assign(
													Object.assign({}, N(M, W, q)),
													{},
													{ comment: W, text: R, options: q, ast: M, isLastComment: k.length - 1 === K }
												)
											);
										for (let [W, K] of ce.entries()) {
											...
											let ge;
											if (
												(j ? (ge = [K]) : ((de.enclosingNode = Fe), (de.precedingNode = ue), (de.followingNode = z), (ge = [de, U, Z, se, fe])),
												$(U, Z, ce, W))
											)
									...
									function o(k, M) {
										...
										if (J.isBlockComment && J.isBlockComment(R)) {
											let ie = y(L, V(R)) ? (y(L, Q(R), { backwards: !0 }) ? a : s) : ' ';
											q.push(ie);
										} else q.push(a);
										let Y = h(L, g(L, V(R)));
							...
							Vm = te({
								'src/main/multiparser.js'(e, r) {
									...
									function u(i, l, p, y) {
										let { stripTrailingHardline: h = !1 } = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {},
											g = s(Object.assign(Object.assign(Object.assign({}, p), l), {}, { parentParser: p.parser, originalText: i }), {
												passThrough: !0,
											}),
											c = tu().parse(i, g),
											{ ast: f } = c;
							...
							Wm = te({
								'src/main/ast-to-doc.js'(e, r) {
									...
									function p(h, g) {
										let { originalText: c, [Symbol.for('comments')]: f, locStart: F, locEnd: _ } = g,
											w = F(h),
											E = _(h),
											N = new Set();
							...
							Gm = te({
								'src/main/core.js'(e, r) {
									...
									var { diffArrays: t } = BD(),
										...
										{ guessEndOfLine: u, convertEndOfLineToChars: i, countEndOfLineChars: l, normalizeEndOfLine: p } = Jn(),
										y = uo().normalize,
										h = Rm(),
										g = et(),
										c = tu(),
											...
											if (
												(C.cursorNode && B.cursorNodeText
													? ((k = C.locStart(C.cursorNode)),
													  ...
													  (q = B.cursorNodeStart),
													  (J = B.cursorNodeText))
													: ((k = 0), (M = v), (R = C.cursorOffset), (q = 0), (J = B.formatted)),
												M === J)
											)
...
`
									...
									function P(m, C) {
										...
										return (
											...
											(d = I(m, d, 0)),
											(v = I(m, v, m.length)),
											Object.assign(Object.assign({}, C), {}, { cursorOffset: o, rangeStart: d, rangeEnd: v })
										);
									}
									function $(m, C) {
										let { cursorOffset: o, rangeStart: d, rangeEnd: v, endOfLine: S } = P(m, C),
											b = m.charAt(0) === _;
...
`
										...
										return {
											hasBOM: b,
											text: m,
											options: P(m, Object.assign(Object.assign({}, C), {}, { cursorOffset: o, rangeStart: d, rangeEnd: v, endOfLine: S })),
										};
									}
									function D(m, C) {
									...
									function T(m, C) {
										...
										return (
											v.rangeStart > 0 || v.rangeEnd < d.length
												? (S = x(d, v))
												: (!v.requirePragma && v.insertPragma && v.printer.insertPragma && !D(d, v) && (d = v.printer.insertPragma(d)),
												  (S = N(d, v))),
											o && ((S.formatted = _ + S.formatted), S.cursorOffset >= 0 && S.cursorOffset++),
											S
										);
									}
									r.exports = {
							...
							Ke = te({
								'src/language-js/utils/index.js'(e, r) {
									...
									var t = Xm().keyword.isIdentifierNameES5,
										{ getLast: s, hasNewline: a, skipWhitespace: n, isNonEmptyArray: u, isNextLineEmptyAfterIndex: i, getStringWidth: l } = Ue(),
									...
									function w(O) {
										var me, _e;
										return (
											((me = O.extra) === null || me === void 0 ? void 0 : me.parenthesized) &&
											g((_e = O.trailingComments) === null || _e === void 0 ? void 0 : _e[0]) &&
									...
									function I(O) {
										...
										return O.expressions
											...
											: (me =
													(_e =
														(He =
															(Ge = (it = (Qe = O.left) !== null && Qe !== void 0 ? Qe : O.test) !== null && it !== void 0 ? it : O.callee) !==
																null && Ge !== void 0
																? Ge
									...
									function L(O) {
										return (
											(O.type === 'ObjectTypeProperty' || O.type === 'ObjectTypeInternalSlot') &&
									...
									function K(O, me) {
										...
										if (O.arguments.length === 1) {
											...
											return O.arguments[2] && !o(O.arguments[2])
												? !1
												: (O.arguments.length === 2 ? b(O.arguments[1]) : B(O.arguments[1]) && ve(O.arguments[1]).length <= 1) || k(O.arguments[1]);
										return !1;
									}
									...
									function ge(O, me) {
										...
										return (
											...
											((me.tag.object.type === 'Identifier' && _e.test(me.tag.object.name)) ||
												(me.tag.object.type === 'MemberExpression' &&
													me.tag.object.property.type === 'Identifier' &&
													(me.tag.object.property.name === 'only' || me.tag.object.property.name === 'skip') &&
...
`)
									...
									function we(O, me) {
										return (
											((O.type === 'TemplateLiteral' && he(O)) || (O.type === 'TaggedTemplateExpression' && he(O.quasi))) &&
...
`)
									...
									function ve(O) {
										...
										return (
											...
											Array.isArray(O.parameters) ? me.push(...O.parameters) : Array.isArray(O.params) && me.push(...O.params),
									...
									function ze(O, me) {
										...
										_e.this && O.call(Ge, 'this'),
											Array.isArray(_e.parameters) ? O.each(Ge, 'parameters') : Array.isArray(_e.params) && O.each(Ge, 'params'),
									...
									function Se(O, me) {
										...
										_e.type === 'ImportExpression'
											? (O.call((He) => me(He, 0), 'source'), _e.attributes && O.call((He) => me(He, 1), 'attributes'))
											: O.each(me, 'arguments');
									}
									function Ie(O) {
									...
									var Te = { Leading: 2, Trailing: 4, Dangling: 8, Block: 16, Line: 32, PrettierIgnore: 64, First: 128, Last: 256 },
										je = (O, me) => {
							...
							jt = te({
								'src/language-js/print/template-literal.js'(e, r) {
									...
									var t = lt(),
										...
										{
											builders: { join: n, hardline: u, softline: i, group: l, indent: p, align: y, lineSuffixBoundary: h, addAlignmentToDoc: g },
									...
									function I(C, o, d) {
										...
										let B = [],
											...
											M = w(v);
										return (
											M && (k = k.map((R) => c(R, Object.assign(Object.assign({}, d), {}, { printWidth: Number.POSITIVE_INFINITY })).formatted)),
											B.push(h, '`'),
											C.each((R) => {
												let q = R.getName();
												if ((B.push(o()), q < k.length)) {
													...
													if (!M) {
														let Y = v[b][q];
														(E(Y) || N(Y) || Y.type === 'ConditionalExpression' || Y.type === 'SequenceExpression' || x(Y) || F(Y)) &&
															(V = [p([i, V]), i]);
													}
													let j =
														Q === 0 &&
										...
										if (S.length > 1 || S.some((b) => b.length > 0)) {
											...
											let B = [],
												k = b.map(
													(L) =>
														'${' +
														c(L, Object.assign(Object.assign({}, o), {}, { printWidth: Number.POSITIVE_INFINITY, endOfLine: 'lf' })).formatted +
														'}'
												),
													...
													p([
														...
														n(
															...
															J.map((L) =>
																n(
																	' | ',
																	L.cells.map((Q, V) => (L.hasLineBreak ? Q : Q + ' '.repeat(q[V] - s(Q))))
																)
															)
														),
													]),
							...
							Ym = te({
								'src/language-js/embed/markdown.js'(e, r) {
									...
									function i(p, y, h) {
										...
										let _ = u(h(c, { parser: 'markdown', __inJsTemplate: !0 }, { stripTrailingHardline: !0 }), !0);
										...
										let F = 0,
											_ = u(l(c), (w) =>
												typeof w != 'string' || !w.includes('@prettier-placeholder')
													? w
													: w.split(/@prettier-placeholder-(\d+)-id/).map((E, N) => (N % 2 === 0 ? i(E) : (F++, f[E])))
											);
...
`),
											...
											let C = null;
											m ? (C = l(I)) : (C = h(x, { parser: 'graphql' }, { stripTrailingHardline: !0 })),
												C ? ((C = n(C, !1)), !E && D && F.push(''), F.push(C), !N && T && F.push('')) : !E && !N && D && F.push(''),
												$ && F.push($);
										}
										return ['`', t([a, s(a, F)]), a, '`'];
									}
							...
							ed = te({
								'src/language-js/embed/html.js'(e, r) {
									...
									var {
										...
										{ printTemplateExpressions: i, uncookTemplateElementValue: l } = jt(),
										p = 0;
								...
								'src/language-js/embed.js'(e, r) {
									...
									function g(D) {
										...
										return (
											...
											(m && m.type === 'TaggedTemplateExpression' && m.tag.type === 'Identifier' && m.tag.name === 'css') ||
											(m &&
												m.type === 'TaggedTemplateExpression' &&
												m.tag.type === 'MemberExpression' &&
												m.tag.object.name === 'css' &&
												(m.tag.property.name === 'global' || m.tag.property.name === 'resolve'))
										);
									}
									function c(D) {
										return D.match(
											...
											(T, m) => a(T) && T.key.type === 'Identifier' && T.key.name === 'styles' && m === 'value',
											...F
										);
									}
									function f(D) {
										return D.match(
											(T) => T.type === 'TemplateLiteral',
											(T, m) => a(T) && T.key.type === 'Identifier' && T.key.name === 'template' && m === 'value',
											...F
										);
									}
									var F = [
										(D, T) => D.type === 'ObjectExpression' && T === 'properties',
										(D, T) => D.type === 'CallExpression' && D.callee.type === 'Identifier' && D.callee.name === 'Component' && T === 'arguments',
											...
											case 'CallExpression':
												return (
													...
													(m.callee.type === 'MemberExpression' &&
														((m.callee.object.type === 'MemberExpression' && (E(m.callee.object.object) || N(m.callee.object))) ||
															(m.callee.object.type === 'CallExpression' && E(m.callee.object.callee))))
												);
											case 'Identifier':
												return m.name === 'css';
											default:
									...
									function x(D) {
										...
										return (
											...
											(m &&
												((m.type === 'TaggedTemplateExpression' &&
													((m.tag.type === 'MemberExpression' && m.tag.object.name === 'graphql' && m.tag.property.name === 'experimental') ||
														(m.tag.type === 'Identifier' && (m.tag.name === 'gql' || m.tag.name === 'graphql')))) ||
													(m.type === 'CallExpression' && m.callee.type === 'Identifier' && m.callee.name === 'graphql')))
										);
									}
									function I(D, T) {
									...
									function P(D) {
										return (
											...
											D.match(
												(T) => T.type === 'TemplateLiteral',
												(T, m) => T.type === 'TaggedTemplateExpression' && T.tag.type === 'Identifier' && T.tag.name === 'html' && m === 'quasi'
											)
										);
									}
									function $(D) {
								...
								'src/language-js/clean.js'(e, r) {
									...
									function n(u, i, l) {
										if (
											...
											(u.type === 'BigIntLiteral' || u.type === 'BigIntLiteralTypeAnnotation') && i.value && (i.value = i.value.toLowerCase()),
											(u.type === 'BigIntLiteral' || u.type === 'Literal') && i.bigint && (i.bigint = i.bigint.toLowerCase()),
										...
										if (
											...
											for (let { type: h, expression: g } of i.children) h === 'JSXExpressionContainer' && g.type === 'TemplateLiteral' && a(g);
										u.type === 'JSXAttribute' &&
											u.name.name === 'css' &&
										...
										if (
											...
											((!((y = u.leadingComments) === null || y === void 0) &&
												y.some((g) => t(g) && ['GraphQL', 'HTML'].some((c) => g.value === ` ${c} `))) ||
							...
							Eo = te({
								'src/language-js/comments.js'(e, r) {
									...
									function L(De) {
										...
										return (re?.type !== 'TryStatement' && re?.type !== 'CatchClause') || !ye
											? !1
									...
									function V(De) {
										let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ce } = De,
											Be = G && !u(Ce, o(G), C(A));
										return (!G || !Be) && (re?.type === 'ConditionalExpression' || re?.type === 'TSConditionalType') && ye ? (i(ye, A), !0) : !1;
									}
									function j(De) {
									...
									function ce(De) {
										...
										return (re &&
											G &&
											n(ye, A, o) === '(' &&
											(re.type === 'Property' || re.type === 'TSDeclareMethod' || re.type === 'TSAbstractMethodDefinition') &&
											G.type === 'Identifier' &&
											re.key === G &&
											n(ye, G, o) !== ':') ||
									...
									function K(De) {
										let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = De;
										return n(ye, A, o) !== '(' ? !1 : G && W.has(re?.type) ? (l(G, A), !0) : !1;
									}
									function de(De) {
									...
									function ue(De) {
										...
										return n(re, A, o) !== ')'
											? !1
											: G && ((le(G) && g(G).length === 0) || (E(G) && N(G).length === 0))
											? (p(G, A), !0)
											: (G?.type === 'MethodDefinition' || G?.type === 'TSAbstractMethodDefinition') && g(G.value).length === 0
											? (p(G.value, A), !0)
											: !1;
									}
									function Fe(De) {
										let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ce } = De;
										if (
											(G?.type === 'FunctionTypeParam' && re?.type === 'FunctionTypeAnnotation' && ye?.type !== 'FunctionTypeParam') ||
											((G?.type === 'Identifier' || G?.type === 'AssignmentPattern') && re && le(re) && n(Ce, A, o) === ')')
										)
											return l(G, A), !0;
									...
									function U(De) {
										let { comment: A, enclosingNode: G } = De;
										return (G?.type === 'ContinueStatement' || G?.type === 'BreakStatement') && !G.label ? (l(G, A), !0) : !1;
									}
									function Z(De) {
										let { comment: A, precedingNode: G, enclosingNode: re } = De;
									...
									function se(De) {
										let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = De;
										return re?.type === 'UnionTypeAnnotation' || re?.type === 'TSUnionType'
											? (c(A) && ((ye.prettierIgnore = !0), (A.unignore = !0)), G ? (l(G, A), !0) : !1)
											: ((ye?.type === 'UnionTypeAnnotation' || ye?.type === 'TSUnionType') &&
													c(A) &&
									...
									function ge(De) {
										...
										return ye && ye.body && ye.body.length === 0
											? (Ce ? p(ye, A) : i(ye, A), !0)
											: G?.type === 'Program' && G?.body.length === 0 && !h(G.directives)
											? (Ce ? p(G, A) : i(G, A), !0)
											: re?.type === 'Program' && re?.body.length === 0 && G?.type === 'ModuleExpression'
											? (p(re, A), !0)
											: !1;
									}
									function he(De) {
										let { comment: A, enclosingNode: G } = De;
										return G?.type === 'ForInStatement' || G?.type === 'ForOfStatement' ? (i(G, A), !0) : !1;
									}
									function we(De) {
										let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = De;
										if (re?.type === 'ImportSpecifier' || re?.type === 'ExportSpecifier') return i(re, A), !0;
										let Ce = G?.type === 'ImportSpecifier' && re?.type === 'ImportDeclaration',
											Be = G?.type === 'ExportSpecifier' && re?.type === 'ExportNamedDeclaration';
									...
									function Pe(De) {
										let { comment: A, enclosingNode: G, followingNode: re } = De;
										return Re.has(G?.type) && re && (Ne.has(re.type) || d(A)) ? (i(re, A), !0) : !1;
									}
									function oe(De) {
										let { comment: A, enclosingNode: G, followingNode: re, text: ye } = De;
										return !re &&
											(G?.type === 'TSMethodSignature' || G?.type === 'TSDeclareFunction' || G?.type === 'TSAbstractMethodDefinition') &&
											n(ye, A, o) === ';'
											? (l(G, A), !0)
											: !1;
									}
									function H(De) {
										let { comment: A, enclosingNode: G, followingNode: re } = De;
										if (c(A) && G?.type === 'TSMappedType' && re?.type === 'TSTypeParameter' && re.constraint)
									...
									function X(De) {
										let { comment: A, enclosingNode: G, followingNode: re } = De;
										return !G || G.type !== 'SwitchCase' || G.test || !re || re !== G.consequent[0]
											? !1
											...
											((A && (f(A) || F(A) || (x(G) && re(A)))) ||
												(G &&
													(G.type === 'JSXSpreadAttribute' ||
														...
														G.type === 'TSUnionType' ||
														((G.type === 'ClassDeclaration' || G.type === 'ClassExpression') && G.superClass === A)))) &&
											(!w(De) || G.type === 'UnionTypeAnnotation' || G.type === 'TSUnionType')
										);
									}
									r.exports = {
								...
								'src/language-js/needs-parens.js'(e, r) {
									...
									function w(D, T) {
										...
										if (o.type === 'Identifier') {
											if (
												(o.extra && o.extra.parenthesized && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/.test(o.name)) ||
												(C === 'left' && ((o.name === 'async' && !m.await) || o.name === 'let') && m.type === 'ForOfStatement')
											)
												return !0;
											if (o.name === 'let') {
												var d;
										...
										switch (o.type) {
												...
												switch (m.type) {
													...
													case 'BinaryExpression': {
														...
														let B = g(S),
															k = m.operator,
															M = g(k);
														return M > B || (C === 'right' && M === B) || (M === B && !h(k, S))
															? !0
															: M < B && S === '%'
															? k === '+' || k === '-'
															: !!p(k);
											...
											case 'TSConstructorType':
												if (C === 'extendsType' && m.type === 'TSConditionalType') {
													...
													if (
														(S.type === 'TSTypePredicate' && S.typeAnnotation && (S = S.typeAnnotation.typeAnnotation),
											...
											case 'TSTypeOperator':
												return (
													...
													(m.type === 'TSTypeAnnotation' && D.getParentNode(1).type.startsWith('TSJSDoc'))
												);
											case 'TSTypeQuery':
												return (C === 'objectType' && m.type === 'TSIndexedAccessType') || (C === 'elementType' && m.type === 'TSArrayType');
											case 'TypeofTypeAnnotation':
												return (
													(C === 'objectType' && (m.type === 'IndexedAccessType' || m.type === 'OptionalIndexedAccessType')) ||
											...
											case 'FunctionTypeAnnotation': {
												...
												return (
													...
													(C === 'objectType' && (S.type === 'IndexedAccessType' || S.type === 'OptionalIndexedAccessType')) ||
													S.type === 'NullableTypeAnnotation' ||
													(m.type === 'FunctionTypeParam' &&
														m.name === null &&
														a(o).some((b) => b.typeAnnotation && b.typeAnnotation.type === 'NullableTypeAnnotation'))
												);
											}
											...
											case 'AssignmentExpression': {
												...
												return C === 'body' && m.type === 'ArrowFunctionExpression'
													? !0
													: (C === 'key' && (m.type === 'ClassProperty' || m.type === 'PropertyDefinition') && m.computed) ||
													...
													: !(
															...
															(m.type === 'SequenceExpression' && S && S.type === 'ForStatement' && (S.init === m || S.update === m)) ||
															(C === 'value' && m.type === 'Property' && S && S.type === 'ObjectPattern' && S.properties.includes(m)) ||
											...
											case 'OptionalCallExpression': {
												...
												if (
													...
													(C === 'callee' && (m.type === 'CallExpression' || m.type === 'NewExpression')) ||
													(m.type === 'TSNonNullExpression' && S.type === 'MemberExpression' && S.object === m)
												)
													return !0;
											}
											case 'CallExpression':
											...
											case 'NGPipeExpression':
												return !(
													...
													(m.type === 'ObjectProperty' && !(o.extra && o.extra.parenthesized)) ||
											...
											case 'JSXElement':
												return (
													C === 'callee' ||
													(C === 'left' && m.type === 'BinaryExpression' && m.operator === '<') ||
													(m.type !== 'ArrayExpression' &&
										...
										switch (a.parser) {
											...
											case '__vue_ts_expression':
												return Object.assign(
													Object.assign({}, s),
													{},
													{ type: a.parser.startsWith('__') ? 'JsExpressionRoot' : 'JsonRoot', node: s, comments: [], rootMarker: a.rootMarker }
												);
											default:
												return s;
										}
							...
							ru = te({
								'src/language-js/print/binaryish.js'(e, r) {
									...
									var { printComments: t } = et(),
										{ getLast: s } = Ue(),
										{
											builders: { join: a, line: n, softline: u, group: i, indent: l, align: p, indentIfBreak: y },
									...
									function T(o, d, v) {
										let S = o.getValue(),
											...
											k =
												S !== b.body &&
												(b.type === 'IfStatement' || b.type === 'WhileStatement' || b.type === 'SwitchStatement' || b.type === 'DoWhileStatement'),
											M = $(d) && S.operator === '|>',
											R = m(o, v, d, !1, k);
										if (k) return R;
										if (M) return i(R);
										...
										let q =
												...
												(b.type === 'JSXExpressionContainer' && B.type === 'JSXAttribute') ||
												(S.operator !== '|' && b.type === 'JsExpressionRoot') ||
												(S.type !== 'NGPipeExpression' &&
													((b.type === 'NGRoot' && d.parser === '__ng_binding') ||
														(b.type === 'NGMicrosyntaxExpression' && B.type === 'NGMicrosyntax' && B.body.length === 1))) ||
												(S === b.body && b.type === 'ArrowFunctionExpression') ||
												(S !== b.body && b.type === 'ForStatement') ||
												(b.type === 'ConditionalExpression' && B.type !== 'ReturnStatement' && B.type !== 'ThrowStatement' && !x(B)) ||
									...
									function m(o, d, v, S, b) {
										...
										let M = C(B),
											R =
												(B.operator === '|>' || B.type === 'NGPipeExpression' || (B.operator === '|' && v.parser === '__vue_expression')) &&
									...
									function C(o) {
										return o.type !== 'LogicalExpression'
											? !1
											: !!(
													(o.right.type === 'ObjectExpression' && o.right.properties.length > 0) ||
													(o.right.type === 'ArrayExpression' && o.right.elements.length > 0) ||
													_(o.right)
											  );
									}
											...
											switch (F.type) {
												...
												case 'NGMicrosyntaxKeyedExpression': {
													let _ = g.getName(),
														...
														E =
															y(F, _, w) ||
															(((_ === 1 && (F.key.name === 'then' || F.key.name === 'else')) ||
																(_ === 2 &&
																	F.key.name === 'else' &&
								...
								'src/language-js/print/jsx.js'(e, r) {
									...
									function d(U, Z, se) {
										...
										if (
											...
											(fe.children[0].expression.type === 'TemplateLiteral' || fe.children[0].expression.type === 'TaggedTemplateExpression')
										)
									...
									function S(U, Z, se, fe) {
										return U
											? ''
											: (se.type === 'JSXElement' && !se.closingElement) || (fe && fe.type === 'JSXElement' && !fe.closingElement)
											? Z.length === 1
												? i
												: u
											: i;
										...
										if ((ge.push(se('name')), fe.value)) {
											...
											if (I(fe.value)) {
												let ke = N(fe.value)
														...
														.replace(/&apos;/g, "'")
														.replace(/&quot;/g, '"'),
													{ escaped: Re, quote: Ne, regex: Pe } = w(ke, Z.jsxSingleQuote ? "'" : '"');
												ke = ke.replace(Pe, Re);
											...
											ge = (he, we) =>
												...
												(!$(he) &&
													(he.type === 'ArrayExpression' ||
														...
														(he.type === 'AwaitExpression' && (ge(he.argument, he) || he.argument.type === 'JSXElement')) ||
														x(he) ||
...
`)
									...
									function J(U, Z, se) {
										...
										return (
											(U.attributes.length === 0 && !se) || ((Z.bracketSameLine || Z.jsxBracketSameLine) && (!se || U.attributes.length > 0) && !fe)
										);
									}
									function L(U, Z, se) {
										let fe = U.getValue(),
										...
										let he = se('name');
										return (
											$(fe.name, D.Leading | D.Line) ? ge.push(p([u, he]), u) : $(fe.name, D.Leading | D.Block) ? ge.push(' ', he) : ge.push(he),
											ge.push('>'),
											ge
										);
									}
...
\r	`,
							...
							ct = te({
								'src/language-js/print/misc.js'(e, r) {
									...
									function i(_) {
										let w = _.getValue();
										return !w.optional || (w.type === 'Identifier' && w === _.getParentNode().key)
											? ''
											: w.type === 'OptionalCallExpression' || (w.type === 'OptionalMemberExpression' && w.computed)
											? '?.'
											: '?';
									}
									function l(_) {
							...
							er = te({
								'src/language-js/print/array.js'(e, r) {
									...
									var { printDanglingComments: t } = et(),
										{
											builders: { line: s, softline: a, hardline: n, group: u, indent: i, ifBreak: l, fill: p },
										} = qe(),
									...
									function I(T, m, C) {
										...
										if (o.elements.length === 0) c(o, f.Dangling) ? d.push(u([v, t(T, m), a, S])) : d.push(v, S);
											...
											let b = y(o.elements),
												...
												q = P(o, m),
												J = B ? (k ? ',' : g(m) ? (q ? l(',', '', { groupId: M }) : l(',')) : '') : '';
											d.push(u([v, i([a, q ? D(T, m, C, J) : [$(T, m, 'elements', C), J], t(T, m, !0)]), a, S], { shouldBreak: R, id: M }));
										}
									...
									function P(T, m) {
										return (
											...
											T.elements.every(
												(C) =>
													C && (_(C) || (w(C) && !c(C.argument))) && !c(C, f.Trailing | f.Line, (o) => !h(m.originalText, E(o), { backwards: !0 }))
											)
										);
									}
									function $(T, m, C, o) {
							...
							Ao = te({
								'src/language-js/print/call-arguments.js'(e, r) {
									...
									var { printDanglingComments: t } = et(),
										...
										{
											builders: { line: N, hardline: x, softline: I, group: P, indent: $, conditionalGroup: D, ifBreak: T, breakParent: m },
											utils: { willBreak: C },
										} = qe(),
									...
									function v(q, J, L) {
										...
										if (de || ue) {
											...
											try {
												q.try(() => {
													c(q, (U, Z) => {
														de &&
															Z === 0 &&
															(z = [[L([], { expandFirstArg: !0 }), ce.length > 1 ? ',' : '', ie ? x : N, ie ? x : ''], ...ce.slice(1)]),
															ue && Z === ee && (z = [...ce.slice(0, -1), L([], { expandLastArg: !0 })]);
													});
												});
											} catch (U) {
											...
											return [
												...
												D([
													['(', ...z, ')'],
													de ? ['(', P(z[0], { shouldBreak: !0 }), ...z.slice(1), ')'] : ['(', ...ce.slice(0, -1), P(s(z), { shouldBreak: !0 }), ')'],
													K(),
												]),
											];
										}
									...
									function S(q) {
										...
										return (
											(q.type === 'ObjectExpression' && (q.properties.length > 0 || u(q))) ||
											...
											(q.type === 'ArrowFunctionExpression' &&
												(!q.returnType || !q.returnType.typeAnnotation || q.returnType.typeAnnotation.type !== 'TSTypeReference' || M(q.body)) &&
												(q.body.type === 'BlockStatement' ||
													...
													(!J && (F(q.body) || q.body.type === 'ConditionalExpression')) ||
													p(q.body))) ||
											q.type === 'DoExpression' ||
									...
									function b(q, J) {
										...
										return (
											...
											S(L) &&
											(!Q || Q.type !== L.type) &&
											(q.length !== 2 || Q.type !== 'ArrowFunctionExpression' || L.type !== 'ArrayExpression') &&
									...
									function B(q) {
										...
										return J.type === 'ModuleExpression' && R(L)
											? !0
											: !u(J) &&
													(J.type === 'FunctionExpression' || (J.type === 'ArrowFunctionExpression' && J.body.type === 'BlockStatement')) &&
							...
							So = te({
								'src/language-js/print/member.js'(e, r) {
									...
									var {
										...
										{ isNumericLiteral: u, isMemberExpression: i, isCallExpression: l } = Ke(),
											...
											I =
												(w &&
													(w.type === 'NewExpression' ||
														...
														(w.type === 'AssignmentExpression' && w.left.type !== 'Identifier'))) ||
												F.computed ||
												(F.object.type === 'Identifier' && F.property.type === 'Identifier' && !i(_)) ||
												((_.type === 'AssignmentExpression' || _.type === 'VariableDeclarator') &&
													((l(F.object) && F.object.arguments.length > 0) ||
														(F.object.type === 'TSNonNullExpression' && l(F.object.expression) && F.object.expression.arguments.length > 0) ||
							...
							md = te({
								'src/language-js/print/member-chain.js'(e, r) {
									ne();
									var { printComments: t } = et(),
										{ getLast: s, isNextLineEmptyAfterIndex: a, getNextNonSpaceNonCommentCharacterIndex: n } = Ue(),
										u = qt(),
										{
											isCallExpression: i,
										...
										{ locEnd: w } = ut(),
										{
											builders: { join: E, hardline: N, group: x, indent: I, conditionalGroup: P, breakParent: $, label: D },
											utils: { willBreak: T },
										} = qe(),
										m = Ao(),
										{ printMemberLookup: C } = So(),
										{ printOptionalToken: o, printFunctionTypeParameters: d, printBindExpressionCallee: v } = ct();
									function S(b, B, k) {
										...
										function L(Ne) {
											...
											i(Pe) && (h(Pe.callee) || i(Pe.callee))
												? (q.unshift({ node: Pe, printed: [t(Ne, [o(Ne), d(Ne, B, k), m(Ne, B, k)], B), J(Pe) ? N : ''] }),
												  Ne.call((oe) => L(oe), 'callee'))
												: h(Pe)
												? (q.unshift({ node: Pe, needsParens: u(Ne, B), printed: t(Ne, l(Pe) ? C(Ne, B, k) : v(Ne, B, k), B) }),
												  Ne.call((oe) => L(oe), 'object'))
												: Pe.type === 'TSNonNullExpression'
												? (q.unshift({ node: Pe, printed: t(Ne, '!', B) }), Ne.call((oe) => L(oe), 'expression'))
										...
										for (
											;
											Y < q.length &&
											(q[Y].node.type === 'TSNonNullExpression' || i(q[Y].node) || (l(q[Y].node) && q[Y].node.computed && g(q[Y].node.property)));
											++Y
										)
											j.push(q[Y]);
										...
										let Re;
										return (
											se || (we.length > 2 && we.some((Ne) => !Ne.arguments.every((Pe) => c(Pe, 0)))) || Fe.slice(0, -1).some(T) || ke()
												? (Re = x(he))
												: (Re = [T(z) || ge ? $ : '', P([z, he])]),
											D('member-chain', Re)
										);
							...
							xo = te({
								'src/language-js/print/call-expression.js'(e, r) {
									...
									function w(N, x, I) {
										...
										if ((o && (P.callee.trailingComments[0].printed = !0), !T && !D && l(P.callee) && !N.call((v) => a(v, x), 'callee')))
											return c(N, x, I);
										let d = [
											D ? 'new ' : '',
											T ? 'import' : I('callee'),
											m,
											o ? `/*:: ${P.callee.trailingComments[0].value.slice(2).trim()} */` : '',
											_(N, x, I),
											f(N, x, I),
										];
							...
							tr = te({
								'src/language-js/print/assignment.js'(e, r) {
									...
									var { isNonEmptyArray: t, getStringWidth: s } = Ue(),
										{
											builders: { line: a, group: n, indent: u, indentIfBreak: i, lineSuffixBoundary: l },
									...
									function d(W, K, de, ue, Fe) {
										...
										if (W.match(b, B, (he) => !Z || (he.type !== 'ExpressionStatement' && he.type !== 'VariableDeclaration')))
											return Z
												? U.type === 'ArrowFunctionExpression' && U.body.type === 'ArrowFunctionExpression'
									...
									function v(W, K, de, ue) {
										...
										let z = Fe,
											U = [];
										for (;;)
											if (z.type === 'UnaryExpression') (z = z.argument), U.push('argument');
									...
									function S(W) {
										if (B(W)) {
											...
											return (
												...
												K.properties.some((de) => $(de) && (!de.shorthand || (de.value && de.value.type === 'AssignmentPattern')))
											);
										}
										return !1;
									}
...
`)
							...
							Lr = te({
								'src/language-js/print/function-parameters.js'(e, r) {
									...
									var { getNextNonSpaceNonCommentCharacter: t } = Ue(),
										...
										{
											builders: { line: a, hardline: n, softline: u, group: i, indent: l, ifBreak: p },
									...
									function m(v, S, b, B, k) {
										...
										if (
											(c(v, (ie, ee) => {
												...
												ce && M.rest && V.push('...'),
													V.push(S()),
													!ce && (V.push(','), L || Q ? V.push(' ') : P(R[ee], b) ? V.push(n, n) : V.push(a));
											}),
											B)
										) {
									...
									function C(v) {
										...
										return (
											...
											(b.type === 'ObjectPattern' ||
												...
												(b.type === 'Identifier' &&
													b.typeAnnotation &&
													(b.typeAnnotation.type === 'TypeAnnotation' || b.typeAnnotation.type === 'TSTypeAnnotation') &&
													w(b.typeAnnotation.typeAnnotation)) ||
												(b.type === 'FunctionTypeParam' && w(b.typeAnnotation)) ||
												(b.type === 'AssignmentPattern' &&
													(b.left.type === 'ObjectPattern' || b.left.type === 'ArrayPattern') &&
													(b.right.type === 'Identifier' ||
														(b.right.type === 'ObjectExpression' && b.right.properties.length === 0) ||
														(b.right.type === 'ArrayExpression' && b.right.elements.length === 0))))
										);
									}
									function o(v) {
										let S;
										return (
											v.returnType ? ((S = v.returnType), S.typeAnnotation && (S = S.typeAnnotation)) : v.typeAnnotation && (S = v.typeAnnotation), S
										);
									}
									function d(v, S) {
										let b = o(v);
							...
							Or = te({
								'src/language-js/print/type-annotation.js'(e, r) {
									...
									var { printComments: t, printDanglingComments: s } = et(),
										...
										{
											builders: { group: n, join: u, line: i, softline: l, indent: p, align: y, ifBreak: h },
										} = qe(),
										g = qt(),
										{ locStart: c } = ut(),
										{ isSimpleType: f, isObjectType: F, hasLeadingOwnLineComment: _, isObjectTypePropertyAFunction: w, shouldPrintComma: E } = Ke(),
										{ printAssignment: N } = tr(),
										{ printFunctionParameters: x, shouldGroupFunctionParameters: I } = Lr(),
									...
									function C(b, B, k) {
										let M = b.getValue(),
											...
											q =
												...
												R.type !== 'TSTupleType' &&
												!(R.type === 'FunctionTypeParam' && !R.name && b.getParentNode(1).this !== R) &&
												!((R.type === 'TypeAlias' || R.type === 'VariableDeclarator' || R.type === 'TSTypeAliasDeclaration') && _(B.originalText, M)),
											J = $(M),
											L = b.map((j) => {
												let Y = k();
										...
										return g(b, B)
											? n([p(V), l])
											: (R.type === 'TupleTypeAnnotation' && R.types.length > 1) || (R.type === 'TSTupleType' && R.elementTypes.length > 1)
											? n([p([h(['(', l]), V]), l, h(')')])
											: n(q ? p(V) : V);
									}
									function o(b, B, k) {
										let M = b.getValue(),
											...
											Q =
												...
												!(
													((q.type === 'ObjectTypeProperty' || q.type === 'ObjectTypeInternalSlot') && !q.variance && !q.optional && c(q) === c(M)) ||
										...
										let Y = x(b, k, B, !1, !0),
											ie =
												M.returnType || M.predicate || M.typeAnnotation
													? [Q ? ' => ' : ': ', k('returnType'), k('predicate'), k('typeAnnotation')]
													: '',
											ee = I(M, ie);
							...
							jr = te({
								'src/language-js/print/type-parameters.js'(e, r) {
									...
									var { printDanglingComments: t } = et(),
										{
											builders: { join: s, line: a, hardline: n, softline: u, group: i, indent: l, ifBreak: p },
										} = qe(),
										{
											isTestCall: y,
											hasComment: h,
									...
									function P(T, m, C, o) {
										...
										let k =
											d.type === 'TSTypeParameterInstantiation'
												? ''
												: F(d).length === 1 && c(m) && !d[o][0].constraint && T.getParentNode().type === 'ArrowFunctionExpression'
												? ','
												: f(m, 'all')
												? p(',')
												: '';
							...
							rr = te({
								'src/language-js/print/property.js'(e, r) {
									...
									var { printComments: t } = et(),
										...
										{ isNumericLiteral: n, isSimpleNumber: u, isStringLiteral: i, isStringPropSafeToUnquote: l, rawText: p } = Ke(),
									...
									function g(f, F, _) {
										...
										if (
											(N.type === 'Identifier' ||
												(n(N) && u(a(p(N))) && String(N.value) === a(p(N)) && !(F.parser === 'typescript' || F.parser === 'babel-ts'))) &&
											(F.parser === 'json' || (F.quoteProps === 'consistent' && h.get(E)))
										) {
											let x = s(JSON.stringify(N.type === 'Identifier' ? N.name : N.value.toString()), F);
											return f.call((I) => t(I, x, F), 'key');
										}
										return l(w, F) && (F.quoteProps === 'as-needed' || (F.quoteProps === 'consistent' && !h.get(E)))
											? f.call((x) => t(x, /^\d/.test(N.value) ? a(N.value) : N.value, F), 'key')
											: _('key');
									}
									function c(f, F, _) {
							...
							qr = te({
								'src/language-js/print/function.js'(e, r) {
									...
									var t = Zt(),
										...
										{
											builders: { line: i, softline: l, group: p, indent: y, ifBreak: h, hardline: g, join: c, indentIfBreak: f },
										...
										{ locEnd: M } = ut(),
										{ printFunctionParameters: R, shouldGroupFunctionParameters: q } = Lr(),
									...
									function Q(U, Z, se, fe) {
										...
										let ke = R(U, Z, se, he),
											...
											Ne = q(ge, Re);
										return (
											we.push(L(U, se, Z), p([Ne ? p(ke) : ke, Re]), ge.body ? ' ' : '', Z('body')),
									...
									function ie(U, Z, se, fe, ge, he) {
										...
										return (
											he.body.type === 'SequenceExpression' && (ge = p(['(', y([l, ge]), l, ')'])),
											p([
												p(y([Re || Ne ? l : '', p(c([' =>', i], se), { shouldBreak: fe })]), { id: H, shouldBreak: oe }),
												' =>',
									...
									function ee(U, Z, se, fe) {
										...
										if (
											((function H() {
												...
												(ke = ke || (ge.returnType && E(ge).length > 0) || ge.typeParameters || E(ge).some((X) => X.type !== 'Identifier')),
													ge.body.type !== 'ArrowFunctionExpression' || (fe && fe.expandLastArg)
							...
							nr = te({
								'src/language-js/print/class.js'(e, r) {
									...
									var { isNonEmptyArray: t, createGroupIdMapper: s } = Ue(),
										...
										{
											builders: { join: u, line: i, hardline: l, softline: p, group: y, indent: h, ifBreak: g },
										} = qe(),
										{ hasComment: c, CommentCheckFlags: f } = Ke(),
										{ getTypeParametersGroupId: F } = jr(),
										{ printMethod: _ } = qr(),
										{ printOptionalToken: w, printTypeAnnotation: E, printDefiniteToken: N } = ct(),
									...
									function v(b, B, k) {
										...
										return (
											...
											(M.type === 'TSAbstractMethodDefinition' || M.abstract) && R.push('abstract '),
									...
									function S(b, B, k) {
										...
										return (
											...
											M.declare && R.push('declare '),
											M.static && R.push('static '),
											(M.type === 'TSAbstractPropertyDefinition' || M.type === 'TSAbstractAccessorProperty' || M.abstract) && R.push('abstract '),
											M.override && R.push('override '),
											M.readonly && R.push('readonly '),
											M.variance && R.push(k('variance')),
											(M.type === 'ClassAccessorProperty' || M.type === 'AccessorProperty' || M.type === 'TSAbstractAccessorProperty') &&
												R.push('accessor '),
								...
								'src/language-js/print/interface.js'(e, r) {
									...
									function c(f, F, _) {
										...
										w.declare && E.push('declare '),
											w.type === 'TSInterfaceDeclaration' && E.push(w.abstract ? 'abstract ' : '', g(f, F, _)),
											E.push('interface');
										let N = [],
											x = [];
										...
										return (
											...
											(w.id && l(w.id, y.Trailing)) || t(w.extends) ? (I ? E.push(n([...N, u(x)])) : E.push(n(u([...N, ...x])))) : E.push(...N, ...x),
											E.push(' ', _('body')),
											n(E)
										);
									}
							...
							To = te({
								'src/language-js/print/module.js'(e, r) {
									...
									var { isNonEmptyArray: t } = Ue(),
										{
											builders: { softline: s, group: a, indent: n, join: u, line: i, ifBreak: l, hardline: p },
										} = qe(),
										...
										{ hasDecoratorsBeforeExport: N, printDecoratorsBeforeExport: x } = nu();
									function I(S, b, B) {
										let k = S.getValue(),
											M = b.semi ? ';' : '',
											R = [],
									...
									function P(S, b, B) {
										...
										return (
											...
											J ? M.push(' ', B('declaration')) : M.push(q === 'type' ? ' type' : '', m(S, b, B), T(S, b, B), o(S, b, B)),
											D(k, b) && M.push(';'),
											M
										);
									}
											...
											S.each(() => {
												...
												q.length > 0 &&
													...
													q.length > 1 || R.length > 0 || k.specifiers.some((L) => h(L))
														? M.push(a(['{', n([b.bracketSpacing ? i : s, u([',', i], q)]), l(c(b) ? ',' : ''), b.bracketSpacing ? i : s, '}']))
														: M.push(['{', b.bracketSpacing ? ' ' : '', ...q, b.bracketSpacing ? ' ' : '', '}']));
										} else M.push('{}');
										return M;
									}
									function C(S, b) {
									...
									function o(S, b, B) {
										...
										return t(k.assertions)
											? [' assert {', b.bracketSpacing ? ' ' : '', u(', ', S.map(B, 'assertions')), b.bracketSpacing ? ' ' : '', '}']
											: '';
									}
									function d(S, b, B) {
										let k = S.getNode(),
										...
										let J = M.startsWith('Import'),
											...
											ie = '';
										return (
											M === 'ExportNamespaceSpecifier' || M === 'ImportNamespaceSpecifier' ? (Y = '*') : V && (Y = B(L)),
											j && !v(k) && (ie = B(Q)),
											R.push(Y, Y && ie ? ' as ' : '', ie),
											R
										);
							...
							uu = te({
								'src/language-js/print/object.js'(e, r) {
									...
									var { printDanglingComments: t } = et(),
										{
											builders: { line: s, softline: a, group: n, indent: u, ifBreak: i, hardline: l },
										} = qe(),
										{ getLast: p, hasNewlineInRange: y, hasNewline: h, isNonEmptyArray: g } = Ue(),
										{ shouldPrintComma: c, hasComment: f, getComments: F, CommentCheckFlags: _, isNextLineEmpty: w } = Ke(),
									...
									function T(m, C, o) {
										...
										let k = B.map((W) => v[W][0]).sort((W, K) => E(W) - E(K))[0],
											...
											R =
												b &&
												M &&
												(M.type === 'InterfaceDeclaration' || M.type === 'DeclareInterface' || M.type === 'DeclareClass') &&
												m.getName() === 'body',
											q =
												...
												(v.type === 'ObjectPattern' &&
													...
													M.type !== 'AssignmentPattern' &&
													M.type !== 'CatchClause' &&
													v.properties.some((W) => W.value && (W.value.type === 'ObjectPattern' || W.value.type === 'ArrayPattern'))) ||
												(v.type !== 'ObjectPattern' && k && y(C.originalText, E(v), E(k))),
										...
										return m.match(
											...
											(W, K, de) => P(W) && (K === 'params' || K === 'parameters' || K === 'this' || K === 'rest') && de === 0
										) ||
											m.match(
												$,
											...
											(!q &&
												m.match(
													...
													(W) => W.type === 'AssignmentExpression' || W.type === 'VariableDeclarator'
												))
											? ce
											: n(ce, { shouldBreak: q });
									}
							...
							dd = te({
								'src/language-js/print/flow.js'(e, r) {
									...
									var t = Zt(),
										...
										{ getParentExportDeclaration: y, isFunctionNotation: h, isGetterOrSetter: g, rawText: c, shouldPrintComma: f } = Ke(),
										...
										{ printOptionalToken: k, printTypeAnnotation: M, printRestSpread: R } = ct();
									function q(L, Q, V) {
										let j = L.getValue(),
											Y = Q.semi ? ';' : '',
											ie = [];
										switch (j.type) {
											...
											case 'ObjectTypeProperty': {
												...
												return (
													...
													[ee, g(j) ? j.kind + ' ' : '', j.variance ? V('variance') : '', B(L, Q, V), k(L), h(j) ? '' : ': ', V('value')]
												);
											}
							...
							Bo = te({
								'src/language-js/print/ternary.js'(e, r) {
									...
									var { hasNewlineInRange: t } = Ue(),
										{ isJsxNode: s, getComments: a, isCallExpression: n, isMemberExpression: u, isTSTypeExpression: i } = Ke(),
										{ locStart: l, locEnd: p } = ut(),
										y = Pt(),
										{
											builders: { line: h, softline: g, group: c, indent: f, align: F, ifBreak: _, dedent: w, breakParent: E },
										} = qe();
									function N(D) {
										let T = [D];
									...
									function P(D) {
										...
										for (let o = 0; !m; o++) {
											...
											(d.type === 'NewExpression' && d.callee === C) || (i(d) && d.expression === C)
									...
									function $(D, T, m) {
										...
										let ee = [...S.map((ue) => a(C[ue])), a(b), a(B)].flat().some((ue) => y(ue) && t(T.originalText, l(ue), p(ue))),
											ce = (ue) => (R === j ? c(ue, { shouldBreak: ee }) : ee ? [ue, E] : ue),
									...
									function g(x, I, P, $) {
										...
										return (
											x.each((o, d, v) => {
												...
												let b = P();
												!I.semi && !m && !i(I, o) && f(o, I) ? (l(S, p.Leading) ? T.push(P([], { needsSemi: !0 })) : T.push(';', b)) : T.push(b),
							...
							yd = te({
								'src/language-js/print/typescript.js'(e, r) {
									...
									var { printDanglingComments: t } = et(),
										...
										{
											builders: { join: a, line: n, hardline: u, softline: i, group: l, indent: p, conditionalGroup: y, ifBreak: h },
										} = qe(),
										{
											isStringLiteral: g,
										...
										{ printTernary: P } = Bo(),
										{ printFunctionParameters: $, shouldGroupFunctionParameters: D } = Lr(),
									...
									function ie(ee, ce, W) {
										...
										switch (K.type) {
											...
											case 'TSConstructorType': {
												if (
													(K.type === 'TSConstructorType' && K.abstract && ue.push('abstract '),
											...
											case 'TSEnumDeclaration':
												return (
													...
													K.members.length === 0
														? ue.push(l(['{', t(ee, ce), i, '}']))
														: ue.push(l(['{', p([u, m(ee, ce, 'members', W), f(ce, 'es5') ? ',' : '']), t(ee, ce, !0), u, '}'])),
													ue
												);
											case 'TSEnumMember':
											...
											case 'TSImportEqualsDeclaration':
												return (
													...
													ue.push('import '),
													K.importKind && K.importKind !== 'value' && ue.push(K.importKind, ' '),
											...
											case 'TSModuleDeclaration': {
												...
												if (U) ue.push('.');
													...
													(K.id.type === 'Identifier' && K.id.name === 'global' && !/namespace|module/.test(se)) ||
														ue.push(z || /(?:^|\s)module(?:\s|$)/.test(se) ? 'module ' : 'namespace ');
												}
								...
								'src/language-js/print/comment.js'(e, r) {
									...
									function y(c, f) {
										...
										if (p(F)) {
											if (h(F)) {
												let E = g(F);
												return F.trailing && !t(f.originalText, i(F), { backwards: !0 }) ? [a, E] : E;
											}
											let _ = l(F),
...
`);
										return [
											...
											s(
												a,
												f.map((F, _) => (_ === 0 ? F.trimEnd() : ' ' + (_ < f.length - 1 ? F.trim() : F.trimStart())))
											),
											'*/',
										];
									}
							...
							Cd = te({
								'src/language-js/printer-estree.js'(e, r) {
									...
									var { printDanglingComments: t } = et(),
										{ hasNewline: s } = Ue(),
										{
											builders: { join: a, line: n, hardline: u, softline: i, group: l, indent: p },
										...
										{ printImportDeclaration: ee, printExportDeclaration: ce, printExportAllDeclaration: W, printModuleSpecifier: K } = To(),
										{ printTernary: de } = Bo(),
										{ printTemplateLiteral: ue } = jt(),
										{ printArray: Fe } = er(),
										{ printObject: z } = uu(),
										{ printClass: U, printClassMethod: Z, printClassProperty: se } = nr(),
										{ printProperty: fe } = rr(),
										{ printFunction: ge, printArrowFunction: he, printMethod: we, printReturnStatement: ke, printThrowStatement: Re } = qr(),
										{ printCallExpression: Ne } = xo(),
										{ printVariableDeclarator: Pe, printAssignmentExpression: oe } = tr(),
									...
									function re(Ce, Be, ve, ze) {
										...
										switch (be.type) {
											...
											case 'ParenthesizedExpression':
												return !E(be.expression) && (be.expression.type === 'ObjectExpression' || be.expression.type === 'ArrayExpression')
													? ['(', ve('expression'), ')']
											...
											case 'UnaryExpression':
												return (
													...
													E(be.argument) ? Se.push(l(['(', p([i, ve('argument')]), i, ')'])) : Se.push(ve('argument')),
													Se
												);
											case 'UpdateExpression':
											...
											case 'VariableDeclaration': {
												let Ie = Ce.map(ve, 'declarations'),
													...
													je;
												return (
													Ie.length === 1 && !E(be.declarations[0]) ? (je = Ie[0]) : Ie.length > 0 && (je = p(Ie[0])),
													(Se = [
														be.declare ? 'declare ' : '',
														be.kind,
														je ? [' ', je] : '',
											...
											case 'IfStatement': {
												...
												if ((Se.push(Oe), be.alternate)) {
													...
													Se.push(Te ? ' ' : u),
														...
														Se.push('else', l(V(be.alternate, ve('alternate'), be.alternate.type === 'IfStatement')));
												}
												return Se;
											}
											case 'ForStatement': {
												...
												return !be.init && !be.test && !be.update
													? [Je, l(['for (;;)', Ie])]
													: [Je, l(['for (', l([p([i, ve('init'), ';', n, ve('test'), ';', n, ve('update')]), i]), ')', Ie])];
											}
											case 'WhileStatement':
											...
											case 'CatchClause':
												if (be.param) {
													let Ie = E(
															be.param,
															(Je) =>
																!v(Je) || (Je.leading && s(Be.originalText, d(Je))) || (Je.trailing && s(Be.originalText, o(Je), { backwards: !0 }))
														),
														Oe = ve('param');
									...
									function p(y, h) {
										...
										if (g === 'ObjectProperty') {
											...
											c.type === 'Identifier'
												...
												: c.type === 'NumericLiteral' && (h.key = { type: 'StringLiteral', value: String(c.value) });
											return;
										}
							...
							Fd = te({
								'src/language-js/options.js'(e, r) {
									...
									r.exports = {
										...
										jsxSingleQuote: { since: '1.15.0', category: s, type: 'boolean', default: !1, description: 'Use single quotes in JSX.' },
										quoteProps: {
											since: '1.17.0',
											category: s,
											type: 'choice',
								...
								'src/language-js/index.js'(e, r) {
									...
									var t = _t(),
										...
										i = [
											...
											t(Sd(), () => ({ since: '1.4.0', parsers: ['typescript', 'babel-ts'], vscodeLanguageIds: ['typescript'] })),
											t(xd(), () => ({ since: '1.4.0', parsers: ['typescript', 'babel-ts'], vscodeLanguageIds: ['typescriptreact'] })),
											t(wa(), () => ({
												name: 'JSON.stringify',
												since: '1.13.0',
											...
											t(Td(), () => ({ since: '1.13.0', parsers: ['json5'], vscodeLanguageIds: ['json5'] })),
										],
								...
								'src/language-css/clean.js'(e, r) {
									...
									function n(i, l, p) {
										...
										if (
											...
											(i.type === 'media-query' || i.type === 'media-query-list' || i.type === 'media-feature-expression') && delete l.value,
											i.type === 'css-rule' && delete l.params,
											i.type === 'selector-combinator' && (l.value = l.value.replace(/\s+/g, ' ')),
											i.type === 'media-feature' && (l.value = l.value.replace(/ /g, '')),
											((i.type === 'value-word' &&
												((i.isColor && i.isHex) || ['initial', 'inherit', 'unset', 'revert'].includes(l.value.replace().toLowerCase()))) ||
											...
											(i.type === 'css-atrule' || i.type === 'css-import') && (l.name = l.name.toLowerCase()),
											...
											i.type === 'selector-attribute' &&
												...
												l.namespace &&
													...
													((l.namespace = l.namespace.trim()), l.namespace.length === 0 && (l.namespace = !0)),
												l.value && ((l.value = l.value.trim().replace(/^["']|["']$/g, '')), delete l.quoted)),
											(i.type === 'media-value' ||
												i.type === 'media-type' ||
												i.type === 'value-number' ||
												i.type === 'selector-root-invalid' ||
												...
												i.type === 'selector-tag') &&
												l.value &&
												(l.value = l.value.replace(/([\d+.Ee-]+)([A-Za-z]*)/g, (y, h, g) => {
													let c = Number(h);
										...
										if (
											(i.type === 'css-atrule' && i.name.toLowerCase() === 'supports' && delete l.value,
											i.type === 'selector-unknown' && delete l.value,
											i.type === 'value-comma_group')
										) {
											let y = i.groups.findIndex((h) => h.type === 'value-number' && h.unit === '...');
											y !== -1 && ((l.groups[y].unit = ''), l.groups.splice(y + 1, 0, { type: 'value-word', value: '...', isColor: !1, isHex: !1 }));
										}
										if (
											i.type === 'value-comma_group' &&
											i.groups.some(
												(y) => (y.type === 'value-atword' && y.value.endsWith('[')) || (y.type === 'value-word' && y.value.startsWith(']'))
											)
										)
											return {
												type: 'value-atword',
							...
							su = te({
								'src/utils/front-matter/print.js'(e, r) {
									...
									function a(n, u) {
										if (n.lang === 'yaml') {
											let i = n.value.trim(),
												l = i ? u(i, { parser: 'yaml' }, { stripTrailingHardline: !0 }) : '';
							...
							_o = te({
								'src/utils/front-matter/parse.js'(e, r) {
									...
									function s(a) {
										...
										let { startDelimiter: u, language: i, value: l = '', endDelimiter: p } = n.groups,
											y = i.trim() || 'yaml';
										if ((u === '+++' && (y = 'toml'), y !== 'yaml' && u !== p)) return { content: a };
										let [h] = n;
										return {
											frontMatter: { type: 'front-matter', lang: y, value: l, startDelimiter: u, endDelimiter: p, raw: h.replace(/\n$/, '') },
											content: h.replace(/[^\n]/g, ' ') + a.slice(h.length),
										};
									}
									r.exports = s;
...
`
							...
							Pd = te({
								'src/language-css/utils/index.js'(e, r) {
									...
									function c(z) {
										let U = z.getValue();
										return a(z, 'css-atrule')?.name === 'import' && U.groups[0].value === 'url' && U.groups.length === 2;
									}
									function f(z) {
									...
									function B(z) {
										var U, Z;
										return (
											((U = z.value) === null || U === void 0 ? void 0 : U.type) === 'value-root' &&
											((Z = z.value.group) === null || Z === void 0 ? void 0 : Z.type) === 'value-value' &&
									...
									function k(z) {
										var U, Z, se;
										return (
											((U = z.value) === null || U === void 0 || (Z = U.group) === null || Z === void 0 || (se = Z.group) === null || se === void 0
												? void 0
									...
									function R(z) {
										...
										return (
											...
											((U = z.groups) === null || U === void 0 || (Z = U[1]) === null || Z === void 0 ? void 0 : Z.type) === 'value-colon'
										);
									}
									function q(z) {
										var U;
									...
									function i(c, f) {
										...
										for (let F in c) {
											...
											F === 'source' ||
												!_ ||
												typeof _ != 'object' ||
												(_.type === 'value-root' || _.type === 'value-unknown' ? l(_, p(c), _.text || _.value) : i(_, f));
										}
									}
									function l(c, f, F) {
									...
									function p(c) {
										...
										return (
											...
											c.type === 'css-atrule' &&
												...
												(f += 1 + c.name.length + c.raws.afterName.match(/^\s*:?\s*/)[0].length),
											c.type !== 'css-atrule' && c.raws && typeof c.raws.between == 'string' && (f += c.raws.between.length),
											f
										);
									}
									function y(c) {
...
` ||
							...
							Md = te({
								'src/language-css/printer-postcss.js'(e, r) {
									ne();
									var t = lt(),
										{ printNumber: s, printString: a, hasNewline: n, isFrontMatterNode: u, isNextLineEmpty: i, isNonEmptyArray: l } = Ue(),
										{
											builders: { join: p, line: y, hardline: h, softline: g, group: c, fill: f, indent: F, dedent: _, ifBreak: w, breakParent: E },
										...
										switch (ae.type) {
											...
											case 'css-rule':
												return [
													...
													ae.nodes
														? [
																ae.selector && ae.selector.type === 'selector-unknown' && H(ae.selector.value) ? y : ' ',
																'{',
											...
											case 'css-decl': {
												...
												return (
													...
													[
														...
														(Ve.type === 'css-atrule' && Ve.variable) || o(Te) ? ae.prop : m(ae.prop),
														Xe.startsWith('//') ? ' ' : '',
														Xe,
														ae.extend ? '' : ' ',
														De(je) && ae.extend && ae.selector ? ['extend(', Me('selector'), ')'] : '',
														O,
														ae.raws.important ? ae.raws.important.replace(/\s*!\s*important/i, ' !important') : ae.important ? ' !important' : '',
														ae.raws.scssDefault ? ae.raws.scssDefault.replace(/\s*!default/i, ' !default') : ae.scssDefault ? ' !default' : '',
														ae.raws.scssGlobal ? ae.raws.scssGlobal.replace(/\s*!global/i, ' !global') : ae.scssGlobal ? ' !global' : '',
														ae.nodes
															? [' {', F([g, Ce(Te, je, Me)]), g, '}']
															: Z(ae) && !Ve.raws.semicolon && je.originalText[Ee(ae) - 1] !== ';'
															? ''
												...
												if (De(je)) {
													...
													if (ae.variable)
														return [
															...
															ae.nodes ? ['{', F([ae.nodes.length > 0 ? g : '', Ce(Te, je, Me)]), g, '}'] : '',
															We ? '' : ';',
														];
												}
												return [
													...
													ae.value ? c([' ', Me('value'), k(ae) ? (K(ae) ? ' ' : y) : '']) : ae.name === 'else' ? ' ' : '',
													ae.nodes
														? [
																k(ae)
																	? ''
																	: (ae.selector && !ae.selector.nodes && typeof ae.selector.value == 'string' && H(ae.selector.value)) ||
																	  (!ae.selector && typeof ae.params == 'string' && H(ae.params))
																	? y
																	: ' ',
																'{',
											...
											case 'selector-root':
												return c([
													d(Te, 'custom-selector') ? [D(Te, 'css-atrule').customSelector, y] : '',
													p([',', d(Te, ['extend', 'custom-selector', 'nest']) ? y : h], Te.map(Me, 'nodes')),
												]);
											...
											case 'selector-tag': {
												let Ve = Te.getParentNode(),
													...
													Xe = We && Ve.nodes[We - 1];
												return [
													ae.namespace ? [ae.namespace === !0 ? '' : ae.namespace.trim(), '|'] : '',
													Xe.type === 'selector-nesting' ? ae.value : Oe(S(Te, ae.value) ? ae.value.toLowerCase() : ae.value),
												];
											}
											case 'selector-id':
												return ['#', ae.value];
											...
											case 'value-comma_group': {
												...
												for (let at = 0; at < ae.groups.length; ++at) {
													...
													if (
														...
														Ne(Le) ||
														Ne($e) ||
														(Le.type === 'value-atword' && (Le.value === '' || Le.value.endsWith('['))) ||
														($e.type === 'value-word' && $e.value.startsWith(']')) ||
														Le.value === '~' ||
														(Le.value && Le.value.includes('\\') && $e && $e.type !== 'value-comment') ||
														(Ze && Ze.value && Ze.value.indexOf('\\') === Ze.value.length - 1 && Le.type === 'value-operator' && Le.value === '/') ||
														Le.value === '\\' ||
														se(Le, $e) ||
														he(Le) ||
														we(Le) ||
													...
													if (
														...
														(!Ze && L(Le)) ||
														(C(Te, 'calc') && (Q(Le) || Q($e) || V(Le) || V($e)) && de($e))
													)
														continue;
													...
													if (
														!(
															...
															!C(Te, 'calc') &&
															!qo &&
															((L($e) && !lu) || (L(Le) && !cu) || (Q($e) && !lu) || (Q(Le) && !cu) || V($e) || V(Le)) &&
															(de($e) || (Rr && (!Ze || (Ze && j(Ze)))))
														) &&
														!(
												...
												let We = fe(Te),
													...
													Ge = c(
														[
															...
															w(!st && A(je.parser, je.originalText) && We && re(je) ? ',' : ''),
															g,
															ae.close ? Me('close') : '',
														],
														{ shouldBreak: _e }
									...
									function Ce(Te, je, Me) {
										...
										return (
											Te.each((nt, tt, Ve) => {
												...
												tt !== Ve.length - 1 &&
													((Ve[tt + 1].type === 'css-comment' && !n(je.originalText, Ae(Ve[tt + 1]), { backwards: !0 }) && !u(Ve[tt])) ||
													(Ve[tt + 1].type === 'css-atrule' && Ve[tt + 1].name === 'else' && Ve[tt].type !== 'css-comment')
														? ae.push(' ')
														: (ae.push(je.__isHTMLStyleAttribute ? y : h), i(je.originalText, nt.getValue(), Ee) && !u(Ve[tt]) && ae.push(h)));
											}, 'nodes'),
											ae
										);
									}
							...
							Ud = te({
								'src/language-css/index.js'(e, r) {
									...
									var t = _t(),
										...
										n = $d(),
										u = [
											t(Vd(), (l) => ({ since: '1.4.0', parsers: ['css'], vscodeLanguageIds: ['css'], extensions: [...l.extensions, '.wxss'] })),
											t(Wd(), () => ({ since: '1.4.0', parsers: ['css'], vscodeLanguageIds: ['postcss'] })),
											t(Hd(), () => ({ since: '1.4.0', parsers: ['less'], vscodeLanguageIds: ['less'] })),
											t(Gd(), () => ({ since: '1.4.0', parsers: ['scss'], vscodeLanguageIds: ['scss'] })),
										],
										i = { postcss: s };
								...
								'src/language-handlebars/utils.js'(e, r) {
									...
									function F(x, I) {
										...
										let m = x.getValue(),
											...
											o =
												($ = (D = (T = C.children) !== null && T !== void 0 ? T : C.body) !== null && D !== void 0 ? D : C.parts) !== null &&
												$ !== void 0
													? $
													: [],
											d = o.indexOf(m);
							...
							Yd = te({
								'src/language-handlebars/printer-glimmer.js'(e, r) {
									ne();
									var {
											builders: { dedent: t, fill: s, group: a, hardline: n, ifBreak: u, indent: i, join: l, line: p, softline: y },
										...
										switch (le.type) {
											...
											case 'BlockStatement': {
												...
												return Ee &&
													...
													? [ie(H, X, Ee.inverse.body[0].path.parts[0]), de(H, X, pe), ue(H, X, pe)]
											...
											case 'TextNode': {
													...
													if (De === 'class') {
														...
														return (
															D(H, ['ConcatStatement']) &&
																...
																P(H, ['MustacheStatement']) && /\s$/.test(Ee) && Ye !== '' && (Ie = !0)),
															[Se ? p : '', Ye, Ie ? p : '']
														);
													}
													return g(Ee);
												...
												G && Ce
													...
													: (P(H, ['BlockStatement', 'ElementNode']) && (ve = Math.max(ve, 1)),
													  T(H, ['BlockStatement', 'ElementNode']) && (Be = Math.max(Be, 1)));
												let ze = '',
													be = '';
												return (
									...
									function j(H, pe) {
										...
										return (
											...
											a([R(X), Ne(H, pe), le.length > 0 ? i([p, l(p, le)]) : '', y, q(X)])
										);
									}
									function Y(H, pe) {
							...
							eg = te({
								'src/language-handlebars/index.js'(e, r) {
									...
									var t = _t(),
										s = Yd(),
										a = Qd(),
										n = [t(Zd(), () => ({ since: '2.3.0', parsers: ['glimmer'], vscodeLanguageIds: ['handlebars'] }))],
										u = { glimmer: s };
...
` + a
							...
							ng = te({
								'src/language-graphql/printer-graphql.js'(e, r) {
									ne();
									var {
											builders: { join: t, hardline: s, line: a, softline: n, group: u, indent: i, ifBreak: l },
										} = qe(),
										...
										switch (T.kind) {
											...
											case 'OperationDefinition': {
												...
												return [
													...
													y(T.variableDefinitions) ? u(['(', i([n, t([l('', ', '), n], P.map(D, 'variableDefinitions'))]), n, ')']) : '',
													F(P, D, T),
													T.selectionSet ? (!m && !C ? '' : ' ') : '',
													D('selectionSet'),
												];
											...
											case 'Field':
												return u([
													T.alias ? [D('alias'), ': '] : '',
													D('name'),
													T.arguments.length > 0 ? u(['(', i([n, t([l('', ', '), n], _(P, $, D, 'arguments'))]), n, ')']) : '',
													F(P, D, T),
													T.selectionSet ? ' ' : '',
													D('selectionSet'),
												]);
...
`);
											...
											case 'ObjectTypeDefinition':
												return [
													...
													F(P, D, T),
													T.fields.length > 0 ? [' {', i([s, t(s, _(P, $, D, 'fields'))]), s, '}'] : '',
												];
											...
											case 'EnumTypeDefinition':
												return [
													...
													D('name'),
													F(P, D, T),
													T.values.length > 0 ? [' {', i([s, t(s, _(P, $, D, 'values'))]), s, '}'] : '',
												];
											...
											case 'SchemaExtension':
												return [
													'extend schema',
													F(P, D, T),
													...(T.operationTypes.length > 0 ? [' {', i([s, t(s, _(P, $, D, 'operationTypes'))]), s, '}'] : []),
												];
											case 'SchemaDefinition':
												return [
													...
													F(P, D, T),
													' {',
													T.operationTypes.length > 0 ? i([s, t(s, _(P, $, D, 'operationTypes'))]) : '',
													s,
													'}',
												];
											...
											case 'UnionTypeDefinition':
												return u([
													...
													u([
														...
														D('name'),
														F(P, D, T),
														T.types.length > 0 ? [' =', l('', ' '), i([l([a, '  ']), t([a, '| '], P.map(D, 'types'))])] : '',
													]),
												]);
							...
							ag = te({
								'src/language-graphql/index.js'(e, r) {
									...
									var t = _t(),
										...
										a = ug(),
										n = sg(),
										u = [t(ig(), () => ({ since: '1.5.0', parsers: ['graphql'], vscodeLanguageIds: ['graphql'] }))],
										i = { graphql: s };
									r.exports = { languages: u, options: a, printers: i, parsers: n };
								},
							}),
...
`
											...
											for (let [v, S] of d.entries())
												if (!((v === 0 || v === d.length - 1) && S === '')) {
													if (v % 2 === 0) {
														S !== '' &&
															m({ type: 'word', value: S, kind: x, hasLeadingPunctuation: h.test(S[0]), hasTrailingPunctuation: h.test(t(S)) });
														continue;
													}
													m(
														h.test(S)
															? { type: 'word', value: S, kind: $, hasLeadingPunctuation: !0, hasTrailingPunctuation: !0 }
															: { type: 'word', value: S, kind: y.test(S) ? P : I, hasLeadingPunctuation: !1, hasTrailingPunctuation: !1 }
													);
												}
										}
										return D;
										function m(C) {
											...
											o &&
												o.type === 'word' &&
												((o.kind === x && C.kind === I && !o.hasTrailingPunctuation) || (o.kind === I && C.kind === x && !C.hasLeadingPunctuation)
													? D.push({ type: 'whitespace', value: ' ' })
													: !d(x, $) && ![o.value, C.value].some((v) => /\u3000/.test(v)) && D.push({ type: 'whitespace', value: '' })),
												D.push(C);
											function d(v, S) {
									...
									function p(y, h, g, c) {
										...
										if (f.type === 'code' && f.lang !== null) {
											...
											if (F) {
												...
												let N = g(l(f, c.originalText), E, { stripTrailingHardline: !0 });
										...
										switch (f.type) {
											...
											case 'jsx':
												return g(`<$>${f.value}</$>`, { parser: '__js_expression', rootMarker: 'mdx' }, { stripTrailingHardline: !0 });
										}
										return null;
									}
									r.exports = p;
...
${u.content}`;
							...
							cg = te({
								'src/language-markdown/print-preprocess.js'(e, r) {
									...
									function l(w) {
										return a(w, (E) =>
											E.type !== 'import' && E.type !== 'export' ? E : Object.assign(Object.assign({}, E), {}, { type: 'importExport' })
										);
									}
									function p(w, E) {
										return a(w, (N) =>
											N.type !== 'inlineCode' || E.proseWrap === 'preserve'
												? N
												: Object.assign(Object.assign({}, N), {}, { value: N.value.replace(/\s+/g, ' ') })
										);
									}
									function y(w, E) {
										return a(w, (N) =>
											...
											N.position.end.offset - N.position.start.offset === N.value.length
												? N
												: Object.assign(Object.assign({}, N), {}, { value: E.originalText.slice(N.position.start.offset, N.position.end.offset) })
										);
									}
									function h(w) {
										return g(
...
` +
									...
									function c(w) {
										return g(
											...
											(E, N) => ({ type: 'text', value: E.value + N.value, position: { start: E.position.start, end: N.position.end } })
										);
									}
									function f(w, E) {
										return a(w, (N, x, I) => {
											...
											let { value: $ } = N;
											return (
												P.type === 'paragraph' && (x === 0 && ($ = $.trimStart()), x === P.children.length - 1 && ($ = $.trimEnd())),
								...
								'src/language-markdown/clean.js'(e, r) {
									...
									function u(i, l, p) {
										if (
											...
											(i.type === 'list' || i.type === 'listItem') && (delete l.spread, delete l.loose),
											i.type === 'text' ||
												(i.type === 'inlineCode' && (l.value = i.value.replace(/[\t\n ]+/g, ' ')),
												i.type === 'wikiLink' && (l.value = i.value.trim().replace(/[\t\n]+/g, ' ')),
												(i.type === 'definition' || i.type === 'linkReference' || i.type === 'imageReference') && (l.label = t(i.label)),
												(i.type === 'definition' || i.type === 'link' || i.type === 'image') &&
													i.title &&
													(l.title = i.title.replace(/\\(["')])/g, '$1')),
												p &&
													p.type === 'root' &&
													p.children.length > 0 &&
													(p.children[0] === i || (s(p.children[0]) && p.children[1] === i)) &&
													i.type === 'html' &&
													a(i.value)))
										)
											return null;
							...
							fg = te({
								'src/language-markdown/printer-markdown.js'(e, r) {
									ne();
									var t = Po(),
										{ getLast: s, getMinNotPresentContinuousCount: a, getMaxContinuousCount: n, getStringWidth: u, isNonEmptyArray: i } = Ue(),
										{
											builders: {
												breakParent: l,
												join: p,
									...
									function Q(oe, H, pe) {
										let X = oe.getValue();
										if (ge(oe))
											return b(H.originalText.slice(X.position.start.offset, X.position.end.offset), H).map((le) =>
												le.type === 'word' ? le.value : le.value === '' ? '' : W(oe, le.value, H)
											);
										switch (X.type) {
											case 'front-matter':
											...
											case 'word': {
												let le = X.value
														.replace(/\*/g, '\\$&')
														.replace(new RegExp([`(^|${B})(_+)`, `(_+)(${B}|$)`].join('|'), 'g'), (De, A, G, re, ye) =>
												...
												return (
													le !== X.value &&
														(oe.match(void 0, Ae, Ee) || oe.match(void 0, Ae, (De, A, G) => De.type === 'emphasis' && G === 0, Ee)) &&
												...
												switch (H.originalText[X.position.start.offset]) {
													case '<': {
														...
														return [
															'<',
															X.url.startsWith(le) &&
															H.originalText.slice(X.position.start.offset + 1, X.position.start.offset + 1 + le.length) !== le
												...
												return ue(oe, H, pe, {
													processor: (Ee, De) => {
														...
														if (
															...
															G.children[0].position.start.column !== G.children[1].position.start.column
														)
															return [A, V(Ee, H, pe, A)];
														return [A, w(' '.repeat(A.length), V(Ee, H, pe, A))];
														function re() {
															let ye = X.ordered
																? (De === 0 ? X.start : Ae ? 1 : X.start + De) + (le % 2 === 0 ? '. ' : ') ')
																: le % 2 === 0
																? '- '
																: '* ';
											...
											case 'footnoteDefinition': {
												let le = oe.getParentNode().children[oe.getName() + 1],
													Ae =
														...
														(H.proseWrap === 'never' ||
															(H.proseWrap === 'preserve' && X.children[0].position.start.line === X.children[0].position.end.line));
												return [
													Pe(X),
													': ',
													Ae
														? ue(oe, H, pe)
														: N([
																w(' '.repeat(4), ue(oe, H, pe, { processor: (Ee, De) => (De === 0 ? N([f, pe()]) : pe()) })),
...
`
										...
										return (
											oe.each((G, re) => {
												...
												if (Ce !== !1) {
													...
													Z(ye, Be) && (De.push(c), (A && q.has(A.type)) || ((se(ye, Be) || fe(ye, Be)) && De.push(c)), fe(ye, Be) && De.push(c)),
														De.push(Ce),
														(A = ye);
												}
											}, 'children'),
									...
									function U(oe) {
										...
										if (oe.type === 'html') H = oe.value.match(/^<!--\s*prettier-ignore(?:-(start|end))?\s*-->$/);
											...
											oe.type === 'esComment'
												? (pe = oe)
												: oe.type === 'paragraph' && oe.children.length === 1 && oe.children[0].type === 'esComment' && (pe = oe.children[0]),
									...
									function se(oe, H) {
										...
										let Ee = (H.prevNode && H.prevNode.type) === oe.type && L.has(oe.type),
											...
											re =
												oe.type === 'html' &&
												((X = H.prevNode) === null || X === void 0 ? void 0 : X.type) === 'html' &&
												H.prevNode.position.end.line + 1 === oe.position.start.line,
											ye =
												oe.type === 'html' &&
												H.parentNode.type === 'listItem' &&
												((le = H.prevNode) === null || le === void 0 ? void 0 : le.type) === 'paragraph' &&
												H.prevNode.position.end.line + 1 === oe.position.start.line;
							...
							Rt = te({
								'src/language-html/utils/index.js'(e, r) {
									...
									var { inferParserByLanguage: t, isFrontMatterNode: s } = Ue(),
										...
										{ CSS_DISPLAY_TAGS: p, CSS_DISPLAY_DEFAULT: y, CSS_WHITE_SPACE_TAGS: h, CSS_WHITE_SPACE_DEFAULT: g } = yg(),
										c = hg(),
										f = new Set([
											'	',
											`
`,
									...
									function D(A, G) {
										return !!(
											(A.type === 'ieConditionalComment' && A.lastChild && !A.lastChild.isSelfClosing && !A.lastChild.endSourceSpan) ||
											(A.type === 'ieConditionalComment' && !A.complete) ||
											(se(A) && A.children.some((re) => re.type !== 'text' && re.type !== 'interpolation')) ||
									...
									function b(A, G) {
										...
										function ye() {
											return s(A)
												? !1
												: (A.type === 'text' || A.type === 'interpolation') && A.prev && (A.prev.type === 'text' || A.prev.type === 'interpolation')
												? !0
												...
												: !(
														(!A.prev &&
															(A.parent.type === 'root' || (se(A) && A.parent) || o(A.parent) || H(A.parent, G) || !ue(A.parent.cssDisplay))) ||
									...
									function B(A, G) {
										return s(A)
											? !1
											: (A.type === 'text' || A.type === 'interpolation') && A.next && (A.next.type === 'text' || A.next.type === 'interpolation')
											? !0
											: !A.parent || A.parent.cssDisplay === 'none'
											? !1
											: se(A.parent)
											...
											: !(
													(!A.next &&
														(A.parent.type === 'root' || (se(A) && A.parent) || o(A.parent) || H(A.parent, G) || !Fe(A.parent.cssDisplay))) ||
									...
									function R(A) {
										return (
											...
											(A.type === 'element' &&
												A.children.length > 0 &&
												(['body', 'script', 'style'].includes(A.name) || A.children.some((G) => ee(G)))) ||
											(A.firstChild &&
									...
									function q(A) {
										return (
											A.type === 'element' &&
											A.children.length > 0 &&
											(['html', 'head', 'ul', 'ol', 'select'].includes(A.name) || (A.cssDisplay.startsWith('table') && A.cssDisplay !== 'table-cell'))
										);
									}
									function J(A) {
									...
									function V(A) {
										return (
											...
											(A.prev
												...
												: A.parent.type === 'root' || A.parent.startSourceSpan.end.line < A.sourceSpan.start.line)
										);
									}
									function j(A) {
										return (
											...
											(A.next
												...
												: A.parent.type === 'root' || (A.parent.endSourceSpan && A.parent.endSourceSpan.start.line > A.sourceSpan.end.line))
										);
									}
									function Y(A) {
										switch (A.type) {
										...
										switch (G.htmlWhitespaceSensitivity) {
											...
											default:
												return G.parser === 'vue' && A.parent && A.parent.type === 'root'
													? 'block'
													: (A.type === 'element' && (!A.namespace || re || c(A)) && p[A.name]) || y;
										}
									}
									function we(A) {
									...
									function N(o) {
										...
										for (let v = 0; v < o.length; v++) {
											...
											S <= 127
												...
												: S <= 2047
												? (d += String.fromCharCode(((S >> 6) & 31) | 192, (S & 63) | 128))
												: S <= 65535
												? (d += String.fromCharCode((S >> 12) | 224, ((S >> 6) & 63) | 128, (S & 63) | 128))
												: S <= 2097151 &&
												  (d += String.fromCharCode(((S >> 18) & 7) | 240, ((S >> 12) & 63) | 128, ((S >> 6) & 63) | 128, (S & 63) | 128));
										}
										return d;
									}
									e.utf8Encode = N;
...
`
										...
										o.walk((S) => {
											if (S.children)
												for (let b = 0; b < S.children.length; b++) {
													...
													!k ||
														k.type !== 'text' ||
														((k.value += B.value), (k.sourceSpan = new t(k.sourceSpan.start, B.sourceSpan.end)), S.removeChild(B), b--);
												}
										});
									}
									function N(o) {
													...
													for (let R = 0; R < M.length; R++, B = k) {
														...
														(k = B.moveBy(q.length + 4)),
															S.insertChildBefore(b, {
																...
																children: q.length === 0 ? [] : [{ type: 'text', value: q, sourceSpan: new t(B.moveBy(2), k.moveBy(-2)) }],
															});
													}
													S.removeChild(b);
												}
									...
									function P(o) {
										o.walk((d) => {
											...
											if (
												d.children.length === 0 ||
												(d.children.length === 1 && d.children[0].type === 'text' && s(d.children[0].value).length === 0)
											) {
											...
											if (!v)
												for (let b = 0; b < d.children.length; b++) {
													let B = d.children[b];
													if (B.type !== 'text') continue;
													let { leadingWhitespace: k, text: M, trailingWhitespace: R } = a(B.value),
														q = B.prev,
														J = B.next;
													M
														? ((B.value = M),
														  (B.sourceSpan = new t(B.sourceSpan.start.moveBy(k.length), B.sourceSpan.end.moveBy(-R.length))),
														  k && (q && (q.hasTrailingSpaces = !0), (B.hasLeadingSpaces = !0)),
														  R && ((B.hasTrailingSpaces = !0), J && (J.hasLeadingSpaces = !0)))
														: (d.removeChild(B), b--, (k || R) && (q && (q.hasTrailingSpaces = !0), J && (J.hasLeadingSpaces = !0)));
												}
										...
										o.walk((v) => {
											v.type === 'element' &&
												(v.hasHtmComponentClosingTag =
													v.endSourceSpan &&
													/^<\s*\/\s*\/\s*>$/.test(d.originalText.slice(v.endSourceSpan.start.offset, v.endSourceSpan.end.offset)));
										});
									}
									function T(o, d) {
										o.walk((v) => {
									...
									function m(o, d) {
										o.walk((v) => {
											...
											if (S) {
												...
												for (let b = 0; b < S.length; b++) {
													let B = S[b];
													(B.isLeadingSpaceSensitive = (b === 0 || B.prev.isTrailingSpaceSensitive) && B.isLeadingSpaceSensitive),
														(B.isTrailingSpaceSensitive = (b === S.length - 1 || B.next.isLeadingSpaceSensitive) && B.isTrailingSpaceSensitive);
												}
											}
										});
									}
								...
								'src/language-html/print/tag.js'(e, r) {
									...
									function b(L, Q, V) {
										...
										let Y = j.prev && j.prev.type === 'comment' && v(j.prev.value),
											...
											de = [a([ce ? ' ' : u, n(K, ee)])];
										return (
											(j.firstChild && S(j.firstChild)) || (j.isSelfClosing && C(j.parent)) || ce
												? de.push(j.isSelfClosing ? ' ' : '')
												: de.push(Q.bracketSameLine ? (j.isSelfClosing ? ' ' : '') : j.isSelfClosing ? u : i),
											de
										);
									}
									function B(L) {
...
` ||
												...
												function I() {
													for (u(l), _ = '', w = 'in descriptor'; ; ) {
														if (((E = t.charAt(N)), w === 'in descriptor'))
															if (n(E)) _ && (F.push(_), (_ = ''), (w = 'after descriptor'));
															else if (E === ',') {
																(N += 1), _ && F.push(_), P();
																return;
													...
													for (C = 0; C < F.length; C++)
														(d = F[C]),
															...
															g.test(S) && v === 'w'
																...
																: ($ = !0);
													$
														? a && a.error && a.error("Invalid srcset descriptor found in '" + t + "' at '" + d + "'.")
														: ((o.url = f), D && (o.w = D), T && (o.d = T), m && (o.h = m), x.push(o));
												}
											};
										});
								},
							...
							Bg = te({
								'src/language-html/syntax-vue.js'(e, r) {
									...
									function s(i, l) {
										...
										return [
											t(l(`function _(${p}) {}`, { parser: 'babel', __isVueForBindingLeft: !0 })),
											' ',
											y,
											' ',
											l(h, { parser: '__js_expression' }, { stripTrailingHardline: !0 }),
										];
									}
									function a(i) {
										let l = /(.*?)\s+(in|of)\s+(.*)/s,
							...
							Lo = te({
								'src/language-html/get-node-content.js'(e, r) {
									...
									function l(p, y) {
										...
										return (
											p.lastChild && t(p.lastChild) ? (g += s(p, y).length) : a(p) && (g -= n(p.lastChild, y).length), y.originalText.slice(h, g)
										);
									}
									r.exports = l;
								},
							...
							Ng = te({
								'src/language-html/embed.js'(e, r) {
									...
									var {
										...
										{ printVueFor: N, printVueBindings: x, isVueEventBindingExpression: I } = Bg(),
										{
											isScriptLikeTag: P,
											isVueNonHtmlBlock: $,
											inferScriptParser: D,
									...
									function b(k, M, R) {
										let q = (ee) => new RegExp(ee.join('|')).test(k.fullName),
											...
											Q = (ee, ce) => {
												let W =
													ee.type === 'NGRoot'
														? ee.node.type === 'NGMicrosyntax' && ee.node.body.length === 1 && ee.node.body[0].type === 'NGMicrosyntaxExpression'
												...
												W &&
													(W.type === 'ObjectExpression' ||
														...
														(ce.parser === '__vue_expression' && (W.type === 'TemplateLiteral' || W.type === 'StringLiteral'))) &&
													(L = !0);
											},
											V = (ee) => s(ee),
											j = function (ee) {
									...
									function B(k, M, R, q) {
										...
										switch (J.type) {
											case 'element': {
												...
												if (!J.isSelfClosing && $(J, q)) {
													...
													let Q = S(J, q),
														...
														j = '';
													return (
														V || ((j = R(T(Q), { parser: L, __embeddedInHtml: !0 }, { stripTrailingHardline: !0 })), (V = j === '')),
														[F(J, q), s(_(k, q, M)), V ? '' : a, j, V ? '' : a, g(J, q), c(J, q)]
													);
												}
												break;
											}
												...
												if (P(J.parent)) {
													...
													if (L) {
														...
														if (q.parser === 'html' && L === 'babel') {
															let j = 'script',
																{ attrMap: Y } = J.parent;
															Y && (Y.type === 'module' || (Y.type === 'text/babel' && Y['data-type'] === 'module')) && (j = 'module'),
																(V.__babelSourceType = j);
														}
														return [t, F(J, q), R(Q, V, { stripTrailingHardline: !0 }), c(J, q)];
													}
												} else if (J.parent.type === 'interpolation') {
													let L = { __isInHtmlInterpolation: !0, __embeddedInHtml: !0 };
													return (
														q.parser === 'angular'
															? ((L.parser = '__ng_interpolation'), (L.trailingComma = 'none'))
															: q.parser === 'vue'
															? (L.parser = q.__should_parse_vue_template_with_ts ? '__vue_ts_expression' : '__vue_expression')
															: (L.parser = '__js_expression'),
														[n([u, R(J.value, L, { stripTrailingHardline: !0 })]), J.parent.next && f(J.parent.next) ? ' ' : u]
													);
												}
												break;
											}
											case 'attribute': {
												...
												let L = b(
													J,
													(Q, V) => R(Q, Object.assign({ __isInHtmlAttribute: !0, __embeddedInHtml: !0 }, V), { stripTrailingHardline: !0 }),
													q
												);
									...
									function $(m, C, o) {
										...
										return f(d)
											? [
													_(d, C),
													...l(
														C.originalText.slice(p(d) + (d.prev && w(d.prev) ? E(d).length : 0), y(d) - (d.next && N(d.next) ? x(d, C).length : 0))
													),
													I(d, C),
											  ]
											: o();
									...
									function D(m, C) {
										return c(m) && c(C)
											? m.isTrailingSpaceSensitive
												...
												? i
												: u
											: (w(m) && (f(C) || C.firstChild || C.isSelfClosing || (C.type === 'element' && C.attrs.length > 0))) ||
											  (m.type === 'element' && m.isSelfClosing && N(C))
											? ''
											: !C.isLeadingSpaceSensitive ||
											  F(C) ||
											  (N(C) && m.lastChild && P(m.lastChild) && m.lastChild.lastChild && P(m.lastChild.lastChild))
											? i
											: C.hasLeadingSpaces
											? n
											: u;
									...
									function T(m, C, o) {
										...
										return m.map((S, b) => {
											...
											let k = [],
												...
												L = B.next ? D(B, B.next) : '';
											return (
												J && (g(B.prev) ? k.push(i, i) : J === i ? k.push(i) : c(B.prev) ? M.push(J) : M.push(a('', u, { groupId: v[b - 1] }))),
												L && (g(B) ? c(B.next) && q.push(i, i) : L === i ? c(B.next) && q.push(i) : R.push(L)),
							...
							wg = te({
								'src/language-html/print/element.js'(e, r) {
									ne();
									var {
											builders: { breakParent: t, dedentToRoot: s, group: a, ifBreak: n, indentIfBreak: u, indent: i, line: l, softline: p },
											utils: { replaceTextEndOfLine: y },
										} = qe(),
										h = Lo(),
										{ shouldPreserveContent: g, isScriptLikeTag: c, isVueCustomBlock: f, countParents: F, forceBreakContent: _ } = Rt(),
										{
									...
									function D(T, m, C) {
										...
										let d =
											...
											b = (M) =>
												d
													? u(M, { groupId: v })
													: (c(o) || f(o, m)) && o.parent.type === 'root' && m.parser === 'vue' && !m.vueIndentScriptAndStyle
													? M
													: i(M),
											B = () =>
												d
											...
											k = () =>
												(o.next ? I(o.next) : P(o.parent))
													...
													: (o.lastChild.type === 'comment' ||
													  ...
													  new RegExp(`\\n[\\t ]{${m.tabWidth * F(T, (R) => R.parent && R.parent.type !== 'root')}}$`).test(o.lastChild.value)
													? ''
													: p;
							...
							_g = te({
								'src/language-html/printer-html.js'(e, r) {
									...
									var {
										...
										y = gg(),
										{ countChars: h, unescapeQuoteEntities: g, getTextValueParts: c } = Rt(),
										f = Sg(),
										{ insertPragma: F } = xg(),
										{ locStart: _, locEnd: w } = au(),
										E = Ng(),
										{ printClosingTagSuffix: N, printClosingTagEnd: x, printOpeningTagPrefix: I, printOpeningTagStart: P } = ur(),
										{ printElement: $ } = wg(),
										{ printChildren: D } = Oo();
									function T(m, C, o) {
										let d = m.getValue();
								...
								'src/language-html/index.js'(e, r) {
									...
									var t = _t(),
										...
										u = [
											...
											t(On(), (l) => ({ since: '1.15.0', parsers: ['html'], vscodeLanguageIds: ['html'], extensions: [...l.extensions, '.mjml'] })),
											t(On(), () => ({
											...
											t(kg(), () => ({ since: '1.10.0', parsers: ['vue'], vscodeLanguageIds: ['vue'] })),
										],
										i = { html: s };
...
`
											...
											d === 0 && d === v.length - 1 ? o : d !== 0 && d !== v.length - 1 ? o.trim() : d === 0 ? o.trimEnd() : o.trimStart()
										);
										return m.proseWrap === 'preserve'
											...
											: C.map((o) => (o.length === 0 ? [] : x(o)))
													.reduce(
														(o, d, v) =>
															v !== 0 && C[v - 1].length > 0 && d.length > 0 && !(D === 'quoteDouble' && t(t(o)).endsWith('\\'))
																? [...o.slice(0, -1), [...t(o), ...d]]
																: [...o, d],
														[]
													)
										...
										let { parentIndent: m, isLastDescendant: C, options: o } = T,
											d =
												D.position.start.line === D.position.end.line
													? ''
													: o.originalText.slice(D.position.start.offset, D.position.end.offset).match(/^[^\n]*\n(.*)$/s)[1],
											v;
										if (D.indent === null) {
...
`
										...
										return b(
											S.map((B) => (B.length === 0 ? [] : x(B)))
												.reduce(
													(B, k, M) =>
														M !== 0 && S[M - 1].length > 0 && k.length > 0 && !/^\s/.test(k[0]) && !/^\s|\s$/.test(t(B))
															? [...B.slice(0, -1), [...t(B), ...k]]
															: [...B, k],
													[]
												)
												.map((B) => B.reduce((k, M) => (k.length > 0 && /\s$/.test(t(k)) ? [...k.slice(0, -1), t(k) + ' ' + M] : [...k, M]), []))
								...
								'src/language-yaml/print/misc.js'(e, r) {
									...
									function l(h, g) {
										...
										return (
											...
											!F.has(c.position.end.line) && (F.add(c.position.end.line), n(c, g) && !p(h.getParentNode())) ? t : ''
										);
									}
									function p(h) {
							...
							Rg = te({
								'src/language-yaml/print/flow-mapping-sequence.js'(e, r) {
									...
									function g(f, F, _) {
										...
										return [
											N,
											h(_.tabWidth, [I, c(f, F, _), _.trailingComma === 'none' ? '' : t(','), p(w) ? [n, u(n, f.map(F, 'endComments'))] : '']),
											$ ? '' : I,
											x,
										];
									}
										...
										return f.map(
											(N, x) => [
												...
												x === w.children.length - 1
													? ''
													: [',', s, w.children[x].position.start.line !== w.children[x + 1].position.start.line ? y(N, _.originalText) : ''],
											],
											'children'
										);
									}
							...
							$g = te({
								'src/language-yaml/print/mapping-item.js'(e, r) {
									ne();
									var {
											builders: { conditionalGroup: t, group: s, hardline: a, ifBreak: n, join: u, line: i },
										} = qe(),
										{
									...
									function _(x, I, P, $, D) {
										...
										if (o)
											return x.type === 'flowMappingItem' && I.type === 'flowMapping'
												? d
												: x.type === 'mappingItem' && w(T.content, D) && !y(T.content) && (!I.tag || I.tag.value !== 'tag:yaml.org,2002:set')
												? [d, v, ':']
												: ['? ', F(2, d)];
										let S = $('value');
										if (C) return [': ', F(2, S)];
										...
										(g(m.content, ['mapping', 'sequence']) && m.content.tag === null && m.content.anchor === null)
											? M.push(a)
											: m.content && M.push(i),
											M.push(S);
...
`);
							...
							Vg = te({
								'src/language-yaml/print/block.js'(e, r) {
									ne();
									var {
											builders: { dedent: t, dedentToRoot: s, fill: a, hardline: n, join: u, line: i, literalline: l, markAsRoot: p },
											utils: { getDocParts: y },
										} = qe(),
										{ getAncestorCount: h, getBlockValueLineContents: g, hasIndicatorComment: c, isLastDescendantNode: f, isNode: F } = $t(),
									...
									function w(E, N, x) {
										...
										for (let [C, o] of T.entries())
											C === 0 && m.push(n),
												m.push(a(y(u(i, o)))),
												C !== T.length - 1 ? m.push(o.length === 0 ? n : p(l)) : I.chomping === 'keep' && $ && m.push(s(o.length === 0 ? n : l));
							...
							Wg = te({
								'src/language-yaml/printer-yaml.js'(e, r) {
									ne();
									var {
											builders: { breakParent: t, fill: s, group: a, hardline: n, join: u, line: i, lineSuffix: l, literalline: p },
										...
										C = Mg(),
										{ alignWithSpaces: o, printNextEmptyLine: d, shouldPrintEndComments: v } = Mr(),
									...
									function M(j, Y, ie) {
										...
										let de = '';
										T(ee, ['mapping', 'sequence', 'comment', 'directive', 'mappingItem', 'sequenceItem']) && !D(j) && (de = d(j, Y.originalText)),
											(W || K) && (T(ee, ['sequence', 'mapping']) && !x(ee) ? ce.push(n) : ce.push(' ')),
											x(ee) && ce.push([ee.middleComments.length === 1 ? '' : n, u(n, j.map(ie, 'middleComments')), n]);
										let ue = j.getParentNode();
										return (
											$(j)
												? ce.push(h(Y.originalText.slice(ee.position.start.offset, ee.position.end.offset).trimEnd(), p))
											...
											I(ee) &&
												...
												ce.push(
													l([
														...
														ue.type === 'mappingKey' && j.getParentNode(2).type === 'mapping' && m(ee) ? '' : t,
														ie('trailingComment'),
													])
												),
											v(ee) &&
												ce.push(
													o(ee.type === 'sequenceItem' ? 2 : 0, [
														...
														u(
															n,
															j.map((Fe) => [g(Y.originalText, Fe.getValue(), F) ? n : '', ie()], 'endComments')
														),
													])
												),
											ce.push(de),
										...
										switch (j.type) {
											case 'root': {
												...
												ie.each((ue, Fe) => {
													...
													Fe !== 0 && K.push(n),
														K.push(ce()),
														J(z, U) ? (K.push(n, '...'), I(z) && K.push(' ', ce('trailingComment'))) : U && !I(U.head) && K.push(n, '---');
												}, 'children');
												let de = E(j);
											...
											case 'document': {
												...
												return (
													L(j, W, Y, ee) === 'head' &&
														((j.head.children.length > 0 || j.head.endComments.length > 0) && K.push(ce('head')),
														I(j.head) ? K.push(['---', ' ', ce(['head', 'trailingComment'])]) : K.push('---')),
													q(j) && K.push(ce('body')),
													u(n, K)
												);
											}
									...
									function L(j, Y, ie, ee) {
										return (ie.children[0] === j && /---(?:\s|$)/.test(ee.originalText.slice(F(j), F(j) + 4))) ||
...
var formatter = (0, import_memoizerific.default)(2)((type, source) =>
	type === !1
		...
		: type === 'dedent' || type === !0
		? dedent(source)
		: import_standalone.default.format(source, { parser: type, plugins: [import_parser_html.default], htmlWhitespaceSensitivity: 'ignore' }).trim()
);
export { formatter };
