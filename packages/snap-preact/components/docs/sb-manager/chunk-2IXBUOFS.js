							...
							if (
								(typeof token != 'string' &&
									(token.type === 'tag' && token.content[0] && token.content[0].type === 'tag'
										...
										? openedTags[openedTags.length - 1].openedBraces--
										: (notTagNorBrace = !0)),
								(notTagNorBrace || typeof token == 'string') && openedTags.length > 0 && openedTags[openedTags.length - 1].openedBraces === 0)
							) {
								...
								(characters
									? type === name
										? (terminated && !entity
												...
												: (entityCharacters !== characters && ((end = begin + entityCharacters.length), (diff = 1 + end - begin), (terminated = !1)),
												  terminated ||
										...
										: (terminated || warning(numericNotTerminated, diff),
										  ...
										  prohibited(reference)
												...
												: ((output = ''),
												  ...
												  reference > 65535 &&
														((reference -= 65536), (output += fromCharCode((reference >>> 10) | 55296)), (reference = 56320 | (reference & 1023))),
						...
						_ = {
							...
							highlightElement: function (element, async, callback) {
								...
								if (
									...
									parent && parent.nodeName.toLowerCase() === 'pre' && !parent.hasAttribute('tabindex') && parent.setAttribute('tabindex', '0'),
									!env.code)
								) {
								...
								for (var j = 0; j < patterns.length; ++j) {
									...
									for (
										...
										if (!(str instanceof Token)) {
											...
											if (
												((currentNode = addAfter(tokenList, removeFrom, wrapped)), after && addAfter(tokenList, currentNode, after), removeCount > 1)
											) {
...
function getAllLineNumbers(_ref) {
	...
	return lines.map(function (_, i) {
		...
		return import_react.default.createElement(
			'span',
			{ key: 'line-'.concat(i), className: 'react-syntax-highlighter-line-number', style: typeof style == 'function' ? style(number) : style },
			''.concat(
				number,
				`
`
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
	let { present, children } = props,
		...
		child = typeof children == 'function' ? children({ present: presence.isPresent }) : import_react.Children.only(children),
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
	...
	let createScope = () => {
		...
		return function (scope2) {
			...
			return (0, import_react.useMemo)(() => ({ [`__scope${scopeName}`]: { ...scope2, [scopeName]: contexts } }), [scope2, contexts]);
		};
	};
	return (
...
var $57acba87d6e25586$var$SCROLL_AREA_NAME = 'ScrollArea',
	...
	$57acba87d6e25586$export$a21cbf9f11fca853 = (0, import_react.forwardRef)((props, forwardedRef) => {
		...
		return (0, import_react.createElement)(
			...
			(0, import_react.createElement)(
				...
				(0, import_react.createElement)('div', { ref: context.onContentChange, style: { minWidth: '100%', display: 'table' } }, children)
			)
		);
	}),
	...
	$57acba87d6e25586$export$2fabd85d0eba3c57 = (0, import_react.forwardRef)((props, forwardedRef) => {
		...
		return (
			...
			context.type === 'hover'
				...
				: context.type === 'always'
				? (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaScrollbarVisible, _extends2({}, scrollbarProps, { ref: forwardedRef }))
				: null
		);
	}),
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react.forwardRef)((props, forwardedRef) => {
		let { orientation = 'vertical', ...scrollbarProps } = props,
			...
			[sizes, setSizes] = (0, import_react.useState)({ content: 0, viewport: 0, scrollbar: { size: 0, paddingStart: 0, paddingEnd: 0 } }),
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarImpl = (0, import_react.forwardRef)((props, forwardedRef) => {
		...
		return (
			(0, import_react.useEffect)(() => {
				...
				return (
					document.addEventListener('wheel', handleWheel, { passive: !1 }), () => document.removeEventListener('wheel', handleWheel, { passive: !1 })
				);
	...
	$57acba87d6e25586$export$9fba1154677d7cd2 = (0, import_react.forwardRef)((props, forwardedRef) => {
		...
		return (0, import_react.createElement)(
			...
			(0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaThumbImpl, _extends2({ ref: forwardedRef }, thumbProps))
		);
	}),
	$57acba87d6e25586$var$ScrollAreaThumbImpl = (0, import_react.forwardRef)((props, forwardedRef) => {
		let { __scopeScrollArea, style, ...thumbProps } = props,
			...
			composedRef = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => scrollbarContext.onThumbChange(node)),
		...
		return (
			(0, import_react.useEffect)(() => {
				...
				if (viewport) {
					...
					return (
						onThumbPositionChange(), viewport.addEventListener('scroll', handleScroll), () => viewport.removeEventListener('scroll', handleScroll)
					);
				}
	...
	$57acba87d6e25586$export$56969d565df7cc4b = (0, import_react.forwardRef)((props, forwardedRef) => {
		...
		return context.type !== 'scroll' && hasBothScrollbarsVisible
			? (0, import_react.createElement)($57acba87d6e25586$var$ScrollAreaCornerImpl, _extends2({}, props, { ref: forwardedRef }))
			: null;
	}),
	$57acba87d6e25586$var$ScrollAreaCornerImpl = (0, import_react.forwardRef)((props, forwardedRef) => {
		...
		return (
			$57acba87d6e25586$var$useResizeObserver(context.scrollbarX, () => {
				...
				let height =
					((_context$scrollbarX = context.scrollbarX) === null || _context$scrollbarX === void 0 ? void 0 : _context$scrollbarX.offsetHeight) || 0;
				context.onCornerHeightChange(height), setHeight(height);
			}),
			$57acba87d6e25586$var$useResizeObserver(context.scrollbarY, () => {
				var _context$scrollbarY;
				let width =
					((_context$scrollbarY = context.scrollbarY) === null || _context$scrollbarY === void 0 ? void 0 : _context$scrollbarY.offsetWidth) || 0;
