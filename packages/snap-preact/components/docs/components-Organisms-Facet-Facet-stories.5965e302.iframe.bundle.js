...
`,
					v = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, o.FD)('div', {
										children: [(0, o.Y)(r.oz, { options: { overrides: { code: E.Z } }, children: x }), (0, o.Y)(r.uY, { story: r.h1 })],
									}),
							},
						},
				...
				const O = (0, m.PA)(({ args: t, controller: n }) => {
						const s = n?.store?.facets.filter((d) => d.display === f.Q.PALETTE).shift();
						return s ? (0, o.Y)(h.s, { ...t, facet: s }) : (0, o.Y)('div', {});
					}),
					g = (t, { loaded: { controller: n } }) => (0, o.Y)(O, { args: t, controller: n });
				...
				const L = (0, m.PA)(({ args: t, controller: n }) => {
					...
					b = (t, { loaded: { controller: n } }) => (0, o.Y)(L, { args: t, controller: n });
				b.loaders = [async () => (await u.search(), { controller: u })];
				const P = (0, m.PA)(({ args: t, controller: n }) => {
						const s = n?.store?.facets.filter((d) => d.display === f.Q.HIERARCHY).shift();
						return s ? (0, o.Y)(h.s, { ...t, facet: s }) : (0, o.Y)('div', {});
					}),
					a = (t, { loaded: { controller: n } }) => (0, o.Y)(P, { args: t, controller: n });
			...
			'./components/src/utilities/snapify.ts'(w, c, e) {
				...
				class g {
					static recommendation(l) {
						const t = l.id;
						if (i[t]) return i[t];
						const n = (i[t] = b({ client: O, controller: l }));
						return (
					...
					static autocomplete(l) {
						const t = l.id;
						if (i[t]) return i[t];
						const n = (i[t] = P({ client: O, controller: l }));
						return (
							n.on('afterStore', async ({ controller: s }, d) => {
								s.log.debug('controller', s), s.log.debug('store', s.store.toJSON()), await d();
							}),
					...
					static search(l) {
						const t = l.id;
						if (i[t]) return i[t];
						const n = (i[t] = L({ client: O, controller: l }));
						return (
							n.on('afterStore', async ({ controller: s }, d) => {
								s.log.debug('controller', s), s.log.debug('store', s.store.toJSON()), await d();
							}),
				...
				function L(a) {
					...
					return new m.Tp(a.controller, {
						...
						store: new E.U(a.controller, { urlManager: l }),
						urlManager: l,
				...
				function b(a) {
					...
					return new h.c(a.controller, {
						client: new p.K(a.client.globals, a.client.config),
						store: new C.t(a.controller, { urlManager: l }),
						urlManager: l,
						eventManager: new u.E(),
						profiler: new _.U(),
						logger: new y.V(),
...
//# sourceMappingURL=components-Organisms-Facet-Facet-stories.5965e302.iframe.bundle.js.map
