(() => {
	(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
		[6225],
		{
			'./components/src/components/Templates/RecommendationBundle/RecommendationBundle.stories.tsx'(w, r, e) {
				'use strict';
				e.r(r), e.d(r, { Default: () => l, __namedExportsOrder: () => d, default: () => f });
				...
				const f = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, n.FD)('div', {
										children: [(0, n.Y)(c.oz, { options: { overrides: { code: b.Z } }, children: _ }), (0, n.Y)(c.uY, { story: c.h1 })],
									}),
							},
						},
						decorators: [(y) => (0, n.Y)('div', { style: { maxWidth: '900px', height: '500px' }, children: (0, n.Y)(y, {}) })],
						argTypes: {
							controller: {
					...
					B = { id: 'RecommendationBundle', tag: 'bundle', globals: { siteId: 'atkzs2', products: ['C-AD-W1-1869P'] } },
					v = i.p.recommendation(B),
					l = (y, { loaded: { controller: x } }) => (0, n.Y)(a.g, { ...y, controller: x, results: x.store.results });
				(l.loaders = [
					async () => (
						v.on('afterStore', async ({ controller: y }, x) => {
  ...
  return <RecommendationBundle {...props} controller={controller} results={controller.store.results} />;
					...
					return (
						(0, n.vJ)(() => {
							const p = new IntersectionObserver(
								([f]) => {
									_(f.isIntersecting), t && f.isIntersecting && p.unobserve(a.current);
								},
								{ rootMargin: b }
							);
							return (
			...
			'./components/src/hooks/useIntersectionAdvanced.tsx'(w, r, e) {
				...
				const c = 250,
					a = (t, i = {}) => {
						const { rootMargin: _ = '0px', fireOnce: p = !1, threshold: f = 0, minVisibleTime: B = 0 } = i,
							[v, l] = (0, n.J0)(!1),
							d = (0, n.li)(null),
							y = (0, n.li)(null),
							[x, h] = (0, n.J0)(0),
						...
						return (
							(0, n.vJ)(() => {
								...
								const I = () => {
									...
									o = () => {
										d.current && window.clearTimeout(d.current), (d.current = null), (y.current = null), l(!1);
									};
								return (
			...
			'./components/src/utilities/createImpressionObserver.ts'(w, r, e) {
				...
				function t(i) {
					const _ = (0, n.li)(null),
						{ inViewport: p, updateRef: f } = (0, c.v)(_, { ...i, fireOnce: !0, threshold: a, minVisibleTime: b });
					return { ref: _, inViewport: p, updateRef: f };
				}
			},
			'./components/src/utilities/snapify.ts'(w, r, e) {
				...
				var n = e('../../node_modules/mobx/dist/mobx.esm.js'),
					...
					_ = e('../../node_modules/@searchspring/snap-store-mobx/dist/esm/Search/SearchStore.js'),
				...
				class g {
					static recommendation(s) {
						const u = s.id;
						if (h[u]) return h[u];
						const T = (h[u] = I({ client: R, controller: s }));
						return (
					...
					static autocomplete(s) {
						const u = s.id;
						if (h[u]) return h[u];
						const T = (h[u] = A({ client: R, controller: s }));
						return (
							T.on('afterStore', async ({ controller: m }, j) => {
								m.log.debug('controller', m), m.log.debug('store', m.store.toJSON()), await j();
							}),
					...
					static search(s) {
						const u = s.id;
						if (h[u]) return h[u];
						const T = (h[u] = C({ client: R, controller: s }));
						return (
							T.on('afterStore', async ({ controller: m }, j) => {
								m.log.debug('controller', m), m.log.debug('store', m.store.toJSON()), await j();
							}),
				...
				function C(o) {
					const s = new f.V(new v.E({ settings: { coreType: 'query', corePrefix: o.controller.id } }), B.X);
					return new c.Tp(o.controller, {
						client: new t.K(o.client.globals, o.client.config),
						store: new _.U(o.controller, { urlManager: s }),
						urlManager: s,
						eventManager: new l.E(),
						profiler: new d.U(),
						logger: new y.V(),
						tracker: new x.J(o.client.globals),
					});
				}
				function I(o) {
					const s = new f.V(new v.E(), B.X).detach(!0);
					return new b.c(o.controller, {
						client: new t.K(o.client.globals, o.client.config),
						store: new p.t(o.controller, { urlManager: s }),
						urlManager: s,
						eventManager: new l.E(),
						profiler: new d.U(),
						logger: new y.V(),
				...
				function A(o) {
					const s = new f.V(new v.E(), B.X).detach();
					return new a.Z(o.controller, {
						client: new t.K(o.client.globals, o.client.config),
						store: new i.Y(o.controller, { urlManager: s }),
						urlManager: s,
						eventManager: new l.E(),
						profiler: new d.U(),
						logger: new y.V(),
...
//# sourceMappingURL=components-Templates-RecommendationBundle-RecommendationBundle-stories.eee161e8.iframe.bundle.js.map
