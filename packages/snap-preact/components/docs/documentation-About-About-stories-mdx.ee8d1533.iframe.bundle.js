		...
		[3433],
		{
			'../../node_modules/@mdx-js/react/lib/index.js'(u, n, t) {
				...
				function h(o) {
					return r;
					function r(i) {
						const m = s(i.components);
						return c.createElement(o, { ...i, allComponents: m });
					}
				}
				function s(o) {
				...
				const e = {};
				function p({ components: o, children: r, disableParentContext: i }) {
					let m;
					return i ? (m = typeof o == 'function' ? o({}) : o || e) : (m = s(o)), a.default.createElement(l.Provider, { value: m }, r);
				}
			},
			'./components/src/documentation/About/About.stories.mdx'(u, n, t) {
				'use strict';
				t.r(n), t.d(n, { __namedExportsOrder: () => f, __page: () => r, default: () => m });
				var c = t('../../node_modules/preact/compat/dist/compat.module.js'),
...
`,
				...
				const i = { title: 'Documentation/About', tags: ['stories-mdx'], includeStories: ['__page'] };
				(i.parameters = i.parameters || {}), (i.parameters.docs = { ...(i.parameters.docs || {}), page: o });
				const m = i,
					f = ['__page'];
			},
			'./components/src/utilities/storybook.tsx'(u, n, t) {
				'use strict';
				t.d(n, { Z: () => h });
				var c = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const l = 'prism-block',
					h = (s) => {
						...
						return (
							...
							(0, c.Y)('code', { ...s, ref: e, 'data-prismjs-copy': 'Copy' })
						);
					};
			},
...
//# sourceMappingURL=documentation-About-About-stories-mdx.ee8d1533.iframe.bundle.js.map
