/*! For license information please see components-Atoms-BadgePill-BadgePill-stories.de247628.iframe.bundle.js.LICENSE.txt */
(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
	[7698],
	{
		'./components/src/components/Atoms/BadgePill/BadgePill.stories.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			'use strict';
			__webpack_require__.r(__webpack_exports__),
				__webpack_require__.d(__webpack_exports__, {
					Default: () => Default,
					__namedExportsOrder: () => __namedExportsOrder,
					default: () => BadgePill_stories,
				});
			...
			const BadgePill_stories = {
				...
				Default = (args) => (0, emotion_react_jsx_runtime_browser_esm.Y)(BadgePill.L, { ...args });
			(Default.args = { value: '30% Off', color: '#0000FF', colorText: '#FFFFFF' }),
				(Default.parameters = {
					...Default.parameters,
					docs: {
						...Default.parameters?.docs,
						source: { originalSource: '(args: BadgePillProps) => <BadgePill {...args} />', ...Default.parameters?.docs?.source },
					},
				});
