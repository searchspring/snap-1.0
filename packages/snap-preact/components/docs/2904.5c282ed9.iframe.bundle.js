...
(() => {
	(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
		[2904],
		{
			'../../node_modules/@searchspring/snap-controller/dist/esm/Recommendation/RecommendationController.js'(T, v, o) {
				o.d(v, { c: () => E });
				var n = o('../../node_modules/deepmerge/dist/cjs.js'),
					b = o.n(n),
					f = o('../../node_modules/@searchspring/snap-store-mobx/dist/esm/types.js'),
					I = o('../../node_modules/@searchspring/snap-controller/dist/esm/Abstract/AbstractController.js'),
					k = o('../../node_modules/@searchspring/snap-controller/dist/esm/types.js'),
					u = o('../../node_modules/@searchspring/snap-controller/dist/esm/utils/isClickWithinProductLink.js');
				const y = { id: 'recommend', beacon: { enabled: !0 }, tag: '', batched: !0, realtime: !1, globals: {} };
				class E extends I.r {
					constructor(c, { client: m, store: r, urlManager: s, eventManager: a, profiler: h, logger: w, tracker: R }, P) {
						if (
							(super(c, { client: m, store: r, urlManager: s, eventManager: a, profiler: h, logger: w, tracker: R }, P),
								...
								product: {
									clickThrough: (e, t) => {
										...
										const d = ['product', 'banner'].includes(t.type) ? t.type : 'product',
											...
											l = { tag: this.store.profile.tag, responseId: i, results: [p] };
									...
									addToCart: (e) => {
										...
										const t = e.responseId,
											...
											d = { responseId: t, tag: this.store.profile.tag, results: [i] };
							...
							(this.search = async () => {
								try {
									...
									const t = this.profiler.create({ type: 'event', name: 'search', context: e }).start(),
										{ meta: i, profile: d, results: p, responseId: l } = await this.client.recommend(e);
									...
									try {
										await this.eventManager.fire('afterSearch', { controller: this, request: e, response: { meta: i, profile: d, results: p } });
									} catch (g) {
										if (g?.message == 'cancelled') {
									...
									C.stop(), this.log.profile(C), this.store.update({ meta: i, profile: d, results: p, responseId: l });
									...
									try {
										await this.eventManager.fire('afterStore', {
											controller: this,
											request: e,
											response: { meta: i, profile: d, results: p, responseId: l },
										});
									} catch (g) {
										if (g?.message == 'cancelled') {
					...
					get params() {
						...
						if ((m && (c.shopper = m), !c.siteId || c.siteId == this.tracker.getGlobals().siteId)) {
			...
			'../../node_modules/@searchspring/snap-store-mobx/dist/esm/Recommendation/RecommendationStore.js'(T, v, o) {
				o.d(v, { t: () => c });
				var n = o('../../node_modules/mobx/dist/mobx.esm.js'),
					b = o('../../node_modules/deepmerge/dist/cjs.js'),
					f = o.n(b),
					I = o('../../node_modules/@searchspring/snap-store-mobx/dist/esm/Abstract/AbstractStore.js'),
					k = o('../../node_modules/@searchspring/snap-store-mobx/dist/esm/Search/Stores/SearchResultStore.js'),
					u = o('../../node_modules/@searchspring/snap-event-manager/dist/esm/EventManager.js');
				class y {
					constructor() {
					...
					removeItems(r) {
						const s = [...this.items];
						r.forEach((a) => {
							const h = s.findIndex((w) => w.id == a.id);
				...
				var M = o('../../node_modules/@searchspring/snap-store-mobx/dist/esm/Meta/MetaStore.js');
				class c extends I.K {
					constructor(r, s) {
						if (
							(super(r),
					...
					update(r) {
						...
						(this.error = void 0),
							...
							(this.profile = new E({ data: { profile: { profile: a } } })),
