	...
	[8012],
	{
		'./components/src/components/Molecules/Grid/Grid.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
				...
				_Atoms_Image__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__('./components/src/components/Atoms/Image/Image.tsx'),
					...
					OverflowButtonElem = () => {
						...
						return showButton && remainder > 0 && options.length !== limit
							? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.Y)('div', {
									...
									role: 'button',
									ref: (e) => (disableA11y || disableOverflowAction ? null : (0, _hooks__WEBPACK_IMPORTED_MODULE_12__.i)(e)),
												...
												if (!limited || options.length == limit || idx < limit - (overflowButtonInGrid ? 1 : 0))
													return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.FD)('div', {
														className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(
															`ss__grid__option ss__grid__option-value--${_searchspring_snap_toolbox__WEBPACK_IMPORTED_MODULE_15__.p(
														...
														children: [
															!option.background && option.backgroundImageUrl
																? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.Y)(_Atoms_Image__WEBPACK_IMPORTED_MODULE_16__._, {
																		...subProps_image,
		...
		'./components/src/components/Molecules/Swatches/Swatches.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
				...
				_Grid__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__('./components/src/components/Molecules/Grid/Grid.tsx'),
				_Atoms_Image__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__('./components/src/components/Atoms/Image/Image.tsx'),
				deepmerge__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__('../../node_modules/deepmerge/dist/cjs.js'),
				deepmerge__WEBPACK_IMPORTED_MODULE_3___default = __webpack_require__.n(deepmerge__WEBPACK_IMPORTED_MODULE_3__),
									...
									'carousel' == type
										? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.Y)(_Carousel__WEBPACK_IMPORTED_MODULE_13__.FN, {
												...
												children: options.map((option) => {
													...
													return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.FD)('div', {
														className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(
															`ss__swatches__carousel__swatch ss__swatches__carousel__swatch--${_searchspring_snap_toolbox__WEBPACK_IMPORTED_MODULE_14__.p(
																option.value?.toString()
															)}`,
															{
										...
										: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.Y)(_Grid__WEBPACK_IMPORTED_MODULE_17__.x, {
												...subProps_grid,
												options,
												onSelect: (e, option) => {
					...
					const globalTheme = (0, _providers__WEBPACK_IMPORTED_MODULE_4__.u)(),
						...
						DropdownContent = (props) => {
							...
							return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Y)('ul', {
								...
								ref: (e) => (0, _hooks__WEBPACK_IMPORTED_MODULE_10__.i)(e, -1, !0, () => toggleOpen()),
