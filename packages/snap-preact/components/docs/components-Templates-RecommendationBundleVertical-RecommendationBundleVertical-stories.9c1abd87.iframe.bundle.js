(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
	[6969],
	{
		'./components/src/components/Templates/RecommendationBundleVertical/RecommendationBundleVertical.stories.tsx': (
			...
			__webpack_require__.r(__webpack_exports__),
				__webpack_require__.d(__webpack_exports__, {
					...
					default: () => RecommendationBundleVertical_stories,
				});
			...
			const RecommendationBundleVertical_stories = {
					title: 'Templates/RecommendationBundleVertical',
					component: RecommendationBundleVertical.a,
					tags: ['autodocs'],
					parameters: {
						docs: {
							page: () =>
				...
				Default = (props, { loaded: { controller } }) =>
					(0, emotion_react_jsx_runtime_browser_esm.Y)(RecommendationBundleVertical.a, { ...props, controller, results: controller.store.results });
			(Default.loaders = [
				async () => (
		...
		'./components/src/components/Templates/RecommendationBundleVertical/RecommendationBundleVertical.tsx': (
			...
			const CSS_RecommendationBundleVertical = ({}) =>
				...
				RecommendationBundleVertical = (0, mobx_react__WEBPACK_IMPORTED_MODULE_1__.PA)((properties) => {
					...
					return (
						styleScript && !disableStyles
							...
							: disableStyles
							? style && (styling.css = [style])
							: (styling.css = [CSS_RecommendationBundleVertical(stylingProps), style]),
						(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Y)(_RecommendationBundle__WEBPACK_IMPORTED_MODULE_6__.g, {
							...styling,
							...subProps_recommendationBundle,
							...additionalProps,
						})
