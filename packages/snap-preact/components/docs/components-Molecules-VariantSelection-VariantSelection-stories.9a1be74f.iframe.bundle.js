	...
	[2271],
	{
		'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx': (
			...
			const VariantSelection_stories = {
				...
				ObservableSelection = (0, mobxreact_esm.PA)(({ args }) => (0, emotion_react_jsx_runtime_browser_esm.Y)(VariantSelection.m, { ...args })),
				...
				Dropdown = (props, { loaded: { controller } }) => {
					const selection = controller.store.results[0].variants?.selections[0];
					return (0, emotion_react_jsx_runtime_browser_esm.Y)(VariantSelection.m, { ...props, selection });
				};
			(Dropdown.loaders = [
				async () => (
										...
										children: options.map((option) => {
											...
											return (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.FD)('li', {
												className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(
													`ss__list__option ss__list__option--${_searchspring_snap_toolbox__WEBPACK_IMPORTED_MODULE_11__.p(
