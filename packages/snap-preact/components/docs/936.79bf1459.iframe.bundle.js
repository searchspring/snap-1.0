(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
	[936],
	{
		'../../node_modules/@storybook/blocks/dist/Color-6VNJS4EI.mjs': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			'use strict';
			...
			var R,
				...
				dist = __webpack_require__('../../node_modules/@storybook/blocks/node_modules/@storybook/theming/dist/index.mjs'),
				components_dist = __webpack_require__('../../node_modules/@storybook/blocks/node_modules/@storybook/components/dist/index.mjs'),
				Wrapper = dist.I4.div({ position: 'relative', maxWidth: 250 }),
				PickerTooltip = (0, dist.I4)(components_dist.kR)({ position: 'absolute', zIndex: 1, top: 4, left: 4 }),
				...
				Note = (0, dist.I4)(components_dist._)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })),
				Swatches = dist.I4.div({ display: 'grid', gridTemplateColumns: 'repeat(9, 16px)', gap: 6, padding: 3, marginTop: 5, width: 200 }),
				...
				Swatch = ({ value, active, onClick, style, ...props }) => {
					...
					return compat_module.default.createElement(SwatchColor, { ...props, active, onClick, style: { ...style, backgroundImage } });
				},
				...
				useColorInput = (initialValue, onChange) => {
					let [value, setValue] = (0, compat_module.useState)(initialValue || ''),
						[color, setColor] = (0, compat_module.useState)(() => parseValue(value)),
						[colorSpace, setColorSpace] = (0, compat_module.useState)(color?.colorSpace || 'hex');
					(0, compat_module.useEffect)(() => {
						let nextValue = initialValue || '',
							nextColor = parseValue(nextValue);
						setValue(nextValue), setColor(nextColor), setColorSpace(nextColor?.colorSpace || 'hex');
					}, [initialValue]);
					let realValue = (0, compat_module.useMemo)(
							() =>
				...
				ColorControl = ({ name, value: initialValue, onChange, onFocus, onBlur, presetColors, startOpen = !1 }) => {
					let throttledOnChange = (0, compat_module.useCallback)(throttle_default()(onChange, 200), [onChange]),
						{ value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, throttledOnChange),
						{ presets, addPreset } = ((presetColors, currentColor, colorSpace) => {
							let [selectedColors, setSelectedColors] = (0, compat_module.useState)(currentColor?.valid ? [currentColor] : []);
							(0, compat_module.useEffect)(() => {
								void 0 === currentColor && setSelectedColors([]);
							}, [currentColor]);
							let presets = (0, compat_module.useMemo)(
									() =>
										(presetColors || [])
											.map((preset) =>
								...
								addPreset = (0, compat_module.useCallback)(
									(color) => {
										color?.valid &&
											(presets.some((preset) => id(preset[colorSpace]) === id(color[colorSpace])) || setSelectedColors((arr) => arr.concat(color)));
									},
									[colorSpace, presets]
								);
