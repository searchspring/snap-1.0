		...
		'./components/src/components/Templates/RecommendationBundle/RecommendationBundle.tsx': (
			...
			const BundledCTA = (0, mobxreact_esm.PA)((properties) => {
				...
				const subProps_icon = {
					...
					subProps_subtotalStrike = { ...globalTheme?.components?.icon, theme: props?.theme, treePath },
					subProps_subtotalPrice = { ...globalTheme?.components?.icon, theme: props?.theme, treePath },
