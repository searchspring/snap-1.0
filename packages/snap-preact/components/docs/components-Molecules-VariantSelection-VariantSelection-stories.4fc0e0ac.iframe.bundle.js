(() => {
	(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
		[2271],
		{
			'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx'(D, v, e) {
				'use strict';
				e.r(v), e.d(v, { Dropdown: () => d, List: () => P, Swatches: () => g, __namedExportsOrder: () => U, default: () => z });
				...
				const z = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(b.oz, { options: { overrides: { code: s.Z } }, children: o }), (0, t.Y)(b.uY, { story: b.h1 })],
									}),
							},
						},
            ...
            rgba(255, 0, 0, 1) 100%
				...
				(d.loaders = [
					async () => (
						y.on('afterSearch', async ({ response: r }, V) => {
							r.results?.length &&
  ...
  return <VariantSelection {...props} />;
			...
			'./components/src/components/Molecules/List/List.tsx'(D, v, e) {
				'use strict';
				e.d(v, { B: () => F });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				function F(l) {
					...
					let O = i.selected;
					const Y = {
							checkbox: { native: N, ...(0, q.s)({ disableStyles: X }), theme: i?.theme, treePath: M },
							icon: { internalClassName: 'ss__list__option__icon', size: '16px', ...(0, q.s)({ disableStyles: X }), theme: i?.theme, treePath: M },
						},
						$ = (0, y.Z)(i, Z);
					...
					const te = (p, E) => {
							let f;
							G
								? W.find((k) => k.value === E.value)
									? ((f = [...W]),
									  f.splice(
											f.findIndex((k) => k.value === E.value),
											1
									  ),
									  f.length == 0 && B && (f = [E]))
									: (f = [...W, E])
								: !B && W.find((k) => k.value === E.value)
								? (f = [])
								: (f = [E]),
								K && K(p, E, f),
								H(f);
						...
						se = {},
						Q = m()(se, i.lang || {}),
						ae = (0, r.u)(Q, { options: I, selectedOptions: W });
					return typeof I == 'object' && I?.length
						? (0, t.Y)(x._, {
								children: (0, t.FD)('div', {
									...$,
									className: n()('ss__list', { 'ss__list--native': N, 'ss__list--disabled': C }, L, S),
									children: [
										(c || Q?.title?.value) && !w && (0, t.Y)('h5', { className: 'ss__list__title', ...ae.title?.all, children: c }),
										(0, t.Y)('ul', {
											className: 'ss__list__options',
											role: 'listbox',
											'aria-label': c,
											children: I.map((p) => {
												const E = W.some((f) => f.value == p.value);
												return (0, t.FD)('li', {
													className: n()(`ss__list__option ss__list__option--${z.p(p.value?.toString())}`, {
														'ss__list__option--selected': E,
														'ss__list__option--disabled': p?.disabled,
														'ss__list__option--unavailable': p?.available === !1,
													}),
													ref: (f) => (0, U.iy)(f),
													onClick: (f) => !C && !p?.disabled && te(f, p),
													title: p.label,
													role: 'option',
													'aria-selected': E,
													'aria-disabled': p.disabled || p?.available === !1,
													children: [
														!j && (0, t.Y)(d.S, { ...Y.checkbox, checked: E, disableA11y: !0, 'aria-label': p.label }),
														p.icon && !R && (0, t.Y)(V.I, { ...Y.icon, ...(typeof p.icon == 'string' ? { icon: p.icon } : p.icon) }),
														!J && (p.label || !p.icon) && (0, t.Y)('label', { className: 'ss__list__option__label', children: p.label || p.value }),
													],
												});
											}),
										}),
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.tsx'(D, v, e) {
				'use strict';
				e.d(v, { m: () => F });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					_ = e('../../node_modules/preact/dist/preact.module.js'),
					...
					U = e('./components/src/hooks/useA11y.tsx'),
					r = e('../../node_modules/@searchspring/snap-toolbox/dist/esm/fieldNameToComponentName/fieldNameToComponentName.js');
				const V = () =>
						(0, a.AH)({
					...
					F = (0, b.PA)((l) => {
						const u = (0, m.u)(),
							h = (0, z.LU)(),
							T = { name: (0, r.P)(l.selection.field), treePath: h },
							i = (0, P.v6)('variantSelection', u, T, l),
							{ selection: c, onSelect: K, disableStyles: N, className: G, internalClassName: J, treePath: R } = i;
						let j = i.type;
						j || (c.type == 'swatch' ? (j = 'swatches') : (j = 'dropdown'));
						const C = (L, S) => {
								K && K(L, S), c.select(S.value);
							},
							w = {
								dropdown: {
									internalClassName: 'ss__variant-selection__dropdown',
									usePortal: !0,
									...(0, x.s)({ disableStyles: N }),
									theme: i?.theme,
									treePath: R,
								},
								icon: {
							...
							B = (0, g.Z)(i, Z),
							X = (L) => {
								const { toggleOpen: S } = L;
								return (0, t.Y)('ul', {
									...B,
									className: 'ss__variant-selection__options',
									ref: (M) => (0, U.iy)(M, -1, !0, () => S()),
									children: c.values.map((M) => {
										const O = c.selected?.value == M.value;
										return (0, t.Y)('li', {
											className: n()('ss__variant-selection__option', {
												'ss__variant-selection__option--selected': O,
												'ss__variant-selection__option--disabled': M.disabled,
												'ss__variant-selection__option--unavailable': M.available === !1,
											}),
											onClick: (Y) => !M.disabled && C(Y, M),
											ref: (Y) => (0, U.iy)(Y),
											'aria-selected': O,
						...
						return c.values.length
							? (0, t.Y)(o._, {
									children: (0, t.Y)('div', {
										...I,
										className: n()('ss__variant-selection', `ss__variant-selection--${j}`, `ss__variant-selection--${c.field}`, G, J),
										children: (() => {
											switch (j) {
												case 'dropdown':
													return (0, t.Y)(_.FK, {
																...
																return (0, t.FD)(_.FK, {
																	children: [
																		(0, t.FD)('div', {
																			...
																			children: [
																				(0, t.Y)('span', { className: 'ss__dropdown__button-wrapper__label', children: c.label }),
																				c.selected
																					? (0, t.FD)('span', {
																		...
																		(0, t.Y)(d.I, { icon: M ? 'angle-up' : 'angle-down', ...w.icon, treePath: S.treePath }),
																	],
																});
															};
															return (0, t.Y)(y.m, { button: (0, t.Y)(L, { treePath: R }), ...w.dropdown, content: (0, t.Y)(X, {}) });
														})(),
													});
												case 'list':
													return (0, t.Y)(_.FK, { children: (0, t.Y)(q.B, { ...w.list, options: c.values }) });
												case 'swatches':
													return (0, t.Y)(_.FK, { children: (0, t.Y)(A.l, { ...w.swatches, options: c.values }) });
											}
										})(),
									}),
							  })
			...
			'./components/src/utilities/componentArgs.ts'(D, v, e) {
				'use strict';
				e.d(v, { F: () => t });
				const t = {
					className: {
			...
			'./components/src/utilities/snapify.ts'(D, v, e) {
				'use strict';
				e.d(v, { p: () => r });
				var t = e('../../node_modules/mobx/dist/mobx.esm.js'),
					_ = e('../../node_modules/@searchspring/snap-controller/dist/esm/Search/SearchController.js'),
					b = e('../../node_modules/@searchspring/snap-controller/dist/esm/Autocomplete/AutocompleteController.js'),
					a = e('../../node_modules/@searchspring/snap-controller/dist/esm/Recommendation/RecommendationController.js'),
					s = e('../../node_modules/@searchspring/snap-client/dist/esm/Client/Client.js'),
					n = e('../../node_modules/@searchspring/snap-store-mobx/dist/esm/Autocomplete/AutocompleteStore.js'),
					...
					z = e('../../node_modules/@searchspring/snap-url-manager/dist/esm/UrlManager/UrlManager.js'),
					...
					q = e('../../node_modules/@searchspring/snap-profiler/dist/esm/Profiler.js'),
				...
				const d = {},
					U = { globals: { siteId: '8uyt2m' } };
				class r {
					static recommendation(u) {
						const h = u.id;
						if (d[h]) return d[h];
						const T = (d[h] = Z({ client: U, controller: u }));
						return (
							T.on('afterStore', async ({ controller: i }, c) => {
					...
					static autocomplete(u) {
						const h = u.id;
						if (d[h]) return d[h];
						const T = (d[h] = F({ client: U, controller: u }));
						return (
							T.on('afterStore', async ({ controller: i }, c) => {
								i.log.debug('controller', i), i.log.debug('store', i.store.toJSON()), await c();
							}),
					...
					static search(u) {
						const h = u.id;
						if (d[h]) return d[h];
						const T = (d[h] = V({ client: U, controller: u }));
						return (
							T.on('afterStore', async ({ controller: i }, c) => {
								i.log.debug('controller', i), i.log.debug('store', i.store.toJSON()), await c();
							}),
				...
				function V(l) {
					const u = new z.V(new P.E({ settings: { coreType: 'query', corePrefix: l.controller.id } }), x.X);
				...
				function Z(l) {
					const u = new z.V(new P.E(), x.X).detach(!0);
					return new a.c(l.controller, {
						client: new s.K(l.client.globals, l.client.config),
						store: new m.t(l.controller, { urlManager: u }),
						urlManager: u,
						eventManager: new g.E(),
						profiler: new q.U(),
						logger: new A.V(),
				...
				function F(l) {
					const u = new z.V(new P.E(), x.X).detach();
					return new b.Z(l.controller, {
						client: new s.K(l.client.globals, l.client.config),
						store: new n.Y(l.controller, { urlManager: u }),
						urlManager: u,
						eventManager: new g.E(),
						profiler: new q.U(),
						logger: new A.V(),
			...
			'./components/src/utilities/storybook.tsx'(D, v, e) {
				'use strict';
				e.d(v, { Z: () => a });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const b = 'prism-block',
					a = (s) => {
						...
						return (
							(0, _.vJ)(() => {
								n.current && s.className?.includes('lang-') && !s.className?.includes(b) && window?.Prism?.highlightElement(n.current);
							}, [s.className, s.children, n]),
							(0, t.Y)('code', { ...s, ref: n, 'data-prismjs-copy': 'Copy' })
						);
					};
			},
			'../../node_modules/dequal/dist/index.mjs'(D, v, e) {
				'use strict';
				e.d(v, { j: () => b });
				var t = Object.prototype.hasOwnProperty;
				function _(a, s, n) {
					for (n of a.keys()) if (b(n, s)) return n;
				}
				function b(a, s) {
					var n, o, m;
					if (a === s) return !0;
					if (a && s && (n = a.constructor) === s.constructor) {
						...
						if (n === Array) {
							if ((o = a.length) === s.length) for (; o-- && b(a[o], s[o]); );
							return o === -1;
						}
						if (n === Set) {
							if (a.size !== s.size) return !1;
							for (o of a) if (((m = o), (m && typeof m == 'object' && ((m = _(s, m)), !m)) || !s.has(m))) return !1;
							return !0;
						}
						if (n === Map) {
							if (a.size !== s.size) return !1;
							for (o of a) if (((m = o[0]), (m && typeof m == 'object' && ((m = _(s, m)), !m)) || !b(o[1], s.get(m)))) return !1;
							return !0;
						}
						...
						if (!n || typeof a == 'object') {
							o = 0;
							for (n in a) if ((t.call(a, n) && ++o && !t.call(s, n)) || !(n in s) || !b(a[n], s[n])) return !1;
			...
			'../../node_modules/memoizerific sync recursive'(D) {
				...
				(v.keys = () => []), (v.resolve = v), (v.id = '../../node_modules/memoizerific sync recursive'), (D.exports = v);
			},
		},
	]);
})();

//# sourceMappingURL=components-Molecules-VariantSelection-VariantSelection-stories.4fc0e0ac.iframe.bundle.js.map
