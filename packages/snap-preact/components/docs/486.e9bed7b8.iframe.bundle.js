	...
	[486],
	{
		...
		'./components/src/components/Molecules/Select/Select.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
				...
				_hooks_useA11y__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__('./components/src/hooks/useA11y.tsx'),
				_hooks__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__('./components/src/hooks/useLang.tsx'),
			...
			const defaultStyles = ({ color, backgroundColor, borderColor, theme, native }) => {
					const lightenedPrimary = new (color__WEBPACK_IMPORTED_MODULE_4___default())(
						backgroundColor || color || theme?.variables?.colors?.primary
					).lightness(95);
					return native
				...
				Select = (0, mobx_react__WEBPACK_IMPORTED_MODULE_6__.PA)((properties) => {
					const globalTheme = (0, _providers__WEBPACK_IMPORTED_MODULE_7__.u)(),
						props = (0, _utilities__WEBPACK_IMPORTED_MODULE_8__.v6)(
							'select',
							globalTheme,
					...
					const subProps_dropdown = {
							...
							...(0, _utilities__WEBPACK_IMPORTED_MODULE_9__.s)({ disableStyles, disabled }),
							theme: props?.theme,
							treePath,
						},
						subProps_button = {
							...
							...(0, _utilities__WEBPACK_IMPORTED_MODULE_9__.s)({ disableStyles, disabled, color, backgroundColor, borderColor }),
							theme: props?.theme,
							treePath,
						},
						subProps_icon = {
							...
							...globalTheme?.components?.icon,
							...(0, _utilities__WEBPACK_IMPORTED_MODULE_9__.s)({ disableStyles, color: iconColor || color, size: '12px' }),
							theme: props?.theme,
							treePath,
						},
					...
					const makeSelection = (e, option) => {
						...
						mergedLang = (0, _hooks__WEBPACK_IMPORTED_MODULE_11__.u)(lang, { options, selectedOptions, label, open });
					return 'object' == typeof options && options?.length
						? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)(_providers__WEBPACK_IMPORTED_MODULE_13__._, {
								children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('div', {
									...
									children: native
										? (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FD)(_emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FK, {
												children: [
													(label || lang.buttonLabel.value) &&
														...
														(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FD)('span', {
															...
															children: [
																(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('label', { ...mergedLang.buttonLabel?.all }),
																separator &&
													...
													(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FD)('select', {
														...
														children: [
															!selection &&
																clearSelection &&
																(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('option', {
										...
										: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)(_Atoms_Dropdown__WEBPACK_IMPORTED_MODULE_14__.m, {
												...
												disableA11y: !0,
												button: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FD)(_Atoms_Button__WEBPACK_IMPORTED_MODULE_15__.$, {
													...subProps_button,
													children: [
														(label || lang.buttonLabel.value) &&
															!hideLabelOnSelection &&
															...
															(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FD)('span', {
																...
																children: [
																	(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('label', { ...mergedLang.buttonLabel.value }),
																	separator &&
																		selection &&
																		(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('span', {
																			className: 'ss__select__label__separator',
												...
												children: (0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('ul', {
													className: 'ss__select__select',
													role: 'listbox',
													'aria-label': 'string' == typeof label ? label : '',
													ref: (e) => (0, _hooks_useA11y__WEBPACK_IMPORTED_MODULE_17__.i)(e, -1, !0, () => setOpen(!1)),
													children: options.map((option) =>
														(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.FD)('li', {
															ref: (e) => (0, _hooks_useA11y__WEBPACK_IMPORTED_MODULE_17__.i)(e),
															...
															children: [
																...
																!hideOptionLabels &&
																	(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Y)('span', { children: option.label }),
															],
														})
													),
												}),
