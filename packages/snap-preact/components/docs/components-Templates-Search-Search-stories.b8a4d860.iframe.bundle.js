	...
	[8907],
	{
		...
		'./components/src/components/Templates/Search/Search.stories.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
				...
				_readme_md__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__('./components/src/components/Templates/Search/readme.md'),
				_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__('./components/src/components/Templates/Search/Search.tsx');
			const __WEBPACK_DEFAULT_EXPORT__ = {
					title: 'Templates/Search',
					component: _Search__WEBPACK_IMPORTED_MODULE_0__.v,
					tags: ['autodocs'],
					parameters: {
						docs: {
							page: () =>
								(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.FD)('div', {
									children: [
										(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Y)(_storybook_blocks__WEBPACK_IMPORTED_MODULE_2__.oz, {
											...
											children: _readme_md__WEBPACK_IMPORTED_MODULE_4__,
										}),
				...
				snapInstance = _utilities_snapify__WEBPACK_IMPORTED_MODULE_6__.p.search({ id: 'Search', globals: { siteId: 'atkzs2' } }),
				noresultsInstance = _utilities_snapify__WEBPACK_IMPORTED_MODULE_6__.p.search({
					id: 'Search-noResults',
					globals: { siteId: 'atkzs2', search: { query: { string: 'eijworhufsbgd' } } },
				}),
				Default = (args, { loaded: { controller } }) =>
					(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Y)(_Search__WEBPACK_IMPORTED_MODULE_0__.v, { ...args, controller });
