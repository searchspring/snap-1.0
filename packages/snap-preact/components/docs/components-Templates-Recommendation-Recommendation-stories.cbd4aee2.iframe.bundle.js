	...
	[1921],
	{
		'./components/src/components/Templates/Recommendation/Recommendation.stories.tsx': (
			...
			const CSS_recommendation = ({ vertical }) =>
				...
				Recommendation = (0, mobxreact_esm.PA)((properties) => {
					const globalTheme = (0, emotion_element_5486c51c_browser_esm.u)(),
						defaultProps = {
							breakpoints: properties.vertical ? JSON.parse(JSON.stringify(Carousel.og)) : JSON.parse(JSON.stringify(Carousel.K)),
							pagination: !1,
							loop: !0,
						};
					let displaySettings,
						props = (0, mergeProps.v6)('recommendation', globalTheme, defaultProps, properties);
					...
					const subProps_carousel = {
							...
							...(0, defined.s)({ disableStyles, vertical }),
							theme: props?.theme,
							treePath,
						},
					...
					const [isVisible, setIsVisible] = (0, hooks_module.J0)(!1),
																		...
																		(0, emotion_react_jsx_runtime_browser_esm.Y)(RecommendationResultTracker.x, {
																			...
																			children: (() => {
																				if (resultComponent && controller) {
																					...
																					return (0, emotion_react_jsx_runtime_browser_esm.Y)(ResultComponent, { controller, result });
																				}
																				return (0, emotion_react_jsx_runtime_browser_esm.Y)(
																					Result.Q,
			...
			const Recommendation_stories = {
				...
				Default = (props, { loaded: { controller } }) => (0, emotion_react_jsx_runtime_browser_esm.Y)(Recommendation, { ...props, controller });
			(Default.loaders = [
				async () => (
