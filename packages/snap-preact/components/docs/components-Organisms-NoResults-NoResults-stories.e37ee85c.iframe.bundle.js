				...
				const Y = ({}) => (0, n.AH)({}),
					k = (0, i.PA)((w) => {
						...
						const tt = (0, g.Z)(f, Y),
							...
							M = y && Array.isArray(y) && y.length !== 0;
						let N, j, p;
						if (b?.recommendation?.enabled) {
							...
							if (_?.templates) {
								...
								(v.id = v.id || `search-${v.tag}`),
									...
									A && _?.templates?.library.import.component.result && (j = (0, E.x)(_?.templates?.library.import.component.result, A)),
									c &&
										_?.templates?.library.import.component.recommendation.default &&
										(N = (0, E.x)(_?.templates?.library.import.component.recommendation.default, c));
							}
						}
						const S = N,
							et = j,
...
//# sourceMappingURL=components-Organisms-NoResults-NoResults-stories.e37ee85c.iframe.bundle.js.map
