			...
			const defaultStyles = ({}) =>
				...
				LayoutSelector = (0, mobx_react_lite__WEBPACK_IMPORTED_MODULE_1__.PA)((properties) => {
					const globalTheme = (0, _providers__WEBPACK_IMPORTED_MODULE_5__.u)(),
						...
						{ options, selected, type, onSelect, showSingleOption, hideLabel, hideOptionLabels, disableStyles, className, treePath } = props;
					...
					if ((hideLabel && (delete lang.label.value, (label = void 0)), hideOptionLabels)) {
						...
						optionsWithNoIcons && console.warn('Warning - found layout options with no visible label or icon', optionsWithNoIcons);
					}
