	...
	[3524],
	{
			...
			const CSS_LayoutSelector = ({}) =>
				...
				LayoutSelector = (0, mobx_react_lite__WEBPACK_IMPORTED_MODULE_1__.PA)((properties) => {
					const globalTheme = (0, _providers__WEBPACK_IMPORTED_MODULE_5__.u)(),
						...
						{ options, selected, type, onSelect, showSingleOption, hideLabel, disableStyles, className, style, styleScript, treePath } = props;
		...
		'./components/src/components/Molecules/LoadMore/LoadMore.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
				...
				_hooks__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__('./components/src/hooks/useIntersection.tsx'),
				...
				_hooks__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__('./components/src/hooks/useFuncDebounce.tsx'),
			...
			const CSS_LoadMore = ({
				...
				LoadMore = (0, mobx_react_lite__WEBPACK_IMPORTED_MODULE_3__.PA)((properties) => {
					...
					if (autoFetch) {
						...
						const loadMoreInViewport = (0, _hooks__WEBPACK_IMPORTED_MODULE_10__.v)(loadMoreRef, intersectionOffset || '0px'),
							[preventLoading, setPreventLoading] = (0, preact_hooks__WEBPACK_IMPORTED_MODULE_1__.J0)(!0);
						isLoading
							? setPreventLoading(!0)
							: (0, _hooks__WEBPACK_IMPORTED_MODULE_11__.d)(() => {
									setPreventLoading(!1);
							  }, 500),
					...
					const defaultLang = {
						...
						mergedLang = (0, _hooks__WEBPACK_IMPORTED_MODULE_12__.u)(lang, { paginationStore: store });
									...
									children: [
										!autoFetch &&
											(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.FD)(preact__WEBPACK_IMPORTED_MODULE_0__.FK, {
												children: [
													(0, _emotion_react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.FD)(_Atoms_Button__WEBPACK_IMPORTED_MODULE_14__.$, {
														onClick: (e) => {
