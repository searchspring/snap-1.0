		...
		[8422],
		{
			...
			'./components/src/components/Atoms/FormattedNumber/FormattedNumber.tsx'(p, s, e) {
				...
				function P(v) {
					...
					const h = r.Z(D, { symbol: F, decimalPlaces: T, padDecimalPlaces: O, thousandsSeparator: A, decimalSeparator: C, symbolAfter: M }),
						U = (0, b.Z)(y, g);
					return j
						? (0, o.Y)(o.FK, { children: h })
						: (0, o.Y)(a._, { children: (0, o.Y)('span', { className: t()('ss__formatted-number', L, S), ...U, children: h }) });
				}
			},
