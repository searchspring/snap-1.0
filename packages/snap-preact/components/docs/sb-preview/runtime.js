...
var __require = ((x2) =>
	typeof require < 'u' ? require : typeof Proxy < 'u' ? new Proxy(x2, { get: (a, b2) => (typeof require < 'u' ? require : a)[b2] }) : x2)(function (
	x2
) {
	...
	'../../node_modules/object-inspect/index.js'(exports, module) {
		...
		module.exports = function inspect_(obj, options2, depth, seen) {
			...
			if (
				...
				(typeof opts.maxStringLength == 'number' ? opts.maxStringLength < 0 && opts.maxStringLength !== 1 / 0 : opts.maxStringLength !== null)
			)
			...
			if (!isDate(obj) && !isRegExp(obj)) {
				var ys = arrObjKeys(obj, inspect),
					...
					stringTag =
						!isPlainObject3 && toStringTag && Object(obj) === obj && toStringTag in obj ? $slice.call(toStr(obj), 8, -1) : protoTag ? 'Object' : '',
					constructorTag = isPlainObject3 || typeof obj.constructor != 'function' ? '' : obj.constructor.name ? obj.constructor.name + ' ' : '',
					tag = constructorTag + (stringTag || protoTag ? '[' + $join.call($concat.call([], stringTag || [], protoTag || []), ': ') + '] ' : '');
			...
			merge = function merge2(target, source2, options2) {
				...
				if (typeof source2 != 'object') {
					if (isArray2(target)) target.push(source2);
						...
						((options2 && (options2.plainObjects || options2.allowPrototypes)) || !has2.call(Object.prototype, source2)) && (target[source2] = !0);
...
var require_stringify = __commonJS({
	'../../node_modules/qs/lib/stringify.js'(exports, module) {
		...
		var getSideChannel = require_side_channel(),
			...
			stringify2 = function stringify3(
				...
				if (
					...
					if (strictNullHandling) return encoder && !encodeValuesOnly ? encoder(prefix2, defaults.encoder, charset, 'key', format) : prefix2;
					obj = '';
				}
				...
				for (var adjustedPrefix = commaRoundTrip && isArray2(obj) && obj.length === 1 ? prefix2 + '[]' : prefix2, j = 0; j < objKeys.length; ++j) {
					var key2 = objKeys[j],
		...
		module.exports = function (object, opts) {
			...
			return (
				options2.charsetSentinel && (options2.charset === 'iso-8859-1' ? (prefix2 += 'utf8=%26%2310003%3B&') : (prefix2 += 'utf8=%E2%9C%93&')),
			...
			parseKeys = function (givenKey, val, options2, valuesParsed) {
				if (givenKey) {
					...
					for (var i = 0; options2.depth > 0 && (segment = child.exec(key2)) !== null && i < options2.depth; ) {
						if (((i += 1), !options2.plainObjects && has2.call(Object.prototype, segment[1].slice(1, -1)) && !options2.allowPrototypes)) return;
						keys.push(segment[1]);
					}
...
var require_arraySome = __commonJS({
	'../../node_modules/lodash/_arraySome.js'(exports, module) {
		...
		function arraySome(array, predicate) {
			for (var index = -1, length = array == null ? 0 : array.length; ++index < length; ) if (predicate(array[index], index, array)) return !0;
			return !1;
		}
	...
	'../../node_modules/lodash/_overRest.js'(exports, module) {
		...
		function overRest(func, start2, transform) {
			return (
				...
				function () {
					for (var args2 = arguments, index = -1, length = nativeMax(args2.length - start2, 0), array = Array(length); ++index < length; )
	...
	'../../node_modules/synchronous-promise/index.js'(exports, module) {
		...
		SynchronousPromise4.prototype = {
			...
			resume: function () {
				...
				return firstPaused && ((firstPaused._paused = !1), firstPaused._runResolutions(), firstPaused._runRejections()), this;
			},
			...
			_handleUserFunctionResult: function (data, nextSynchronousPromise) {
				looksLikeAPromise(data) ? this._chainPromiseData(data, nextSynchronousPromise) : nextSynchronousPromise.resolve(data);
			},
		...
		if (Promise === SynchronousPromise4) throw new Error('Please use SynchronousPromise.installGlobally() to install globally');
						...
						(l = [
							{
								...
								value: function (e2) {
									var t3,
										...
										b2 = i();
									p === 'chrome' &&
										typeof (b2 == null || (t3 = b2.brave) === null || t3 === void 0 ? void 0 : t3.isBrave) == 'function' &&
										(p = 'brave'),
										p && (s2[p] = !0),
										w2 && (s2[w2] = !0);
...
function extractEventHiddenProperties(event) {
	let rebuildEvent = eventProperties.filter((value2) => event[value2] !== void 0).reduce((acc, value2) => ({ ...acc, [value2]: event[value2] }), {});
	return (
	...
	reviver2 = function reviver(options) {
		...
		return function revive(key, value) {
			...
			if (typeof value == 'string' && value.startsWith('_function_') && options.allowFunction) {
				...
				return (
					Object.defineProperty(result, 'toString', { value: () => sourceSanitized }), Object.defineProperty(result, 'name', { value: name }), result
				);
			}
			...
			isObject3(value2) &&
				...
				Array.isArray(value2) &&
					value2.forEach((v2, index) => {
						v2 === '_undefined_' ? (mutated.set(v2, !0), (value2[index] = void 0)) : mutated.get(v2) || (mutated.set(v2, !0), mutateUndefined(v2));
					});
		};
	},
	parse = (data, options2 = {}) => {
...
var getEventSourceUrl = (event) => {
	...
	PostMessageTransport = class {
		...
		send(event, options2) {
			let { target, allowRegExp, allowFunction, allowSymbol, allowDate, allowError, allowUndefined, allowClass, maxDepth, space, lazyEval } =
					options2 || {},
...
var B = Object.create,
	...
	E = (r, e, n, t) => {
		if ((e && typeof e == 'object') || typeof e == 'function')
			for (let a of C(e)) !w.call(r, a) && a !== n && R(r, a, { get: () => e[a], enumerable: !(t = b(e, a)) || t.enumerable });
		return r;
	},
	v = (r, e, n) => ((n = r != null ? B(h(r)) : {}), E(e || !r || !r.__esModule ? R(n, 'default', { value: r, enumerable: !0 }) : n, r)),
	x = I((T) => {
...
var getImportPathMap = (0, import_memoizerific2.default)(1)((entries) =>
	...
	combineArgs = (value2, update) =>
		Array.isArray(value2) && Array.isArray(update)
			? update.reduce((acc, upd, index) => ((acc[index] = combineArgs(value2[index], update[index])), acc), [...value2]).filter((v2) => v2 !== void 0)
...
function prepareContext(context) {
	...
	let mappedArgs = Object.entries(targetedContext.args).reduce((acc, [key2, val]) => {
			...
			let mappingFn = (originalValue) =>
				originalValue in targetedContext.argTypes[key2].mapping ? targetedContext.argTypes[key2].mapping[originalValue] : originalValue;
...
var inferType = (value2, name2, visited) => {
      ...
      `),
				...
				: (visited.add(value2),
				  Array.isArray(value2)
						? { name: 'array', value: value2.length > 0 ? inferType(value2[0], name2, new Set(visited)) : { name: 'other', value: 'unknown' } }
	...
	inferArgTypes = (context) => {
		let { id, argTypes: userArgTypes = {}, initialArgs = {} } = context,
			argTypes = (0, import_mapValues.default)(initialArgs, (arg, key2) => ({ name: key2, type: inferType(arg, `${id}.${key2}`, new Set()) })),
...
var matches = (name2, descriptor) => (Array.isArray(descriptor) ? descriptor.includes(name2) : name2.match(descriptor)),
	...
	inferControls = (context) => {
		...
		let filteredArgTypes = filterArgTypes(argTypes, include, exclude),
			withControls = (0, import_mapValues.default)(filteredArgTypes, (argType, name2) => argType?.type && inferControl(argType, name2, matchers));
...
function composeStory(
	...
	let normalizedComponentAnnotations = normalizeComponentAnnotations(componentAnnotations),
		storyName = exportsName || storyAnnotations.storyName || storyAnnotations.story?.name || storyAnnotations.name || 'unknown',
	...
	return Object.assign(
		(extraArgs) => {
			let context = { ...story, hooks: new HooksContext(), globals: defaultGlobals, args: { ...story.initialArgs, ...extraArgs } };
...
function composeStories(storiesImport, globalConfig, composeStoryFn) {
	...
	return Object.entries(stories).reduce(
		(storiesMap, [exportsName, story]) =>
			G(exportsName, meta) ? Object.assign(storiesMap, { [exportsName]: composeStoryFn(story, meta, globalConfig, exportsName) }) : storiesMap,
		{}
	);
}
var CSF_CACHE_SIZE = 1e3,
	...
	StoryStore = class {
		...
		loadAllCSFFiles({ batchSize = EXTRACT_BATCH_SIZE } = {}) {
			...
			let importPaths = Object.entries(this.storyIndex.entries).map(([storyId, { importPath }]) => [importPath, storyId]),
				loadInBatches = (remainingImportPaths) => {
					...
					let csfFilePromiseList = remainingImportPaths
						.slice(0, batchSize)
						.map(([importPath, storyId]) => this.loadCSFFileByStoryId(storyId).then((csfFile) => ({ importPath, csfFile })));
				...
				entries: Object.fromEntries(
					Object.entries(this.storyIndex.entries).map(([id, entry]) => [
						...
						stories[id]
							...
							: { ...entry, parameters: this.preparedMetaFromCSFFile({ csfFile: cachedCSFFiles[entry.importPath] }).parameters },
					])
				),
			};
		}
...
function useSharedState(sharedId, defaultState) {
	let channel = addons.getChannel(),
		[lastValue] = channel.last(`${SHARED_STATE_CHANGED}-manager-${sharedId}`) || channel.last(`${SHARED_STATE_SET}-manager-${sharedId}`) || [],
...
var import_synchronous_promise2 = __toESM(require_synchronous_promise(), 1),
	...
	StoryStoreFacade = class {
		constructor() {
			(this.projectAnnotations = { loaders: [], decorators: [], parameters: {}, argsEnhancers: [], argTypesEnhancers: [], args: {}, argTypes: {} }),
				(this.entries = {}),
				(this.csfExports = {});
		}
		importFn(path) {
        ...
        legacy (6.x) MDX API, or use the new store.`);
			...
			let { default: defaultExport, __namedExportsOrder, ...namedExports } = fileExports,
				...
				specifiers = (scope.STORIES || []).map((specifier) => ({ ...specifier, importPathMatcher: new RegExp(specifier.importPathMatcher) }));
			...
			storyExports.forEach(([key2, storyExport]) => {
				let exportName = M(key2),
					...
					name2 = (typeof storyExport != 'function' && storyExport.name) || storyExport.storyName || storyExport.story?.name || exportName;
	...
	checkMethod = (method) => {
      ...
      ${warningAlternatives[method]}`);
		if (!scope.__STORYBOOK_CLIENT_API__) throw new Error(`Singleton client API not yet initialized, cannot call \`${method}\`.`);
	},
	...
	setGlobalRender = (render) => {
		checkMethod('setGlobalRender'), scope.__STORYBOOK_CLIENT_API__ && (scope.__STORYBOOK_CLIENT_API__.facade.projectAnnotations.render = render);
	},
			...
			(this.lastFileName = 0),
				...
				(this.addParameters = ({ globals, globalTypes, ...parameters }) => {
					(this.facade.projectAnnotations.parameters = combineParameters(this.facade.projectAnnotations.parameters, parameters)),
						globals && (this.facade.projectAnnotations.globals = { ...this.facade.projectAnnotations.globals, ...globals }),
						globalTypes &&
							(this.facade.projectAnnotations.globalTypes = { ...this.facade.projectAnnotations.globalTypes, ...normalizeInputTypes(globalTypes) });
				}),
				...
				(this.storiesOf = (kind, m2) => {
					...
					let hasAdded = !1,
						api = { kind: kind.toString(), add: () => api, addDecorator: () => api, addLoader: () => api, addParameters: () => api };
	...
	require_decode2 = __commonJS3({
		'../../node_modules/entities/lib/decode.js'(exports) {
			...
			exports.decodeHTML = (function () {
				for (
					var legacy = Object.keys(legacy_json_1.default).sort(sorter), keys = Object.keys(entities_json_1.default).sort(sorter), i = 0, j = 0;
					i < keys.length;
					i++
				)
		...
		'../../node_modules/entities/lib/encode.js'(exports) {
			...
			function getInverseReplacer(inverse) {
				...
				for (var start2 = 0; start2 < single.length - 1; start2++) {
					for (var end = start2; end < single.length - 1 && single[end].charCodeAt(1) + 1 === single[end + 1].charCodeAt(1); ) end += 1;
	...
	require_ansi_to_html = __commonJS3({
		'../../node_modules/ansi-to-html/lib/ansi_to_html.js'(exports, module) {
			...
			function _createClass(Constructor, protoProps, staticProps) {
				return (
					protoProps && _defineProperties(Constructor.prototype, protoProps), staticProps && _defineProperties(Constructor, staticProps), Constructor
				);
			}
...
var StoryRender = class {
		...
		async runPhase(signal, phase, phaseFn) {
			(this.phase = phase),
				...
				signal.aborted && ((this.phase = 'aborted'), this.channel.emit(STORY_RENDER_PHASE_CHANGED, { newPhase: this.phase, storyId: this.id }));
		}
		async prepare() {
			if (
	...
	Preview = class {
		...
		getProjectAnnotationsOrRenderError(getProjectAnnotations) {
			return import_synchronous_promise3.SynchronousPromise.resolve()
				...
				.then((projectAnnotations) => {
					if (
						(projectAnnotations.renderToDOM && deprecate('`renderToDOM` is deprecated, please rename to `renderToCanvas`'),
		...
		async onUpdateGlobals({ globals }) {
			...
			this.storyStore.globals.update(globals),
				...
				this.channel.emit(GLOBALS_UPDATED, { globals: this.storyStore.globals.get(), initialGlobals: this.storyStore.globals.initialGlobals });
		}
		...
		async onResetArgs({ storyId, argNames }) {
			let story = this.storyRenders.find((r) => r.id === storyId)?.story || (await this.storyStore.loadStory({ storyId })),
				updatedArgs = (argNames || [...new Set([...Object.keys(story.initialArgs), ...Object.keys(this.storyStore.args.get(storyId))])]).reduce(
      ...
      Do you have an error in your \`preview.js\`? Check your Storybook's browser console for errors.`);
			return scope.FEATURES?.storyStoreV7 && (await this.storyStore.cacheAllCSFFiles()), this.storyStore.extract(options2);
		}
...
var PreviewWithSelection = class extends Preview {
		...
		initializeWithStoryIndex(storyIndex) {
			return super
				.initializeWithStoryIndex(storyIndex)
				.then(
					() => (scope.FEATURES?.storyStoreV7 || this.channel.emit(SET_INDEX, this.storyStore.getSetIndexPayload()), this.selectSpecifiedStory())
				);
		}
		...
		async renderSelection({ persistedArgs } = {}) {
			...
			if (
				...
				scope.FEATURES?.storyStoreV7 && this.channel.emit(STORY_PREPARED, { id: storyId, parameters, initialArgs, argTypes, args: unmappedArgs }),
					(implementationChanged || persistedArgs) && this.channel.emit(STORY_ARGS_UPDATED, { storyId, args: unmappedArgs });
...
var getQueryString = ({ selection, extraParams }) => {
	...
	WebView = class {
		constructor() {
			this.testing = !1;
			let { __SPECIAL_TEST_PARAMETER__ } = import_qs3.default.parse(document22.location.search, { ignoreQueryPrefix: !0 });
...
`))),
		...
		showPreparingStory({ immediate = !1 } = {}) {
			clearTimeout(this.preparingTimeout),
				immediate ? this.showMode('PREPARING_STORY') : (this.preparingTimeout = setTimeout(() => this.showMode('PREPARING_STORY'), PREPARING_DELAY));
		}
		showPreparingDocs({ immediate = !1 } = {}) {
			clearTimeout(this.preparingTimeout),
				immediate ? this.showMode('PREPARING_DOCS') : (this.preparingTimeout = setTimeout(() => this.showMode('PREPARING_DOCS'), PREPARING_DELAY));
		}
		showMain() {
			this.showMode('MAIN');
		}
...
function simulatePageLoad($container) {
	...
	$scriptsRoot
		...
		: (($scriptsRoot = document32.createElement('div')), ($scriptsRoot.id = SCRIPTS_ROOT_ID), document32.body.appendChild($scriptsRoot));
			...
			(scope.__STORYBOOK_STORY_STORE__ = preview.storyStore)),
		{
			...
			configure(renderer, loadable, m2, disableBackwardCompatibility = !0) {
				...
				initialized
					...
					: (preview.initialize({ getStoryIndex: () => clientApi.getStoryIndex(), importFn, getProjectAnnotations }), (initialized = !0));
			},
		}
	);
}
...
__export(websocket_exports, { WebsocketTransport: () => WebsocketTransport, createChannel: () => createChannel2, default: () => websocket_default });
