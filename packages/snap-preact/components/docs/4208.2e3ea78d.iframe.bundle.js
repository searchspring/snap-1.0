		...
		'./components/src/components/Templates/RecommendationBundle/RecommendationBundle.tsx': (
			...
			const BundleSelector = (0, es.PA)((properties) => {
				const globalTheme = (0, emotion_element_5486c51c_browser_esm.u)(),
					...
					{ children, checked, icon, seedText, seed, hideCheckboxes, onCheck, title, className, treePath, classNamePrefix } = props,
			...
			const BundledCTA = (0, es.PA)((properties) => {
				...
				const subProps_icon = { name: 'bundle-cart', className: `${classNamePrefix}__wrapper__cta__icon`, size: 50, theme: props?.theme, treePath },
						...
						: (0, emotion_react_jsx_runtime_browser_esm.FD)(preact_module.FK, {
								children: [
									...
									(0, emotion_react_jsx_runtime_browser_esm.Y)(Button.$, {
										...subProps_button,
										className: classnames_default()(`${classNamePrefix}__wrapper__cta__button`, {
			...
			const defaultStyles = ({ vertical, separatorIcon, carousel, ctaInline, alias: inherits }) => {
				...
				RecommendationBundle = (0, es.PA)((properties) => {
					...
					const seed = results ? results[0] : controller.store?.results[0],
						...
						subProps_result = { className: 'ss__recommendation__result', ...(0, defined.s)({ disableStyles }), theme: props?.theme, treePath };
						...
						resultsToRender?.length
							? (0, emotion_react_jsx_runtime_browser_esm.Y)(cache._, {
									children: (0, emotion_react_jsx_runtime_browser_esm.Y)('div', {
										...styling,
										ref: recsRef,
										className: classnames_default()(classNamePrefix, { [`${classNamePrefix}--stacked`]: !ctaInline }, className),
										children: isVisible
																										...
																										return 0 != idx || hideSeed
																											? (0, emotion_react_jsx_runtime_browser_esm.Y)(RecommendationResultTracker.x, {
																													...
																													children: (0, emotion_react_jsx_runtime_browser_esm.Y)(BundleSelector, {
																														...
																														classNamePrefix,
																														className:
																															idx + 1 == resultsToRender.length ? `${classNamePrefix}__wrapper__selector--last` : '',
																														children: resultComponent
																															? (0, cloneWithProps.Y)(resultComponent, {
																																	result,
																																	seed: !1,
																				...
																				return 0 != idx || hideSeed
																					? (0, emotion_react_jsx_runtime_browser_esm.Y)(RecommendationResultTracker.x, {
																							...
																							children: (0, emotion_react_jsx_runtime_browser_esm.Y)(BundleSelector, {
																								...
																								children: resultComponent
																									? (0, cloneWithProps.Y)(resultComponent, { result, seed: !1, selected, onProductSelect, treePath })
																									: (0, emotion_react_jsx_runtime_browser_esm.Y)(Result.Q, {
																											...subProps_result,
																											controller,
																											result,
																					...
																					: (0, emotion_react_jsx_runtime_browser_esm.Y)(RecommendationResultTracker.x, {
																							...
																							children: (0, emotion_react_jsx_runtime_browser_esm.Y)(BundleSelector, {
																								...
																								lang: { seedText: lang.seedText },
																								children: resultComponent
																									? (0, cloneWithProps.Y)(resultComponent, { result, seed: !0, selected, onProductSelect, treePath })
																									: (0, emotion_react_jsx_runtime_browser_esm.Y)(Result.Q, {
																											...subProps_result,
																											controller,
																											result,
