		...
		'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx': (
			...
			__webpack_require__.r(__webpack_exports__),
				__webpack_require__.d(__webpack_exports__, {
					Dropdown: () => VariantSelection_stories_Dropdown,
					List: () => VariantSelection_stories_List,
					Swatches: () => VariantSelection_stories_Swatches,
			...
			const CSS_variantSelection = () =>
				...
				VariantSelection = (0, mobxreact_esm.PA)((properties) => {
							...
							? (0, emotion_react_jsx_runtime_browser_esm.Y)(cache._, {
									children: (0, emotion_react_jsx_runtime_browser_esm.Y)('div', {
										...
										children: (() => {
											switch (type) {
												case 'dropdown':
													return (0, emotion_react_jsx_runtime_browser_esm.Y)(preact_module.FK, {
														children: (0, emotion_react_jsx_runtime_browser_esm.Y)(Dropdown.m, {
															button: (0, emotion_react_jsx_runtime_browser_esm.Y)((props) => {
																const { open } = props;
																return (0, emotion_react_jsx_runtime_browser_esm.FD)(preact_module.FK, {
																	children: [
																		(0, emotion_react_jsx_runtime_browser_esm.FD)('div', {
																			...
																			children: [
																				...
																				selection.selected
																					? (0, emotion_react_jsx_runtime_browser_esm.FD)('span', {
															...
															children: (0, emotion_react_jsx_runtime_browser_esm.Y)('div', {
																...
																children: selection.values.map((val) => {
																	...
																	return (0, emotion_react_jsx_runtime_browser_esm.Y)('div', {
																		className: classnames_default()('ss__variant-selection__option', {
												...
												case 'list':
													return (0, emotion_react_jsx_runtime_browser_esm.Y)(preact_module.FK, {
														children: (0, emotion_react_jsx_runtime_browser_esm.Y)(List.B, { ...subProps_list, options: selection.values }),
													});
												case 'swatches':
													return (0, emotion_react_jsx_runtime_browser_esm.Y)(preact_module.FK, {
														children: (0, emotion_react_jsx_runtime_browser_esm.Y)(Swatches.l, { ...subProps_swatches, options: selection.values }),
													});
											}
										})(),
									}),
			...
			const VariantSelection_stories = {
				...
				ObservableSelection = (0, mobxreact_esm.PA)(({ args }) => (0, emotion_react_jsx_runtime_browser_esm.Y)(VariantSelection, { ...args })),
				VariantSelection_stories_List = (args) => (0, emotion_react_jsx_runtime_browser_esm.Y)(ObservableSelection, { args }),
				VariantSelection_stories_Swatches = (args) => (0, emotion_react_jsx_runtime_browser_esm.Y)(ObservableSelection, { args }),
				values = [
					{
						value: 'Rainbow',
						label: 'Rainbow',
				...
				VariantSelection_stories_Dropdown = (props, { loaded: { controller } }) => {
					const selection = controller.store.results[0].variants?.selections[0];
					return (0, emotion_react_jsx_runtime_browser_esm.Y)(VariantSelection, { ...props, selection });
				};
			(VariantSelection_stories_Dropdown.loaders = [
				async () => (
				...
				(VariantSelection_stories_Dropdown.args = { type: 'dropdown' }),
				(VariantSelection_stories_List.args = {
					selection: {
						select: (e) => {
				...
				(VariantSelection_stories_Swatches.args = {
					selection: {
						select: (e) => {
							console.log('selected', e);
						},
				...
				(VariantSelection_stories_List.parameters = {
					...VariantSelection_stories_List.parameters,
					docs: {
						...VariantSelection_stories_List.parameters?.docs,
						source: {
							originalSource: '(args: VariantSelectionProps) => {\n  return <ObservableSelection args={args} />;\n}',
							...VariantSelection_stories_List.parameters?.docs?.source,
						},
					},
				}),
				(VariantSelection_stories_Swatches.parameters = {
					...VariantSelection_stories_Swatches.parameters,
					docs: {
						...VariantSelection_stories_Swatches.parameters?.docs,
						source: {
							originalSource: '(args: VariantSelectionProps) => {\n  return <ObservableSelection args={args} />;\n}',
							...VariantSelection_stories_Swatches.parameters?.docs?.source,
						},
					},
				}),
				(VariantSelection_stories_Dropdown.parameters = {
					...VariantSelection_stories_Dropdown.parameters,
					docs: {
						...VariantSelection_stories_Dropdown.parameters?.docs,
						source: {
							originalSource:
							...
							...VariantSelection_stories_Dropdown.parameters?.docs?.source,
						},
					},
				});
