(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
	[8792],
	{
		...
		'./components/.storybook/preview.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
									...
									async (target, elem) => {
										...
										const BranchOverride = (
											await Promise.all([
												...
												__webpack_require__.e(4900),
												__webpack_require__.e(8012),
												__webpack_require__.e(4296),
			...
			class ThemeStore {
				...
				get theme() {
					...
					let themeOverrides = mergeThemeLayers(overrides, overrideBreakpoint, overrides, overrideBreakpoint, {
						...
						theme = mergeThemeLayers(base, baseBreakpoint, this.currency, this.language, this.languageOverrides, themeOverrides);
					...
					selectedOption?.overrides &&
						(selectedOption?.overrides &&
							...
							(themeOverrides = mergeThemeLayers(themeOverrides, selectedOption.overrides))),
				...
				CustomComponentWrapper = (0, es.PA)((properties) => {
					...
					return (0, emotion_react_jsx_runtime_browser_esm.Y)(cache._, {
						children: (0, emotion_react_jsx_runtime_browser_esm.Y)('div', {
							...styling,
							children: (0, emotion_react_jsx_runtime_browser_esm.Y)(treePath.p3, { path, children }),
						}),
					});
				}),
			...
			addTheme(snapTemplates, 'snappy', snappy.m), addTheme(snapTemplates, 'bocachica', bocachica.S), addTheme(snapTemplates, 'base', base.E);
		...
		'./components/src/themes/bocachica/bocachica.ts': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			const badgeImage = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				badgePill = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				badgeRectangle = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				badgeText = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				banner = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				breadcrumbs = { default: {}, mobile: {}, tablet: {}, desktop: {} };
			...
			const button_button = {
				...
				formattedNumber = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				icon = {
					default: {
				...
				image_image = {
					default: { themeStyleScript: ({ visibility, theme }) => (0, emotion_react_browser_esm.AH)({ '& img': { visibility } }) },
					mobile: {},
					tablet: {},
					desktop: {},
				},
				inlineBanner = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				loadingBar = {
					default: {
				...
				overlay = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				paginationInfo = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				price = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
				...
				skeleton = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				calloutBadge = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				carousel = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
				...
				errorHandler = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				facetGridOptions = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables,
				...
				facetSlider = {
					default: {
						themeStyleScript: ({ railColor, trackColor, handleColor, valueTextColor, handleDraggingColor, showTicks, stickyHandleLabel, theme }) => {
							const variables = theme?.variables;
							return (0, emotion_react_browser_esm.AH)({
				...
				list = {
					default: {
						themeStyleScript: ({ theme }) => (0, emotion_react_browser_esm.AH)({ gap: '8px', '& .ss__list__options': { gap: '10px' } }),
				...
				overlayBadge = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				pagination = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
							return (0, emotion_react_browser_esm.AH)({
								'& .ss__pagination__page': { color: variables?.colors?.secondary, '&.ss__pagination__page--active': { textDecoration: 'underline' } },
							});
						},
					},
					mobile: {},
				...
				radioList = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				result = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
				...
				perPage = {
					default: {
						themeStyleScript: ({ theme }) => (0, emotion_react_browser_esm.AH)({ '.ss__button__content': { gap: '7px' } }),
				...
				rating = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				sortBy = {
					default: {
						themeStyleScript: () => (0, emotion_react_browser_esm.AH)({ '.ss__button__content': { gap: '7px' } }),
						theme: { components: { icon: { size: '12px' } } },
					},
					mobile: {},
					tablet: {},
				...
				swatches = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				variantSelection = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				branchOverride = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				facet = {
					default: {
						themeStyleScript: ({ color, theme }) => {
							const variables = theme?.variables;
				...
				facets = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				facetsHorizontal = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
				...
				results = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				sidebar = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
					...
					default: {
						themeStyleScript: () =>
							(0, emotion_react_browser_esm.AH)({
								...
								'.ss__toolbar__slot--top': { marginRight: 'inherit', width: 'calc(300px + 1.5em)' },
								'&.ss__search__content__toolbar--middle-toolbar, &.ss__search__header-section__toolbar--top-toolbar': {
									display: 'flex',
									justifyContent: 'initial',
									justifyItems: 'initial',
									'.ss__toolbar__sort-by': { marginLeft: 'auto' },
									'.ss__select__dropdown__button': { padding: '6px 5px 6px 30px' },
								},
								'.ss__toolbar__layout-selector': { order: 4 },
							}),
					},
					mobile: {},
					tablet: {},
				...
				autocomplete = {
					default: {
						themeStyleScript: ({ horizontalTerms, vertical, theme }) => {
							const variables = theme?.variables;
							return (0, emotion_react_browser_esm.AH)({
								...
								'.ss__autocomplete__content': { '.ss__autocomplete__content__info': { a: { textTransform: 'uppercase' } } },
							});
						},
						...
						theme: {
							components: {
								...
								results: { columns: 3, rows: 2 },
								result: { hideBadge: !0 },
							},
						},
					},
					mobile: { hideFacets: !0, vertical: !0, horizontalTerms: !0, theme: { components: { results: { rows: 1, columns: 2 } } } },
					tablet: { hideFacets: !0, vertical: !0, horizontalTerms: !0, theme: { components: { results: { rows: 1, columns: 3 } } } },
					desktop: { vertical: !1, horizontalTerms: !0, theme: { components: { results: { rows: 1, columns: 3 }, facet: { limit: 4 } } } },
				},
				recommendation = {
					default: {
						themeStyleScript: ({ theme }) => {
				...
				recommendationBundleEasyAdd = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				recommendationBundleList = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				recommendationBundleVertical = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				recommendationGrid = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				recommendationEmail = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				search = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
							return (0, emotion_react_browser_esm.AH)({
								'.ss__search__content__toolbar--middle-toolbar, .ss__search__header-section__toolbar--top-toolbar': {
									...
									justifyItems: 'initial',
									'.ss__toolbar__sort-by': { marginLeft: 'auto' },
									'.ss__dropdown .ss__select__dropdown__button': { padding: '6px 5px 6px 5px' },
								},
								[`@media (max-width: ${variables?.breakpoints[0]}px)`]: {
									'.ss__search__header-section__toolbar--top-toolbar': { justifyContent: 'space-between !important' },
								},
							});
						},
						...
						theme: {
							components: {
								results: { columns: 5 },
								filterSummary: { hideTitle: !0 },
								sidebar: { hideTitle: !0 },
								'button.filter-toggle': { icon: 'filters' },
								'toolbar.top': { modules: ['PaginationInfo', 'SortBy', 'PerPage'] },
								'toolbar.middle': { modules: [] },
								'toolbar.bottom': { modules: ['Pagination'] },
								mobileSidebar: { theme: { components: { filterSummary: { hideTitle: !1 } } } },
							},
						},
					},
					mobile: { theme: { components: { results: { columns: 2 }, 'toolbar.top': { modules: ['MobileSidebar', 'LayoutSelector'] } } } },
					tablet: { theme: { components: { results: { columns: 3 } } } },
					desktop: { theme: { components: { results: { columns: 3 } } } },
				},
				searchHorizontal = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
							return (0, emotion_react_browser_esm.AH)({
								'.ss__banner--header': { display: 'none' },
								'.ss__filter-summary': { margin: '10px 0' },
								'.ss__search-header': { textAlign: 'left' },
								'.ss__search-horizontal__content__toolbar--top-toolbar': {
									justifyContent: 'right',
									'.ss__toolbar__pagination-info': { marginRight: 'auto' },
								},
								[`@media (max-width: ${variables?.breakpoints[2]}px)`]: {
									'.ss__search-horizontal__content__toolbar--top-toolbar': { justifyContent: 'space-between' },
								},
							});
						},
						theme: {
							components: {
								facetsHorizontal: { limit: 9 },
								searchHeader: {
									titleText: (data) => (data.search?.query?.string ? `Search Results For ${data.search?.query.string}` : 'Search Results'),
								},
								filterSummary: { hideTitle: !0 },
								sidebar: { hideTitle: !0 },
								'button.filter-toggle': { icon: 'filters' },
					...
					mobile: {
						hideFacetsHorizontal: !0,
						theme: {
							components: { 'toolbar.top': { modules: ['MobileSidebar', 'LayoutSelector'] }, 'toolbar.middle': { modules: ['PaginationInfo'] } },
						},
					},
					tablet: {},
					desktop: {},
				...
				bocachica = {
					...
					components: {
						...{
							...
							button: button_button.default,
							dropdown: dropdown.default,
							formattedNumber: formattedNumber.default,
							icon: icon.default,
							image: image_image.default,
							...
							layoutOptions: [
								{
									...
									label: '',
									icon: 'square',
									overrides: { components: { 'searchHorizontal results': { columns: 1 }, 'search results': { columns: 1 } } },
								},
								{
									value: 2,
									label: '',
									default: !0,
									icon: 'layout-large',
									overrides: { components: { 'searchHorizontal results': { columns: 2 }, 'search results': { columns: 2 } } },
								},
							],
							components: {
								...{
									...
									button: button_button.mobile,
									dropdown: dropdown.mobile,
									formattedNumber: formattedNumber.mobile,
									icon: icon.mobile,
									image: image_image.mobile,
								...
								...{
									...
									checkbox: checkbox_checkbox.mobile,
						...
						},
						{
							...
							components: {
								...
								...{
									...
									checkbox: checkbox_checkbox.tablet,
						...
						},
						{
							...
							components: {
								...
								...{
									...
									checkbox: checkbox_checkbox.desktop,
		...
		'./components/src/themes/snappy/snappy.ts': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var emotion_react_browser_esm = __webpack_require__('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js');
			const badgePill = {
					default: { themeStyleScript: ({ theme }) => (0, emotion_react_browser_esm.AH)({ margin: '10px' }) },
					mobile: {},
					tablet: {},
					desktop: {},
				},
				badgeRectangle = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				badgeText = { default: { themeStyleScript: ({}) => (0, emotion_react_browser_esm.AH)({}) }, mobile: {}, tablet: {}, desktop: {} },
				banner = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				breadcrumbs = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				button_button = {
					default: {
						themeStyleScript: ({}) =>
							(0, emotion_react_browser_esm.AH)({
								...
								'&:not(.ss__button--disabled):hover': { opacity: 0.7, backgroundColor: '#fff', '.ss__icon': { fill: '#5C5C5C', stroke: '#5C5C5C' } },
							}),
					},
					mobile: {},
					tablet: {},
				...
				searchHeader = {
					default: {
						themeStyleScript: ({ theme }) => {
							...
							return (0, emotion_react_browser_esm.AH)({
								paddingBottom: '10px',
								'.ss__search-header__title': { color: variables?.colors?.primary, marginBottom: '5px', fontWeight: 'initial', fontSize: '25px' },
								'.ss__search-header__title--corrected': { color: variables?.colors?.secondary },
							});
						},
				...
				calloutBadge = {
					default: {
						themeStyleScript: ({ theme }) => (0, emotion_react_browser_esm.AH)({ paddingLeft: '0px', '& .ss__badge-text': { paddingLeft: '0px' } }),
					},
					mobile: {},
					tablet: {},
					desktop: {},
			...
			const checkbox_checkbox = {
				...
				facetPaletteOptions = {
					default: {
						...
						columns: 5,
						hideIcon: !1,
						theme: { components: { icon: { size: '50%', icon: 'check-thin' } } },
					},
					mobile: {},
					tablet: {},
					desktop: {},
				...
				layoutSelector = {
					default: {
						...
						type: 'list',
						hideLabel: !0,
						theme: { components: { icon: { size: '5px' } } },
					},
					mobile: {},
					tablet: {},
					desktop: {},
			...
			const pagination = {
				...
				perPage = {
					default: {
						...
						label: '',
						theme: { components: { icon: { size: '12px' }, select: { separator: '' } } },
					},
					mobile: {},
					tablet: {},
					desktop: {},
				...
				sortBy = {
					default: {
						...
						theme: { components: { icon: { size: '12px', icon: 'angle-down' } } },
					},
					mobile: { theme: { components: { select: { hideSelection: !0 } } } },
					tablet: {},
					desktop: {},
				},
				swatches = { default: {}, mobile: {}, tablet: {}, desktop: {} },
				...
				mobileSidebar = {
					...
					mobile: { hideSortBy: !0, hideOpenButtonText: !0, hideFilterSummary: !0 },
					tablet: {},
					desktop: {},
				},
				noResults = {
				...
				results = { default: {}, mobile: { columns: 5 }, tablet: {}, desktop: {} },
				sidebar = {
					default: {
						themeStyleScript: ({ theme }) => {
							const variables = theme?.variables;
				...
				autocomplete = {
					...
					mobile: { hideFacets: !0, vertical: !0, horizontalTerms: !0, theme: { components: { results: { rows: 1, columns: 2 } } } },
					tablet: { hideFacets: !0, vertical: !0, horizontalTerms: !0, theme: { components: { results: { rows: 1, columns: 3 } } } },
					desktop: { vertical: !0, horizontalTerms: !0, theme: { components: { results: { rows: 1, columns: 3 }, facet: { limit: 4 } } } },
				},
				recommendation = {
					default: {
						themeStyleScript: ({ theme }) => {
				...
				search = {
					default: {
							...
							return (0, emotion_react_browser_esm.AH)({
								...
								[`@media (max-width: ${variables?.breakpoints[0]}px)`]: {
									...
									'.ss__search__content__toolbar--middle-toolbar': {
										...
										flexWrap: 'wrap',
										'.ss__toolbar__filter-summary': { flexBasis: '100%' },
									},
									'.ss__search__content__toolbar--middle-toolbar, .ss__search__header-section__toolbar--top-toolbar': {
										'.ss__toolbar__sort-by': { marginLeft: 'initial' },
									},
								},
							});
						},
						...
						theme: {
							components: {
								filterSummary: { hideTitle: !0 },
								sidebar: { hideTitle: !0, hideFilterSummary: !0 },
								'button.filter-toggle': { icon: 'close-thin' },
								'toolbar.top': { modules: ['FilterSummary', 'SortBy', 'LayoutSelector'] },
								'toolbar.middle': { modules: [] },
								'toolbar.bottom': { modules: ['PerPage', 'PaginationInfo', 'Pagination'] },
								mobileSidebar: { theme: { components: { filterSummary: { hideTitle: !1 } } } },
							},
						},
					},
					mobile: {
						theme: {
							components: {
								results: { columns: 2 },
								'toolbar.top': { modules: ['MobileSidebar'] },
								'toolbar.middle': { modules: ['FilterSummary', 'SortBy', 'LayoutSelector'] },
							},
						},
					},
					tablet: { theme: { components: { results: { columns: 3 } } } },
					...
					default: {
						themeStyleScript: ({ theme }) => {
							...
							return (0, emotion_react_browser_esm.AH)({
								...
								'.ss__search-horizontal__content__toolbar--bottom-toolbar': { marginTop: '10px' },
								[`@media (max-width: ${variables?.breakpoints[2]}px)`]: {
									'.ss__search-horizontal__content__toolbar--top-toolbar': { justifyContent: 'space-between' },
								},
							});
				...
				genericLayoutOptions = [
					{
						value: 1,
						label: '',
						default: !0,
						icon: 'layout-large',
						overrides: { components: { 'searchHorizontal results': { columns: 4 }, 'search results': { columns: 4 } } },
					},
					{
						value: 2,
						label: '',
						...
						overrides: {
							components: {
								'searchHorizontal result': { layout: 'list' },
								'search result': { layout: 'list' },
								'searchHorizontal results': { columns: 1 },
				...
				snappy = {
					...
					layoutOptions: genericLayoutOptions,
					responsive: [
						{
							layoutOptions: [
								{
