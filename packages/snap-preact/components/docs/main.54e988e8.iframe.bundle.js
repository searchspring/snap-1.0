(self.webpackChunk_searchspring_snap_preact = self.webpackChunk_searchspring_snap_preact || []).push([
	[8792],
	{
		...
		'./components/.storybook/preview.tsx': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			class Snap {
				constructor(config, services) {
					...
					let globalContext = {};
					try {
						globalContext = (0, getContext.S)(['shopper', 'config', 'merchandising', 'siteId', 'currency']);
					} catch (err) {
			...
			const pluginBackgroundFilters = (cntrlr) => {
				...
				pluginMutateResults = (cntrlr, config) => {
				...
				pluginBackgroundFilters_pluginBackgroundFilters = (cntrlr) => {
					if ('search' != cntrlr.type) return;
					const backgroundFilters = [];
			...
			const plugins_pluginBackgroundFilters_pluginBackgroundFilters = (cntrlr) => {
					if ('search' != cntrlr.type) return;
					const backgroundFilters = [];
				...
				src_plugins_pluginBackgroundFilters_pluginBackgroundFilters = (cntrlr, config) => {
					const backgroundFilters = [];
				...
				constructor(params) {
					(this.themes = {}),
						...
						(this.import = {
							...
							plugins: {
								shopify: { backgroundFilters: pluginBackgroundFilters, mutateResults: pluginMutateResults },
								bigcommerce: { backgroundFilters: pluginBackgroundFilters_pluginBackgroundFilters },
								magento2: { backgroundFilters: plugins_pluginBackgroundFilters_pluginBackgroundFilters },
								common: {
									backgroundFilters: src_plugins_pluginBackgroundFilters_pluginBackgroundFilters,
							...
							component: {
								...
								recommendation: {
									...
									email: {
										RecommendationEmail: async () =>
											...
											(this.components.recommendation.email.RecommendationEmail = (
												await Promise.all([__webpack_require__.e(4522), __webpack_require__.e(5789)]).then(
								...
								result: {
									Result: async () =>
										...
										(this.components.result.Result = (
											await Promise.all([__webpack_require__.e(4522), __webpack_require__.e(6105)]).then(
		...
		'./components/src/themes/bocachica/bocachica.ts': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			const badgeImage = { styleScript: () => (0, emotion_react_browser_esm.AH)({ maxHeight: '100%', maxWidth: '100%' }) },
				badgePill = {
			...
			const button_button = {
				...
				facetPaletteOptions = {
					styleScript: ({ columns, horizontal, gapSize, gridSize, theme }) =>
						(0, emotion_react_browser_esm.AH)({
							display: 'flex',
							flexFlow: 'row wrap',
				...
				grid = {
					styleScript: ({ theme, columns, gapSize, disableOverflowAction }) =>
						(0, emotion_react_browser_esm.AH)({
							'.ss__grid__options': {
								display: 'flex',
								flexFlow: 'row wrap',
				...
				branchOverride = {},
				facet = {
					styleScript: ({ color, disableCollapse, theme }) => {
						const variables = theme?.variables;
						return (0, emotion_react_browser_esm.AH)({
							width: '100%',
							margin: '0 0 20px 0',
				...
				recommendationBundle = {
					styleScript: ({ slidesPerView, spaceBetween, ctaInline, vertical, separatorIcon, theme }) => {
						const variables = theme?.variables;
						return (0, emotion_react_browser_esm.AH)({
							margin: '20px 0',
				...
				recommendationBundleEasyAdd = { styleScript: ({}) => (0, emotion_react_browser_esm.AH)({}) },
				recommendationBundleList = { styleScript: ({}) => (0, emotion_react_browser_esm.AH)({}) },
				recommendationBundleVertical = { styleScript: ({}) => (0, emotion_react_browser_esm.AH)({}) },
				recommendationGrid = {
					styleScript: ({ columns, gapSize }) =>
						(0, emotion_react_browser_esm.AH)({
							overflow: 'auto',
							maxWidth: '100%',
							maxHeight: '100%',
				...
				searchHorizontal = { styleScript: ({ theme }) => (0, emotion_react_browser_esm.AH)({ '.ss__filter-summary': { margin: '10px 0' } }) },
				bocachica = {
					name: 'bocachica',
